...
namespace AmplifyShaderEditor
{
    public class DoCreateStandardShader : EndNameEditAction
    {
        public override void Action(int instanceId, string pathName, string resourceFile)
        {
            ...
            {
                AmplifyShaderEditorWindow currentWindow = AmplifyShaderEditorWindow.OpenWindow(
                    shaderName,
                    UIUtils.ShaderIcon
                );
                UIUtils.CurrentWindow = currentWindow;
    ...
    public class DoCreateTemplateShader : EndNameEditAction
    {
        public override void Action(int instanceId, string pathName, string resourceFile)
        {
            ...
            {
                Shader shader = AmplifyShaderEditorWindow.CreateNewTemplateShader(
                    UIUtils.NewTemplateGUID,
                    uniquePath,
                    shaderName
                );
                ProjectWindowUtil.ShowCreatedAsset(shader);
