...
namespace AmplifyShaderEditor
{
    ...
    public sealed class InputPort : WirePort
    {
        ...
        public InputPort()
            : base(-1, -1, WirePortDataType.FLOAT, string.Empty)
        {
            m_typeLocked = true;
        }
        ...
        public InputPort(
            ...
            PortGenType genType = PortGenType.NonCustomLighting
        )
            : base(nodeId, portId, dataType, name, orderId)
        {
            m_dataName = name;
            m_internalDataPropertyLabel =
                (string.IsNullOrEmpty(name) || name.Equals(Constants.EmptyPortValue))
                    ? InputDefaultNameStr
                    : name;
        ...
        public override void NotifyExternalRefencesOnChange()
        {
            for (int i = 0; i < m_externalReferences.Count; i++)
            {
                ...
                if (node)
                {
                    ...
                    node.OnConnectedInputNodeChanges(
                        m_externalReferences[i].PortId,
                        m_nodeId,
                        m_portId,
                        m_name,
                        m_dataType
        ...
        public void UpdatePreviewInternalData()
        {
            switch (m_dataType)
            {
                case WirePortDataType.INT:
                    m_previewInternalInt = IntInternalData;
                    break;
                case WirePortDataType.FLOAT:
                    m_previewInternalFloat = FloatInternalData;
                    break;
                case WirePortDataType.FLOAT2:
                    m_previewInternalVec2 = Vector2InternalData;
                    break;
                case WirePortDataType.FLOAT3:
                    m_previewInternalVec3 = Vector3InternalData;
                    break;
                case WirePortDataType.FLOAT4:
                    m_previewInternalVec4 = Vector4InternalData;
                    break;
                case WirePortDataType.COLOR:
                    m_previewInternalColor = ColorInternalData;
                    break;
            }
        }
        ...
        {
            string[] data = String.IsNullOrEmpty(m_internalData)
                ? null
                : m_internalData.Split(IOUtils.VECTOR_SEPARATOR);
            ...
            try
            {
                switch (m_dataType)
                {
                    case WirePortDataType.OBJECT:
                        break;
                    case WirePortDataType.FLOAT:
                        m_previewInternalFloat = reset ? 0 : Convert.ToSingle(data[0]);
                        break;
                    case WirePortDataType.INT:
                        {
                            if (reset)
                            ...
                            else
                            {
                                ...
                                for (int i = 0; i < 4; i++)
                                {
                                    for (int j = 0; j < 4; j++)
                                    {
                                        if (overallIdx < count)
                                        {
                                            m_previewInternalMatrix4x4[i, j] = Convert.ToSingle(
                                                data[overallIdx]
                                            );
                                        }
                                        else
        ...
        void UpdateInternalDataFromVariables(bool forceDecimal = false)
        {
            switch (m_dataType)
            {
                ...
                case WirePortDataType.FLOAT2:
                    {
                        m_internalData =
                            m_previewInternalVec2.x.ToString()
                ...
                case WirePortDataType.FLOAT3:
                    {
                        m_internalData =
                            m_previewInternalVec3.x.ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalVec3.y.ToString()
                            + IOUtils.VECTOR_SEPARATOR
                ...
                case WirePortDataType.FLOAT4:
                    {
                        m_internalData =
                            m_previewInternalVec4.x.ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalVec4.y.ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalVec4.z.ToString()
                            + IOUtils.VECTOR_SEPARATOR
                ...
                case WirePortDataType.COLOR:
                    {
                        m_internalData =
                            m_previewInternalColor.r.ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalColor.g.ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalColor.b.ToString()
                            + IOUtils.VECTOR_SEPARATOR
                ...
                case WirePortDataType.FLOAT3x3:
                    {
                        m_internalData =
                            m_previewInternalMatrix4x4[0, 0].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[0, 1].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[0, 2].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[1, 0].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[1, 1].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[1, 2].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[2, 0].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[2, 1].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[2, 2].ToString();
                ...
                case WirePortDataType.FLOAT4x4:
                    {
                        m_internalData =
                            ...
                            + m_previewInternalMatrix4x4[0, 2].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[0, 3].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[1, 0].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[1, 1].ToString()
                            ...
                            + m_previewInternalMatrix4x4[1, 2].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[1, 3].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[2, 0].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[2, 1].ToString()
                            ...
                            + m_previewInternalMatrix4x4[2, 2].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[2, 3].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[3, 0].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[3, 1].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[3, 2].ToString()
                            + IOUtils.VECTOR_SEPARATOR
                            + m_previewInternalMatrix4x4[3, 3].ToString();
        ...
        private string SamplerWrappedData(ref MasterNodeDataCollector dataCollector)
        {
            ...
            dataCollector.AddToUniforms(
                m_nodeId,
                GeneratorUtils.GetPropertyDeclaraction(m_internalData, TextureType.Texture2D, ";")
            );
        ...
        public string GeneratePortInstructions(ref MasterNodeDataCollector dataCollector)
        {
            ...
            {
                result = UIUtils
                    .GetNode(m_externalReferences[0].NodeId)
                    .GenerateShaderForOutput(
                        m_externalReferences[0].PortId,
                        ref dataCollector,
                        false
                    );
                if (m_externalReferences[0].DataType != m_dataType)
                {
                    result = UIUtils.CastPortType(
                        ref dataCollector,
                        UIUtils.GetNode(m_nodeId).CurrentPrecisionType,
                        null,
                        m_externalReferences[0].DataType,
                        m_dataType,
                        result
                    );
                }
            ...
            else
            {
                ...
                if (DataType == WirePortDataType.FLOAT3x3)
                    ...
                    result = !String.IsNullOrEmpty(m_internalDataWrapper)
                        ? String.Format(m_internalDataWrapper, m_internalData)
                        : m_internalData;
            }
            return result;
        }

        public string GenerateShaderForOutput(
        ...
        )
        {
            ...
            if (linkPort != null)
            {
                return linkPort.GenerateShaderForOutput(
                    ref dataCollector,
                    inputPortType,
                    ignoreLocalVar,
                    autoCast
        ...
        public OutputPort GetOutputConnection(int connID = 0)
        {
            ...
            {
                return UIUtils
                    .GetNode(m_externalReferences[connID].NodeId)
                    .GetOutputPortByUniqueId(m_externalReferences[connID].PortId);
            }
            return null;
        }
        ...
        {
            string label =
                (useCustomLabel == true && customLabel != null)
                    ? customLabel
                    : m_internalDataPropertyLabel;
            switch (m_dataType)
            {
                ...
                case WirePortDataType.FLOAT:
                    {
                        FloatInternalData = owner.EditorGUIFloatField(
                            rect,
                            label,
                            FloatInternalData
                        );
                ...
                case WirePortDataType.FLOAT2:
                    {
                        Vector2InternalData = owner.EditorGUIVector2Field(
                            rect,
                            label,
                            Vector2InternalData
                        );
                ...
                case WirePortDataType.FLOAT3:
                    {
                        Vector3InternalData = owner.EditorGUIVector3Field(
                            rect,
                            label,
                            Vector3InternalData
                        );
                ...
                case WirePortDataType.FLOAT4:
                    {
                        Vector4InternalData = owner.EditorGUIVector4Field(
                            rect,
                            label,
                            Vector4InternalData
                        );
                ...
                case WirePortDataType.FLOAT3x3:
                    {
                        ...
                        for (int i = 0; i < 3; i++)
                        {
                            ...
                            currVec3 = owner.EditorGUIVector3Field(
                                rect,
                                label + "[ " + i + " ]",
                                currVec3
                            );
                ...
                case WirePortDataType.FLOAT4x4:
                    {
                        ...
                        for (int i = 0; i < 4; i++)
                        {
                            Vector4 currVec = matrix.GetRow(i);
                            EditorGUI.BeginChangeCheck();
                            currVec = owner.EditorGUIVector4Field(
                                rect,
                                label + "[ " + i + " ]",
                                currVec
                            );
                ...
                case WirePortDataType.COLOR:
                    {
                        ColorInternalData = owner.EditorGUIColorField(
                            rect,
                            label,
                            ColorInternalData
                        );
        ...
        )
        {
            ...
            switch (m_dataType)
            {
                ...
                case WirePortDataType.FLOAT:
                    {
                        FloatInternalData = owner.EditorGUILayoutFloatField(
                            label,
                            FloatInternalData
                        );
                    }
                ...
                case WirePortDataType.FLOAT2:
                    {
                        Vector2InternalData = owner.EditorGUILayoutVector2Field(
                            label,
                            Vector2InternalData
                        );
                    }
                ...
                case WirePortDataType.FLOAT3:
                    {
                        Vector3InternalData = owner.EditorGUILayoutVector3Field(
                            label,
                            Vector3InternalData
                        );
                    }
                ...
                case WirePortDataType.FLOAT4:
                    {
                        Vector4InternalData = owner.EditorGUILayoutVector4Field(
                            label,
                            Vector4InternalData
                        );
                    }
                ...
                case WirePortDataType.FLOAT3x3:
                    {
                        ...
                        for (int i = 0; i < 3; i++)
                        {
                            ...
                            currVec3.Set(currVec.x, currVec.y, currVec.z);
                            EditorGUI.BeginChangeCheck();
                            currVec3 = owner.EditorGUILayoutVector3Field(
                                label + "[ " + i + " ]",
                                currVec3
                            );
                            if (EditorGUI.EndChangeCheck())
                ...
                case WirePortDataType.FLOAT4x4:
                    {
                        ...
                        for (int i = 0; i < 4; i++)
                        {
                            Vector4 currVec = matrix.GetRow(i);
                            EditorGUI.BeginChangeCheck();
                            currVec = owner.EditorGUILayoutVector4Field(
                                label + "[ " + i + " ]",
                                currVec
                            );
                            if (EditorGUI.EndChangeCheck())
                ...
                case WirePortDataType.COLOR:
                    {
                        ColorInternalData = owner.EditorGUILayoutColorField(
                            label,
                            ColorInternalData
                        );
                    }
        ...
        public bool IsZeroInternalData
        {
            get
            {
                ...
                {
                    case WirePortDataType.FLOAT:
                        return Mathf.Abs(m_previewInternalFloat) < 0.001f;
                    case WirePortDataType.UINT:
                    case WirePortDataType.INT:
                        return m_previewInternalInt == 0;
                    case WirePortDataType.FLOAT2:
                        return (
                            Mathf.Abs(m_previewInternalVec2.x) < 0.001f
                            && Mathf.Abs(m_previewInternalVec2.y) < 0.001f
                        );
                    case WirePortDataType.FLOAT3:
                        return (
                            Mathf.Abs(m_previewInternalVec3.x) < 0.001f
                    ...
                    case WirePortDataType.FLOAT4:
                        return (
                            Mathf.Abs(m_previewInternalVec4.x) < 0.001f
                    ...
                    case WirePortDataType.COLOR:
                        return (
                            Mathf.Abs(m_previewInternalColor.r) < 0.001f
        ...
        public Matrix4x4 Matrix4x4InternalData
        {
            set
            {
                m_previewInternalMatrix4x4 = value;
                m_internalDataUpdated = false;
            }
        ...
        public string WrappedInternalData
        {
            ...
            {
                UpdateInternalDataFromVariables();
                return string.IsNullOrEmpty(m_internalDataWrapper)
                    ? m_internalData
                    : String.Format(m_internalDataWrapper, m_internalData);
            }
        }
            ...
            set
            {
                ...
                switch (DataType)
                {
                    case WirePortDataType.FLOAT:
                    {
                        ...
                        {
                            case WirePortDataType.FLOAT2:
                                m_previewInternalVec2.x = m_previewInternalFloat;
                                break;
                            case WirePortDataType.FLOAT3:
                                m_previewInternalVec3.x = m_previewInternalFloat;
                                break;
                            case WirePortDataType.FLOAT4:
                                m_previewInternalVec4.x = m_previewInternalFloat;
                                break;
                            case WirePortDataType.FLOAT3x3:
                            case WirePortDataType.FLOAT4x4:
                            {
                            ...
                            case WirePortDataType.COLOR:
                                m_previewInternalColor.r = m_previewInternalFloat;
                                break;
                            case WirePortDataType.INT:
                                m_previewInternalInt = (int)m_previewInternalFloat;
                                break;
                        }
                        break;
                    }
                    case WirePortDataType.FLOAT2:
                    {
                        ...
                        {
                            case WirePortDataType.FLOAT:
                                m_previewInternalFloat = m_previewInternalVec2.x;
                                break;
                            case WirePortDataType.FLOAT3:
                            {
                            ...
                            case WirePortDataType.INT:
                                m_previewInternalInt = (int)m_previewInternalVec2.x;
                                break;
                        }
                        break;
                    }
                    case WirePortDataType.FLOAT3:
                    {
                        ...
                        {
                            case WirePortDataType.FLOAT:
                                m_previewInternalFloat = m_previewInternalVec3.x;
                                break;
                            case WirePortDataType.FLOAT2:
                            {
                            ...
                            case WirePortDataType.INT:
                                m_previewInternalInt = (int)m_previewInternalVec3.x;
                                break;
                        }
                        break;
                    }
                    case WirePortDataType.FLOAT4:
                    {
                        ...
                        {
                            case WirePortDataType.FLOAT:
                                m_previewInternalFloat = m_previewInternalVec4.x;
                                break;
                            case WirePortDataType.FLOAT2:
                            {
                            ...
                            case WirePortDataType.INT:
                                m_previewInternalInt = (int)m_previewInternalVec4.x;
                                break;
                        }
                        break;
                    }
                    ...
                    case WirePortDataType.COLOR:
                    {
                        ...
                        {
                            case WirePortDataType.FLOAT:
                                m_previewInternalFloat = m_previewInternalColor.r;
                                break;
                            case WirePortDataType.FLOAT2:
                            {
                            ...
                            case WirePortDataType.INT:
                                m_previewInternalInt = (int)m_previewInternalColor.r;
                                break;
                        }
                        break;
                    }
                    case WirePortDataType.INT:
                    {
                        ...
                        {
                            case WirePortDataType.FLOAT:
                                m_previewInternalFloat = m_previewInternalInt;
                                break;
                            case WirePortDataType.FLOAT2:
                                m_previewInternalVec2.x = m_previewInternalInt;
                                break;
                            case WirePortDataType.FLOAT3:
                                m_previewInternalVec3.x = m_previewInternalInt;
                                break;
                            case WirePortDataType.FLOAT4:
                                m_previewInternalVec4.x = m_previewInternalInt;
                                break;
                            case WirePortDataType.FLOAT3x3:
                            case WirePortDataType.FLOAT4x4:
                            {
                            ...
                            case WirePortDataType.COLOR:
                                m_previewInternalColor.r = m_previewInternalInt;
                                break;
                        }
                        break;
                    }
        ...
        public bool IsFragment
        {
            get
            {
                return m_category == MasterNodePortCategory.Fragment
                    || m_category == MasterNodePortCategory.Debug;
            }
        }
        ...
        public void SetPreviewInputTexture(ParentGraph container)
        {
            ...
            {
                m_node.PreviewMaterial.SetTexture(
                    m_cachedPropertyId,
                    container
                        .GetNode(ExternalReferences[0].NodeId)
                        .GetOutputPortByUniqueId(ExternalReferences[0].PortId)
                        .OutputPreviewTexture
                );
            }
        ...
        public void SetPreviewInputValue(ParentGraph container)
        {
            ...
            {
                m_inputPreviewTexture = new RenderTexture(
                ...
                case WirePortDataType.FLOAT:
                    {
                        ...
                        InputPreviewMaterial.SetFloat(
                            CachedFloatPropertyID,
                            m_previewInternalFloat
                        );
                    }
                    break;
                case WirePortDataType.FLOAT2:
                    {
                        ...
                        InputPreviewMaterial.SetVector(
                            CachedVectorPropertyID,
                            new Vector4(v2.x, v2.y, 0, 0)
                        );
                    }
                    break;
                case WirePortDataType.FLOAT3:
                ...
                case WirePortDataType.COLOR:
                    {
                        ...
                        InputPreviewMaterial.SetColor(
                            CachedColorPropertyID,
            ...
            if (IsConnected)
            {
                ...
                for (int connIdx = 0; connIdx < count; connIdx++)
                {
                    ...
                    if (node != null)
                    {
                        ...
                        {
                            if (
                                outputPort.ExternalReferences[j].NodeId == NodeId
        ...
        public Shader InputPreviewShader
        {
            get
            {
                if (m_inputPreviewShader == null)
                    m_inputPreviewShader = AssetDatabase.LoadAssetAtPath<Shader>(
            ...
            set { m_inputPreviewShader = value; }
        }
        ...
        public override string Name
        {
            ...
            set
            {
                m_name = value;
                m_internalDataPropertyLabel =
                    (string.IsNullOrEmpty(value) || value.Equals(Constants.EmptyPortValue))
                        ? InputDefaultNameStr
                        : value;
        ...
        public RenderTexture InputPreviewTexture(ParentGraph container)
        {
            if (IsConnected)
            {
                if (m_externalReferences.Count > 0)
                    return container
                        .GetNode(m_externalReferences[0].NodeId)
                        .GetOutputPortByUniqueId(m_externalReferences[0].PortId)
                        .OutputPreviewTexture;
                else
                    return null;
            }
        ...
        public bool HasOwnOrLinkConnection
        {
            get { return IsConnected || HasConnectedExternalLink; }
        }
        public bool HasExternalLink
        {
            get { return m_externalNodeLink > -1 && m_externalPortLink > -1; }
        }
