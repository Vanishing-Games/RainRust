    ...
    public class WireBezierReference
    {
        ...
        public void DebugDraw()
        {
            GUI.Label(
                m_boundingBox,
                string.Empty,
                UIUtils.GetCustomStyle(CustomStyle.MainCanvasTitle)
            );
        }
        ...
        public override string ToString()
        {
            return string.Format(
                "In node: {0} port: {1} -> Out node: {2} port: {3}",
                m_inNodeId,
                m_inPortId,
                m_outNodeId,
                m_outPortId
        ...
        public int InNodeId
        {
            get { return m_inNodeId; }
        }
        public int InPortId
        {
            get { return m_inPortId; }
        }
        public int OutNodeId
        {
            get { return m_outNodeId; }
        }
        public int OutPortId
        {
            get { return m_outPortId; }
        }
    }
}
