    ...
    public class GLDraw
    {
        ...
        */
        ...
        public static void CreateMaterial()
        {
            ...
            LineShader = AssetDatabase.LoadAssetAtPath<Shader>(
                AssetDatabase.GUIDToAssetPath("50fc796413bac8b40aff70fb5a886273")
            );
        ...
        )
        {
            ...
            Allv3Points = Handles.MakeBezierPoints(
                start,
                end,
                startTangent,
                endTangent,
