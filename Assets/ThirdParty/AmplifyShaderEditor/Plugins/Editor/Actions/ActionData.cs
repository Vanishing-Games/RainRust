...
namespace AmplifyShaderEditor
{
    ...
    public class CreateConnectionActionData : ActionData
    {
        ...
        public CreateConnectionActionData(
            int inputNodeId,
            int inputPortId,
            int outputNodeId,
            int outputPortId
        ...
        public override string ToString()
        {
            return "Create Connection Node - Input Node: "
                + m_inputNodeId
                + " Input Port: "
                + m_inputPortId
                + " Output Node: "
    ...
    public class DestroyConnectionActionData : ActionData
    {
        ...
        public DestroyConnectionActionData(
            int inputNodeId,
            int inputPortId,
            int outputNodeId,
            int outputPortId
        ...
        public override string ToString()
        {
            return "Destroy Connection Node - Input Node: "
                + m_inputNodeId
                + " Input Port: "
                + m_inputPortId
                + " Output Node: "
    ...
    public class MoveInputConnectionActionData : ActionData
    {
        ...
        public MoveInputConnectionActionData(
            int oldInputNodeId,
            int oldInputPortId,
            int newInputNodeId,
            int newInputPortId,
        ...
        public override string ToString()
        {
            return "Move Input Connection Node - Old Input Node: "
                + m_oldInputNodeId
                + " Old Input Port: "
                + m_oldInputNodePortId
                + " New Input Node: "
    ...
    public class MoveOutputConnectionActionData : ActionData
    {
        ...
        public MoveOutputConnectionActionData(
            int inputNodeId,
            int inputPortId,
            int newOutputNodeId,
            int newOutputPortId,
        ...
        public override string ToString()
        {
            return "Move Input Connection Node - Input Node: "
                + m_inputNodeId
                + " Input Port: "
                + m_inputPortId
                + " Old Output Node: "
    ...
    public class ChangeNodePropertiesActionData : ActionData
    {
        ...
        public override string ToString()
        {
            return "Change Node Propertie - Node: "
                + m_nodeId
                + "\nOriginal Properties:\n"
