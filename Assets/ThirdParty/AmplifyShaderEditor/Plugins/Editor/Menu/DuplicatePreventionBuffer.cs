...
namespace AmplifyShaderEditor
{
    ...
    public class DuplicatePreventionBuffer
    {
        ...
        private string[] m_availableUVChannelsNamesArray = { "null", "null", "null", "null" };
        ...
        private Dictionary<string, int> m_availableLocalVariableNames =
        ...
        {
            if (channelId < 0 || channelId > (m_availableUVChannelsArray.Length - 1))
            {
                return false;
            }
        ...
        public void GetFirstAvailableName(
            int nodeId,
        ...
        )
        {
            ...
            while (!foundName)
            {
                ...
                string propertyName = UIUtils.GeneratePropertyName(
                    inspectorName,
        ...
        {
            if (
                m_availableLocalVariableNames.ContainsKey(name)
                && m_availableLocalVariableNames[name] > -1
            )
                return false;
            return true;
        }
