...
namespace AmplifyShaderEditor
{
    public sealed class NodeParametersWindow : MenuParent
    {
        ...
        public NodeParametersWindow(AmplifyShaderEditorWindow parentWindow)
            : base(
                parentWindow,
                0,
                0,
        ...
        )
        {
            ...
            if (m_nodePropertiesStyle == null)
            {
                ...
                m_nodePropertiesStyle.normal.textColor = m_nodePropertiesStyle.active.textColor =
                    EditorGUIUtility.isProSkin ? new Color(1f, 1f, 1f) : new Color(0f, 0f, 0f);
            }
                ...
                GUILayout.BeginArea(m_transformedArea, m_content, m_style);
                {
                    ...
                    if (selectedNode != null)
                    {
                        ...
                        EditorGUILayout.BeginVertical();
                        {
                            ...
                            if (
                                ...
                                == ParentWindow.CurrentGraph.CurrentMasterNodeId
                            )
                            {
                    ...
                    else
                    {
                        ...
                        EditorGUILayout.BeginVertical();
                        {
                            ...
                            bool generalIsVisible = m_parentWindow
                            ...
                            m_parentWindow.InnerWindowVariables.ExpandedGeneralShaderOptions =
                                generalIsVisible;
                            AmplifyShaderFunction function = ParentWindow
                                .CurrentGraph
                                .CurrentShaderFunction;
                            if (function != null)
                            {
                                ...
                                function.AdditionalDirectives.Draw(
                                    ParentWindow.CurrentGraph.CurrentOutputNode
                                );
                            }

                            bool inputIsVisible = m_parentWindow
                                .InnerWindowVariables
                            ...
                            m_parentWindow.InnerWindowVariables.ExpandedFunctionInputs =
                                inputIsVisible;

                            bool swicthIsVisible = m_parentWindow
                                .InnerWindowVariables
                            ...
                            m_parentWindow.InnerWindowVariables.ExpandedFunctionSwitches =
                                swicthIsVisible;

                            bool outputIsVisible = m_parentWindow
                                .InnerWindowVariables
                            ...
                            m_parentWindow.InnerWindowVariables.ExpandedFunctionOutputs =
                                outputIsVisible;
        ...
        public void DrawGeneralFunction()
        {
            ...
            if (serializedObject != null)
            {
                ...
                cat.intValue = ParentWindow.CurrentGraph.CurrentOutputNode.EditorGUILayoutPopup(
                    "Category",
                    cat.intValue,
                    UIUtils.CategoryPresets
                );

                if (cat.enumValueIndex == 0)
                {
                    SerializedProperty custCat = serializedObject.FindProperty(
        ...
        public void DrawFunctionInputs()
        {
            ...
            if (
                m_functionInputsReordableList == null
                || functionInputNodes.Count != m_functionInputsLastCount
            )
            {
                ...
                m_functionInputsReordableList = new ReorderableList(
                    functionInputNodes,
                    typeof(FunctionInput),
                    true,
                    false,
                    false,
                    false
                ...
                m_functionInputsReordableList.drawElementCallback = (
                    Rect rect,
                    int index,
                    bool isActive,
                    bool isFocused
        ...
        public void DrawFunctionSwitches()
        {
            ...
            if (
                m_functionSwitchesReordableList == null
                || functionSwitchNodes.Count != m_functionSwitchesLastCount
            )
            {
                functionSwitchNodes.Sort(
                    (x, y) =>
                    {
                        return x.OrderIndex.CompareTo(y.OrderIndex);
                    }
                ...
                m_functionSwitchesReordableList = new ReorderableList(
                    functionSwitchNodes,
                    typeof(FunctionSwitch),
                    true,
                    false,
                    false,
                    false
                ...
                m_functionSwitchesReordableList.drawElementCallback = (
                    Rect rect,
                    int index,
                    bool isActive,
                    bool isFocused
        ...
        public void DrawFunctionOutputs()
        {
            ...
            if (
                m_functionOutputsReordableList == null
                || functionOutputNodes.Count != m_functionOutputsLastCount
            )
            {
                ...
                m_functionOutputsReordableList = new ReorderableList(
                    functionOutputNodes,
                ...
                m_functionOutputsReordableList.drawElementCallback = (
                    Rect rect,
                    int index,
                    bool isActive,
                    bool isFocused
        ...
        private void RefreshVisibleList(ref List<PropertyNode> allNodes)
        {
            ...
            for (int i = 0; i < nodes.Count; i++)
            {
                ...
                if (
                    ...
                    && (
                        !m_propertyReordableNodes.Exists(x =>
                ...
                )
                {
                    ...
                    drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused) =>
                    {
                        ...
                        EditorGUI.LabelField(
                            first,
                            m_propertyReordableNodes[index].PropertyInspectorName
                        );
                        var second = rect;
                        second.width *= 0.4f;
                        ...
                        if (
                            GUI.Button(
                                second,
                                m_propertyReordableNodes[index].PropertyName,
