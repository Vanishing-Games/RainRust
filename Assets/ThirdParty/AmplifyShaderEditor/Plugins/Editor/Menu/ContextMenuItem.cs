...
namespace AmplifyShaderEditor
{
    public class ContextMenuItem
    {
        ...
        )
        {
            ...
            m_nameWithShortcut =
                shortcut != KeyCode.None
                    ? (name + " [ " + UIUtils.KeyCodeToString(shortcut) + " ]")
                    : name;
        ...
        public int CompareTo(ContextMenuItem item, bool useWeights)
        {
            if (
                useWeights
                && NodeAttributes.SortOrderPriority > -1
                && item.NodeAttributes.SortOrderPriority > -1
            )
            {
        ...
        public string NameWithShortcut
        {
            get { return m_nameWithShortcut; }
        }
        ...
        public GUIContent ItemUIContent
        {
            get { return m_guiContent; }
        }
