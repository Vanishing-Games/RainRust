...
namespace AmplifyShaderEditor
{
    public sealed class ShaderEditorModeWindow : MenuParent
    {
        ...
        public ShaderEditorModeWindow(AmplifyShaderEditorWindow parentWindow)
            : base(
                parentWindow,
                0,
                0,
                0,
                0,
                "ShaderEditorModeWindow",
                MenuAnchor.BOTTOM_CENTER,
                MenuAutoSize.NONE
            ) { }
        ...
        public void Draw(
            ...
            float usableArea,
            float leftPos,
            float rightPos /*, bool showLastSelection*/
        )
        {
            ...
            if (m_init)
            {
                ...
                GUIStyle shaderModeNoShader = UIUtils.GetCustomStyle(
                    CustomStyle.ShaderModeNoShader
                );
                GUIStyle materialModeTitle = UIUtils.GetCustomStyle(CustomStyle.MaterialModeTitle);
                GUIStyle shaderNoMaterialModeTitle = UIUtils.GetCustomStyle(
                    CustomStyle.ShaderNoMaterialModeTitle
                );
            ...
            {
                m_leftButtonStyle = UIUtils.GetCustomStyle(
                    currentShader == null
                        ? CustomStyle.ShaderModeNoShader
                        : CustomStyle.ShaderModeTitle
                );
                ...
                if (currentMaterial != null)
                {
                    ...
                    string matName =
                        (currentMaterial != null) ? (currentMaterial.name) : NoMaterialStr;
            ...
            // Shader Function
                ...
                && ParentWindow.CurrentGraph.CurrentOutputNode != null
            )
            {
                ...
                m_leftButtonRect.y += m_leftButtonRect.height - 38 - 15;
                string functionName =
                    (ParentWindow.CurrentGraph.CurrentShaderFunction != null)
                        ? (ParentWindow.CurrentGraph.CurrentShaderFunction.name)
                        : "No Shader Function";
