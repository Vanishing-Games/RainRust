    ...
    public sealed class TemplateDepthModule : TemplateModuleParent
    {
        ...
        public void ConfigureFromTemplateData(TemplateDepthData depthData)
        {
            ...
            if (depthData.ValidZWrite && m_validZWrite != depthData.ValidZWrite)
            {
                ...
                {
                    m_zWriteMode.IntValue = ZBufferOpHelper.ZWriteModeDict[
                        depthData.ZWriteModeValue
                    ];
        ...
        public override void ShowUnreadableDataMessage(ParentNode owner)
        {
            ...
            NodeUtils.DrawPropertyGroup(
                ref foldoutValue,
                ZBufferOpHelper.DepthParametersStr,
        ...
        void DrawBlock(UndoParentNode owner)
        {
            ...
            if (m_validOffset)
            {
                m_offsetEnabled = owner.EditorGUILayoutToggle(
                    ZBufferOpHelper.OffsetStr,
                    m_offsetEnabled
                );
                if (m_offsetEnabled)
                {
        ...
        public bool IsActive
        {
            get
            {
                return (m_zTestMode.IsValid || m_zTestMode.IntValue != 0)
                    || (m_zWriteMode.IsValid || m_zWriteMode.IntValue != 0)
                    || m_offsetEnabled;
            }
        }
        public string CurrentZWriteMode
        {
            get
            {
                ...
                return string.Format(
                    ZWriteFormatter,
                    ZBufferOpHelper.ZWriteModeValues[finalZWrite]
                );
                ;
            }
        }
        public string CurrentZTestMode
        {
            get
            {
                ...
                return string.Format(
                    ZTestFormatter,
                    ZBufferOpHelper.ZTestModeValues[finalZTestMode]
                );
            }
        }
        ...
        public string CurrentOffset
        {
            get
            {
                if (m_offsetEnabled)
                    return "Offset "
                        + m_offsetFactor.GetValueOrProperty()
                        + " , "
                        + m_offsetUnits.GetValueOrProperty()
                        + "\n";
                else
                    return "Offset 0,0\n";
            }
        ...
        {
            get { return m_validZTest; }
        }
        public bool ValidZWrite
        {
            get { return m_validZWrite; }
        }
        public bool ValidOffset
        {
            get { return m_validOffset; }
        }
        public InlineProperty ZTestMode
        {
            get { return m_zTestMode; }
        }
        public InlineProperty ZWriteMode
        {
            get { return m_zWriteMode; }
        }
        public InlineProperty OffsetFactor
        {
            get { return m_offsetFactor; }
        }
        public InlineProperty OffsetUnits
        {
            get { return m_offsetUnits; }
        }
        public bool OffsetEnabled
        {
            get { return m_offsetEnabled; }
        }
        ...
        public ZTestMode ZTestModeValue
        {
            ...
            get { return (ZTestMode)(m_zTestMode.IntValue - 1); }
        }
        public ZWriteMode ZWriteModeValue
        {
            ...
            get { return (ZWriteMode)(m_zWriteMode.IntValue - 1); }
        }
        public float OffsetFactorValue
        {
            ...
            get { return m_offsetFactor.FloatValue; }
        }
        ...
        public float OffsetUnitsValue
        {
            ...
            get { return m_offsetUnits.FloatValue; }
        }
    }
}
