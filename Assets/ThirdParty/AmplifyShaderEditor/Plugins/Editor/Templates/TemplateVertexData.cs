...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateVertexData
    {
        ...
        public void RegisterComponent(char channelId, string value)
        {
            ...
            {
                Debug.LogWarning(
                    "Attempting to create interpolated data from invalid channel " + channelId
                );
                return;
            }
        ...
        public void BuildVar(PrecisionType precisionType = PrecisionType.Float)
        {
            ...
            switch (dataType)
            {
                ...
                case WirePortDataType.FLOAT2:
                    {
                        newVar += "{0}." + Components[0] + ", " + "{0}." + Components[1];
                    }
                    break;
        ...
        public WirePortDataType SwizzleType
        {
            get
            {
                ...
                {
                    case 2:
                        newType = WirePortDataType.FLOAT;
                        break;
                    case 3:
                        newType = WirePortDataType.FLOAT2;
                        break;
                    case 4:
                        newType = WirePortDataType.FLOAT3;
                        break;
                    case 5:
                        newType = WirePortDataType.FLOAT4;
                        break;
                }
