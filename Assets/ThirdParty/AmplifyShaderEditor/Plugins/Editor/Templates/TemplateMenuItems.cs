...
namespace AmplifyShaderEditor
{
    public class TemplateMenuItems
    {
        ...
        {
            AmplifyShaderEditorWindow.CreateConfirmationTemplateShader(
        ...
        {
            AmplifyShaderEditorWindow.CreateConfirmationTemplateShader(
                "e1de45c0d41f68c41b2cc20c8b9c05ef"
            );
        }
        ...
        {
            AmplifyShaderEditorWindow.CreateConfirmationTemplateShader(
                "899e609c083c74c4ca567477c39edef0"
            );
        }
        ...
        {
            AmplifyShaderEditorWindow.CreateConfirmationTemplateShader(
                "c2a467ab6d5391a4ea692226d82ffefd"
            );
        }
