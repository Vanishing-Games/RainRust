...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateModulesHelper
    {
        ...
        [SerializeField]
        private TemplateAdditionalIncludesHelper m_additionalIncludes =
            new TemplateAdditionalIncludesHelper();

        [SerializeField]
        private TemplateAdditionalDefinesHelper m_additionalDefines =
            new TemplateAdditionalDefinesHelper();

        [SerializeField]
        private TemplateAdditionalPragmasHelper m_additionalPragmas =
            new TemplateAdditionalPragmasHelper();
        ...
        public void FetchDataFromTemplate(TemplateModulesData module)
        {
            ...
            if (module.PragmaTag.IsValid)
            {
                ...
                m_additionalDirectives.FillNativeItems(
                    module.IncludePragmaContainer.NativeDirectivesList
                );
        ...
        public void Draw(
            ParentNode owner,
            TemplateModulesData currentModule,
            TemplateModulesHelper parent = null
        )
        {
        ...
        public string GenerateAllModulesString(bool isSubShader)
        {
            ...
            {
                CullMode cullMode =
                    (CullModeHelper.ValidData) ? CullModeHelper.CurrentCullMode : CullMode.Back;
        ...
        public void ReadFromString(
            TemplateModulesData modulesData,
            ref uint index,
            ref string[] nodeParams
        )
        {
            try
            {
            ...
            if (UIUtils.CurrentShaderVersion() < 15312)
            {
                ...
                m_additionalDirectives.AddItems(
                    ...
                    m_additionalIncludes.ItemsList
                );
                m_additionalDirectives.AddItems(
                    AdditionalLineType.Define,
                    m_additionalDefines.ItemsList
                );
                m_additionalDirectives.AddItems(
                    AdditionalLineType.Pragma,
                    m_additionalPragmas.ItemsList
                );
            }
            else
            {
        ...
        public TemplatesBlendModule BlendOpHelper
        {
            get { return m_blendOpHelper; }
        }
        public TemplatesBlendModule BlendOpHelper1
        {
            get { return m_blendOpHelper1; }
        }
        public TemplatesBlendModule BlendOpHelper2
        {
            get { return m_blendOpHelper2; }
        }
        public TemplatesBlendModule BlendOpHelper3
        {
            get { return m_blendOpHelper3; }
        }
        public TemplateAlphaToMaskModule AlphaToMaskHelper
        {
            get { return m_alphaToMaskHelper; }
        }
        public TemplateCullModeModule CullModeHelper
        {
            get { return m_cullModeHelper; }
        }
        public TemplateColorMaskModule ColorMaskHelper
        {
            get { return m_colorMaskHelper; }
        }
        public TemplateColorMaskModule ColorMaskHelper1
        {
            get { return m_colorMaskHelper1; }
        }
        public TemplateColorMaskModule ColorMaskHelper2
        {
            get { return m_colorMaskHelper2; }
        }
        public TemplateColorMaskModule ColorMaskHelper3
        {
            get { return m_colorMaskHelper3; }
        }
        public TemplatesStencilBufferModule StencilBufferHelper
        {
            get { return m_stencilBufferHelper; }
        }
        public TemplateDepthModule DepthOphelper
        {
            get { return m_depthOphelper; }
        }
        public TemplateTagsModule TagsHelper
        {
            get { return m_tagsHelper; }
        }
        public TemplateShaderModelModule ShaderModelHelper
        {
            get { return m_shaderModelHelper; }
        }
        ...
        public RenderingPlatformOpHelper RenderingPlatforms
        {
            get { return m_renderingPlatforms; }
        }
