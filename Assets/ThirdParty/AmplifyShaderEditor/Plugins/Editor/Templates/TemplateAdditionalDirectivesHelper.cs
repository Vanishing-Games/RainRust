...
namespace AmplifyShaderEditor
{
    ...
    public class AdditionalDirectiveContainer : ScriptableObject
    {
        ...
        public void Init(AdditionalDirectiveContainerSaveItem item)
        {
            ...
            if (GUIDToggle)
            {
                LibObject = AssetDatabase.LoadAssetAtPath<TextAsset>(
    ...
    public sealed class TemplateAdditionalDirectivesHelper : TemplateModuleParent
    {
        ...
        [SerializeField]
        private List<AdditionalDirectiveContainer> m_additionalDirectives =
            new List<AdditionalDirectiveContainer>();

        [SerializeField]
        private List<AdditionalDirectiveContainer> m_shaderFunctionDirectives =
            new List<AdditionalDirectiveContainer>();
        ...
        [SerializeField]
        private List<AdditionalDirectiveContainerSaveItem> m_directivesSaveItems =
        ...
        public TemplateAdditionalDirectivesHelper(string moduleName)
            : base(moduleName) { }
        ...
        public void AddShaderFunctionItems(
            string ownerOutputId,
            List<AdditionalDirectiveContainer> functionList
        )
        {
            ...
            if (functionList.Count > 0)
            {
                ...
                {
                    AdditionalDirectiveContainer item =
                        ScriptableObject.CreateInstance<AdditionalDirectiveContainer>();
        ...
        public void RemoveShaderFunctionItems(
            string ownerOutputId /*, List<AdditionalDirectiveContainer> functionList */
        )
        {
            List<AdditionalDirectiveContainer> list = m_shaderFunctionDirectives.FindAll(
                (x) => x.OwnerId.Equals(ownerOutputId)
            );
        ...
        public void AddItems(AdditionalLineType type, List<string> items)
        {
            ...
            {
                AdditionalDirectiveContainer newItem =
                    ScriptableObject.CreateInstance<AdditionalDirectiveContainer>();
                newItem.LineType = type;
        ...
        public void AddNativeContainer()
        {
            ...
            {
                if (
                    m_additionalDirectives.FindIndex(x =>
                        x.Origin.Equals(AdditionalContainerOrigin.Native)
                    ) == -1
                )
                {
                    AdditionalDirectiveContainer newItem =
        ...
        void DrawButtons()
        {
            ...
            if (
                GUILayout.Button(
                    string.Empty,
                    UIUtils.PlusStyle,
                    GUILayout.Width(Constants.PlusMinusButtonLayoutWidth)
                )
            )
            {
                AdditionalDirectiveContainer newItem =
            ...
            )
            {
                ...
                {
                    AdditionalDirectiveContainer itemToDelete = m_additionalDirectives[
                        m_additionalDirectives.Count - 1
                    ];
        ...
        void DrawConditionals(Rect rect, AdditionalDirectiveContainer directive)
        {
            ...
            tog.xMin += 2;
            tog.yMin -= 2;
            bool value = GUI.Toggle(
                tog,
                directive.ShowConditionals,
                "",
            ...
            if (directive.ShowConditionals)
            {
                ...
                directive.Passes = m_currOwner.EditorGUITextField(
                    condPos,
                    string.Empty,
                    directive.Passes
                );
                ...
                string minText =
                    (directive.VersionMin == 0) ? string.Empty : directive.VersionMin.ToString();
                ...
                string maxText =
                    (directive.VersionMax == 0) ? string.Empty : directive.VersionMax.ToString();
        ...
        public override void Draw(UndoParentNode currOwner, bool style = true)
        {
            ...
            {
                m_reordableList = new ReorderableList(
                    m_additionalDirectives,
                    typeof(AdditionalDirectiveContainer),
                    true,
                    false,
                    false,
                    false
                )
                {
                    ...
                    {
                        if (
                            m_additionalDirectives[index].Origin == AdditionalContainerOrigin.Native
                            && m_nativeDirectivesFoldout
                        )
                        {
                            return (m_nativeDirectives.Count + 1)
                    ...
                    drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused) =>
                    {
                        ...
                        {
                            rect.height =
                                (m_nativeDirectives.Count + 1) * (EditorGUIUtility.singleLineHeight)
                                + 5;
                        }
                        ...
                        if (m_additionalDirectives[index] != null)
                        {
                            ...
                            if (
                                m_additionalDirectives[index].Origin
                                == AdditionalContainerOrigin.Native
                            )
                            {
                                rect.xMin -= 5;
                                rect.xMax += 1;
                                ...
                                m_nativeRect = rect;
                                m_nativeRect.y -=
                                    (m_nativeRect.height - (EditorGUIUtility.singleLineHeight + 5))
                                    * 0.5f;
                                m_nativeRect.xMin += 2;
                                m_nativeRect.xMax -= 2;
                                m_nativeRect.yMax -= 2;
                            ...
                            float popUpWidth = 88;
                            float widthAdjust =
                                m_additionalDirectives[index].LineType == AdditionalLineType.Include
                                    ? -14
                                    : 0;
                            ...
                            Rect GUIDTogglePos =
                                m_additionalDirectives[index].LineType == AdditionalLineType.Include
                                    ? new Rect(
                                        rect.x
                                            + rect.width
                                            - 3 * Constants.PlusMinusButtonLayoutWidth
                                            - conditionalsOffset
                                            + 3,
                                        rect.y,
                            ...
                            Rect buttonPlusPos = new Rect(
                                rect.x
                                    + rect.width
                                    - 2 * Constants.PlusMinusButtonLayoutWidth
                                    - conditionalsOffset
                                    + 1,
                                rect.y - 2,
                                Constants.PlusMinusButtonLayoutWidth,
                            ...
                            Rect labelPos = new Rect(
                                rect.x + popupPos.width - labelWidthStyleAdjust,
                                rect.y,
                                labelWidthStyleAdjust
                                    + rect.width
                                    - popupPos.width
                                    - buttonPlusPos.width
                                    - buttonMinusPos.width
                                    + widthAdjust,
                                EditorGUIUtility.singleLineHeight
                            );

                            m_additionalDirectives[index].LineType = (AdditionalLineType)
                                m_currOwner.EditorGUIEnumPopup(
                                    popupPos,
                                    m_additionalDirectives[index].LineType
                                );
                            ...
                            )
                            {
                                if (m_additionalDirectives[index].GUIDToggle)
                                {
                                    ...
                                    TextAsset obj =
                                        m_currOwner.EditorGUIObjectField(
                                            labelPos,
                                            m_additionalDirectives[index].LibObject,
                                            typeof(TextAsset),
                                            false
                                        ) as TextAsset;
                                    if (EditorGUI.EndChangeCheck())
                                    {
                                        ...
                                        if (extension.Equals(".cginc") || extension.Equals(".hlsl"))
                                        {
                                            ...
                                            m_additionalDirectives[index].GUIDValue =
                                                AssetDatabase.AssetPathToGUID(pathName);
                                        }
                                    }
                                }
                                else
                                {
                                    m_additionalDirectives[index].LineValue =
                                        m_currOwner.EditorGUITextField(
                                            labelPos,
                                            string.Empty,
                                            m_additionalDirectives[index].LineValue
                                        );
                                ...
                                if (
                                    GUI.Button(
                                        GUIDTogglePos,
                                        m_additionalDirectives[index].GUIDToggle
                                            ? UIUtils.FloatIntIconOFF
                                            : UIUtils.FloatIntIconON,
        ...
        public void AddAllToDataCollector(
        ...
        bool TestConditionals(TemplatePass pass, AdditionalDirectiveContainer directive)
        {
            ...
            if (
                isSRP
                && directive.VersionMin != 0
                && ASEPackageManagerHelper.CurrentSRPVersion < directive.VersionMin
            )
            {
                return false;
            }
            ...
            if (
                isSRP
                && directive.VersionMax != 0
                && ASEPackageManagerHelper.CurrentSRPVersion > directive.VersionMax
            )
            {
                return false;
            }
        ...
        {
            List<AdditionalDirectiveContainer> list = fromSF
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                switch (directive.LineType)
                {
                    case AdditionalLineType.Include:
                        {
                            ...
                            if (!string.IsNullOrEmpty(value) && !nativesContainer.HasInclude(value))
                            {
                    ...
                    case AdditionalLineType.Define:
                        {
                            if (
                                !string.IsNullOrEmpty(directive.LineValue)
        ...
        public override void ReadFromString(ref uint index, ref string[] nodeParams)
        {
            try
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    AdditionalLineType lineType = (AdditionalLineType)
                        Enum.Parse(typeof(AdditionalLineType), nodeParams[index++]);
                    ...
                    if (UIUtils.CurrentShaderVersion() > 15607)
                    {
                        ...
                        {
                            newItem.LibObject = AssetDatabase.LoadAssetAtPath<TextAsset>(
                                AssetDatabase.GUIDToAssetPath(newItem.GUIDValue)
                            );
                            if (newItem.LibObject == null)
                            {
                                Debug.LogWarning(
                                    "Include file not found with GUID " + newItem.GUIDValue
                                );
                            }
                        }
                    }
                    ...
                    {
                        origin = (AdditionalContainerOrigin)
                            Enum.Parse(typeof(AdditionalContainerOrigin), nodeParams[index++]);
        ...
        public override void WriteToString(ref string nodeInfo)
        {
            if (
                m_additionalDirectives.Count == 1
                && m_additionalDirectives[0].Origin == AdditionalContainerOrigin.Native
            )
            {
            ...
            for (int i = 0; i < m_additionalDirectives.Count; i++)
            {
                ...
                IOUtils.AddFieldValueToString(
                    ref nodeInfo,
                    m_additionalDirectives[i].LineValue.Replace(';', Constants.SemiColonSeparator)
                );
                ...
                IOUtils.AddFieldValueToString(
                    ref nodeInfo,
                    m_additionalDirectives[i].ShowConditionals
                );
                ...
                IOUtils.AddFieldValueToString(
                    ref nodeInfo,
                    m_additionalDirectives[i].Passes.Replace(';', Constants.SemiColonSeparator)
                );
            }
        }
        ...
        public void UpdateSaveItemsFromDirectives()
        {
            ...
            for (int i = 0; i < m_additionalDirectives.Count; i++)
            {
                ...
                {
                    m_directivesSaveItems.Add(
                        new AdditionalDirectiveContainerSaveItem(m_additionalDirectives[i])
                    );
                }
                else
                {
        ...
        public List<AdditionalDirectiveContainer> DirectivesList
        {
