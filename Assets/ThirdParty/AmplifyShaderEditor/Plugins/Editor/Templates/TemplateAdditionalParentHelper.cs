...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateAdditionalParentHelper : TemplateModuleParent
    {
        ...
        public TemplateAdditionalParentHelper(string moduleName)
            : base(moduleName) { }
        ...
        public void Draw(ParentNode owner)
        {
            ...
            owner.ContainerGraph.ParentWindow.InnerWindowVariables.ExpandedAdditionalDefines =
                foldout;
        }
        ...
        void DrawMainBody()
        {
            ...
            for (int i = 0; i < itemCount; i++)
            {
                EditorGUILayout.BeginHorizontal();
                {
                    ...
                    {
                        m_additionalItems[i] = UIUtils.RemoveShaderInvalidCharacters(
                            m_additionalItems[i]
                        );
                        m_isDirty = true;
                    }
        ...
        public virtual void AddToDataCollector(
