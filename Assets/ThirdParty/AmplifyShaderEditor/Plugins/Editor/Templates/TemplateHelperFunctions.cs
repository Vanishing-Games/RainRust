...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateReplaceHelper
    {
        ...
        public TemplateReplaceHelper(TemplateMultiPassMasterNode masterNode)
        {
    ...
    public class TemplateModuleData
    {
        ...
        public bool IsValid
        {
            get { return DataCheck == TemplateDataCheck.Valid; }
        }

        public virtual void SetAllModulesDefault()
        {
    ...
    public sealed class TemplateDepthData : TemplateModuleData
    {
        ...
        {
            DataCheck =
                (ValidZWrite || ValidZTest || ValidOffset)
                    ? TemplateDataCheck.Valid
                    : TemplateDataCheck.Invalid;
        }
    }
    ...
    public static class TemplateHelperFunctions
    {
        ...
        */
        ...
        public static readonly Dictionary<string, InvisibleOptionsEnum> InvisibleOptions =
            new Dictionary<string, InvisibleOptionsEnum>()
            {
                { "SyncP", InvisibleOptionsEnum.SyncProperties },
            };

        public static readonly Dictionary<string, TemplateSpecialTags> StringToReservedTags =
            new Dictionary<string, TemplateSpecialTags>()
            {
                ...
                {
                    TemplateSpecialTags.DisableBatching.ToString(),
                    TemplateSpecialTags.DisableBatching
                },
            };

        public static readonly Dictionary<string, DisableBatching> StringToDisableBatching =
            new Dictionary<string, DisableBatching>
            {
        ...
        public static readonly Dictionary<string, RenderType> StringToRenderType = new Dictionary<
            string,
            RenderType
        >
        {
        ...
        public static readonly Dictionary<string, RenderQueue> StringToRenderQueue = new Dictionary<
            string,
            RenderQueue
        >
        {
        ...
        public static readonly Dictionary<string, WirePortDataType> PropertyToWireType =
            new Dictionary<string, WirePortDataType>
            {
        ...
        public static readonly Dictionary<WirePortDataType, int> DataTypeChannelUsage =
            new Dictionary<WirePortDataType, int>
            {
        ...
        public static readonly Dictionary<int, WirePortDataType> ChannelToDataType = new Dictionary<
            int,
            WirePortDataType
        >
        {
        ...
        public static readonly Dictionary<TemplateSemantics, string> SemanticsDefaultName =
            new Dictionary<TemplateSemantics, string>
            {
        ...
        public static readonly Dictionary<int, TemplateInfoOnSematics> IntToInfo = new Dictionary<
            int,
        ...
        public static readonly Dictionary<string, TemplateInfoOnSematics> ShortcutToInfo =
            new Dictionary<string, TemplateInfoOnSematics>
            {
        ...
        public static readonly Dictionary<TemplateInfoOnSematics, string> InfoToDefineFrag =
            new Dictionary<TemplateInfoOnSematics, string>
            {
                ...
                { TemplateInfoOnSematics.SCREEN_POSITION, "ASE_NEEDS_FRAG_SCREEN_POSITION" },
                {
                    ...
                    "ASE_NEEDS_FRAG_SCREEN_POSITION_NORMALIZED"
                },
                { TemplateInfoOnSematics.COLOR, "ASE_NEEDS_FRAG_COLOR" },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES0,
                    "ASE_NEEDS_FRAG_TEXTURE_COORDINATES0"
                },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES1,
                    "ASE_NEEDS_FRAG_TEXTURE_COORDINATES1"
                },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES2,
                    "ASE_NEEDS_FRAG_TEXTURE_COORDINATES2"
                },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES3,
                    "ASE_NEEDS_FRAG_TEXTURE_COORDINATES3"
                },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES4,
                    "ASE_NEEDS_FRAG_TEXTURE_COORDINATES4"
                },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES5,
                    "ASE_NEEDS_FRAG_TEXTURE_COORDINATES5"
                },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES6,
                    "ASE_NEEDS_FRAG_TEXTURE_COORDINATES6"
                },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES7,
        ...
        public static readonly Dictionary<TemplateInfoOnSematics, string> InfoToDefineVertex =
            new Dictionary<TemplateInfoOnSematics, string>
            {
                ...
                {
                    TemplateInfoOnSematics.SCREEN_POSITION_NORMALIZED,
                    "ASE_NEEDS_VERT_SCREEN_POSITION_NORMALIZED"
                },
                { TemplateInfoOnSematics.COLOR, "ASE_NEEDS_VERT_COLOR" },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES0,
                    "ASE_NEEDS_VERT_TEXTURE_COORDINATES0"
                },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES1,
                    "ASE_NEEDS_VERT_TEXTURE_COORDINATES1"
                },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES2,
                    "ASE_NEEDS_VERT_TEXTURE_COORDINATES2"
                },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES3,
                    "ASE_NEEDS_VERT_TEXTURE_COORDINATES3"
                },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES4,
                    "ASE_NEEDS_VERT_TEXTURE_COORDINATES4"
                },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES5,
                    "ASE_NEEDS_VERT_TEXTURE_COORDINATES5"
                },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES6,
                    "ASE_NEEDS_VERT_TEXTURE_COORDINATES6"
                },
                {
                    TemplateInfoOnSematics.TEXTURE_COORDINATES7,
                    "ASE_NEEDS_VERT_TEXTURE_COORDINATES7"
                },
        ...
        public static readonly Dictionary<TemplateInfoOnSematics, string> InfoToLocalVar =
            new Dictionary<TemplateInfoOnSematics, string>
            {
        ...
        public static readonly Dictionary<
            TemplateInfoOnSematics,
            WirePortDataType
        > InfoToWirePortType = new Dictionary<TemplateInfoOnSematics, WirePortDataType>
        {
        ...
        public static readonly Dictionary<int, TemplateInfoOnSematics> IntToUVChannelInfo =
            new Dictionary<int, TemplateInfoOnSematics>
            {
                { 0, TemplateInfoOnSematics.TEXTURE_COORDINATES0 },
                { 1, TemplateInfoOnSematics.TEXTURE_COORDINATES1 },
                { 2, TemplateInfoOnSematics.TEXTURE_COORDINATES2 },
        ...
        public static readonly Dictionary<int, TemplateSemantics> IntToSemantic = new Dictionary<
            int,
            TemplateSemantics
        >
        {
        ...
        public static readonly Dictionary<TemplateSemantics, int> SemanticToInt = new Dictionary<
            TemplateSemantics,
            int
        >
        {
        ...
        public static readonly Dictionary<string, TemplateSemantics> ShortcutToSemantic =
            new Dictionary<string, TemplateSemantics>
            {
        ...
        public static readonly Dictionary<string, WirePortDataType> CgToWirePortType =
            new Dictionary<string, WirePortDataType>()
            {
                { "float", WirePortDataType.FLOAT },
        ...
        public static readonly Dictionary<string, int> AvailableInterpolators = new Dictionary<
            string,
            int
        >()
        {
        ...
        public static readonly Dictionary<string, int> ShaderModelToArrayIdx = new Dictionary<
            string,
            int
        >()
        {
        ...
        public static readonly Dictionary<string, TemplateSRPType> TagToRenderPipeline =
            new Dictionary<string, TemplateSRPType>()
            {
                { "UniversalPipeline", TemplateSRPType.URP },
                { "LightweightPipeline", TemplateSRPType.URP },
                { "HDRenderPipeline", TemplateSRPType.HDRP },
            };
        public static string CoreColorLib =
            "Packages/com.unity.render-pipelines.core/ShaderLibrary/Color.hlsl";
        public static string CoreCommonLib =
            "Packages/com.unity.render-pipelines.core/ShaderLibrary/Common.hlsl";

        public static string PragmaOnlyRendersPattern = @"#pragma\s+only_renderers\s+([\w .]*)";
        public static string PragmaExcludeRendersPattern =
            @"#pragma\s+exclude_renderers\s+([\w .]*)";
        ...
        public static string GlobalDirectivesPattern =
            "[#]+(define|pragma|include)\\s+([\\w .\\/\\\"]*)";
        public static string BeforePragmaPattern =
            @"(?:CGPROGRAM|HLSLPROGRAM|GLSLPROGRAM).*?\n(\s*)(.)";
        public static string GlobalTOPDirectivesPattern =
            @"(CGPROGRAM|CGINCLUDE|HLSLPROGRAM|HLSLINCLUDE).*?\n\s*(.)";
        ...
        public static readonly string LocalVarPattern =
            @"\/\*ase_local_var[:]*(\w*)\*\/\s*(\w*)\s+(\w*)";

        public static readonly string InlinePattern =
            @"\/\*ase_inline_begin\*\/(.*?)\/\*ase_inline_end\*\/";

        public static readonly string SRPConditionPattern =
            @"\/\*ase_srp_cond_begin:([==|!=|>=|<=|>|<]*)(\d*)\*\/(?s)(.*?)\s\/\*ase_srp_cond_end\*\/";
        public static readonly string UnityConditionPattern =
            @"\/\*ase_unity_cond_begin:([==|!=|>=|<=|>|<]*)(\d*)\*\/(?s)(.*?)\s\/\*ase_unity_cond_end\*\/";

        public static readonly string SubShaderLODPattern = @"\sLOD\s+(\d+)";

        public static readonly string PassNamePattern =
            "Name\\s+\\\"([\\w\\+\\-\\*\\/\\(\\) ]*)\\\"";
        ...
        public static readonly string ZOffsetPattern =
            @"^\s*Offset\s+([-+]?[0-9]*\.?[0-9]+|\[*\w+\]*)\s*,\s*([-+]?[0-9]*\.?[0-9]+|\[*\w+\]*)\s*";
        public static readonly string VertexDataPattern =
            @"([a-z0-9D_]+|samplerCUBE|sampler2DArray)\s+(\w+)\s*:\s*([A-Z0-9_]+);";
        public static readonly string InterpRangePattern =
            @"ase_interp\((\d\.{0,1}\w{0,4}),(\d*)\)";
        ...
        public static readonly string PropertiesPatternI =
            @"^(\s*)(\[[\[\]\w\s\(\)_,\.]*\])*[\s\/]*(\w*)\s*\(\s*""([\w\(\)\+\-\\* ]*)""\s*\,\s*(\w*)\s*.*\)\s*=\s*[\w,()"" {}\.]*";
        ...
        public static readonly string BlendModePatternFirst =
            @"\bBlend([ \t]+0)*[ \t]+(?:Off|(\[*\w+\]*)[ \t]+(\[*\w+\]*)(?:(?=[ \t]+Blend)|(?:[ \t,]+(\[*\w+\]*)[ \t]+(\[*\w+\]*)|)))";
        public static readonly string BlendModePattern =
            @"\bBlend([ \t]+0)[ \t]+(?:Off|(\[*\w+\]*)[ \t]+(\[*\w+\]*)(?:(?=[ \t]+Blend)|(?:[ \t,]+(\[*\w+\]*)[ \t]+(\[*\w+\]*)|)))";
        public static readonly string BlendModePattern1 =
            @"\bBlend([ \t]+1)[ \t]+(?:Off|(\[*\w+\]*)[ \t]+(\[*\w+\]*)(?:(?=[ \t]+Blend)|(?:[ \t,]+(\[*\w+\]*)[ \t]+(\[*\w+\]*)|)))";
        public static readonly string BlendModePattern2 =
            @"\bBlend([ \t]+2)[ \t]+(?:Off|(\[*\w+\]*)[ \t]+(\[*\w+\]*)(?:(?=[ \t]+Blend)|(?:[ \t,]+(\[*\w+\]*)[ \t]+(\[*\w+\]*)|)))";
        public static readonly string BlendModePattern3 =
            @"\bBlend([ \t]+3)[ \t]+(?:Off|(\[*\w+\]*)[ \t]+(\[*\w+\]*)(?:(?=[ \t]+Blend)|(?:[ \t,]+(\[*\w+\]*)[ \t]+(\[*\w+\]*)|)))";
        ...
        public static readonly string BlendOpPatternFirst =
            @"\bBlendOp([ \t]+0)*[ \t]+(\[*\w+\]*)(?:(?=[ \t]+Blend)|[ \t,]*(?:(\[*\w+\]*)|))";
        public static readonly string BlendOpPattern =
            @"\bBlendOp([ \t]+0)[ \t]+(\[*\w+\]*)(?:(?=[ \t]+Blend)|[ \t,]*(?:(\[*\w+\]*)|))";
        public static readonly string BlendOpPattern1 =
            @"\bBlendOp([ \t]+1)[ \t]+(\[*\w+\]*)(?:(?=[ \t]+Blend)|[ \t,]*(?:(\[*\w+\]*)|))";
        public static readonly string BlendOpPattern2 =
            @"\bBlendOp([ \t]+2)[ \t]+(\[*\w+\]*)(?:(?=[ \t]+Blend)|[ \t,]*(?:(\[*\w+\]*)|))";
        public static readonly string BlendOpPattern3 =
            @"\bBlendOp([ \t]+3)[ \t]+(\[*\w+\]*)(?:(?=[ \t]+Blend)|[ \t,]*(?:(\[*\w+\]*)|))";
        ...
        public static readonly string ShaderGlobalsOverallPattern =
            @"(?:\/\*ase_pragma\*\/|[\}\#])[\#\&\|\!\<\>\(\)\=\w\s\;\/\*\.\\""]*\/\*ase_globals\*\/";
        public static readonly string ShaderGlobalsMultilinePattern =
            @"^\s*(?:uniform\s*)*(\w*)\s*(\w*);$";
        ...
        public static readonly string InterpolatorDecl =
            Constants.VertexShaderOutputStr + ".{0} = " + Constants.VertexShaderInputStr + ".{0};";
        ...
        public static readonly string StructsRemoval =
            @"struct\s+\w+\s+{[\#\&\|\!\<\>\s\w\(\).;:=,\/\*]+};";

        public static readonly string SRPBatcherFindTag =
            @"CBUFFER_START\s*\(\s*UnityPerMaterial\s*\)\s*\n(\s*)";
        ...
        public static bool GetPassUniqueId(
            TemplateTagData tagData,
            TemplatePropertyContainer propertyContainer,
            TemplateIdManager idManager,
            string uniquePrefix,
            int offsetIdx,
            string subBody,
            ref string passUniqueID
        )
        {
        ...
        public static bool FetchInvisibleInfo(
            string input,
            ref int optionsArr,
            ref string id,
            ref int idIndex
        ...
        public static string GenerateTextureSemantic(
        ...
        )
        {
            ...
            dataCollector.AddToVertexInterpolatorsDecl(
                string.Format(InterpolatorDecl, texCoordName)
            );
            return texCoordName;
        }

        public static void CreatePragmaIncludeList(
            string data,
            TemplateIncludePragmaContainter includePragmaContainer
        )
        {
            ...
            foreach (
                Match match in Regex.Matches(data, GlobalDirectivesPattern, RegexOptions.Multiline)
            )
            {
                if (match.Success)
                {
        ...
        public static void CreateShaderPropertiesList(
            string propertyData,
            ref List<TemplateShaderPropertyData> propertiesList,
        ...
        )
        {
            ...
            )
            {
                ...
                {
                    if (
                        !duplicatesHelper.ContainsKey(match.Groups[nameIdx].Value)
                        && PropertyToWireType.ContainsKey(match.Groups[typeIdx].Value)
                    )
                    {
                        TemplateShaderPropertyData newData = new TemplateShaderPropertyData(
                            match.Index,
                            match.Value,
        ...
        public const string DepthMacroDeclRegex =
            @"UNITY_DECLARE_DEPTH_TEXTURE\(\s*_CameraDepthTexture";

        public static void CheckUnityBuiltinGlobalMacros(
            string propertyData,
            ref List<TemplateShaderPropertyData> propertiesList,
            ref Dictionary<string, TemplateShaderPropertyData> duplicatesHelper,
            int subShaderId,
        ...
        public static void CreateShaderGlobalsList(
            string propertyData,
            ref List<TemplateShaderPropertyData> propertiesList,
            ref Dictionary<string, TemplateShaderPropertyData> duplicatesHelper,
            int subShaderId,
        ...
        )
        {
            ...
            MatchCollection matchCollection = Regex.Matches(
                propertyData,
                ShaderGlobalsOverallPattern
            );
            string value =
                (matchCollection.Count > 0) ? matchCollection[0].Groups[0].Value : propertyData;
            foreach (
                Match lineMatch in Regex.Matches(
                    value,
                    ShaderGlobalsMultilinePattern,
                    RegexOptions.Multiline
                )
            )
            {
                ...
                {
                    if (
                        !duplicatesHelper.ContainsKey(lineMatch.Groups[nameIdx].Value)
                        && CgToWirePortType.ContainsKey(lineMatch.Groups[typeIdx].Value)
                    )
                    {
                        TemplateShaderPropertyData newData = new TemplateShaderPropertyData(
                            -1,
        ...
        public static void CreateStencilOps(
            string stencilData,
            ref TemplateStencilData stencilDataObj
        )
        {
                            ...
                            case "Ref":
                                {
                                    if (
                                        ...
                                        && IsInlineProperty(match.Groups[2].Value, ref property)
                                    )
                                    {
                                    ...
                                    else
                                    {
                                        try
                                        {
                                            stencilDataObj.Reference = Convert.ToInt32(
                            ...
                            case "ReadMask":
                                {
                                    ...
                                    else
                                    {
                                        try
                                        {
                                            stencilDataObj.ReadMask = Convert.ToInt32(
                                                match.Groups[2].Value
                                            );
                                        }
                                        catch (Exception e)
                            ...
                            case "WriteMask":
                                {
                                    ...
                                    else
                                    {
                                        try
                                        {
                                            stencilDataObj.WriteMask = Convert.ToInt32(
                                                match.Groups[2].Value
                                            );
                                        }
                                        catch (Exception e)
        ...
        public static void CreateColorMask(
            string colorMaskData,
            ref TemplateColorMaskData colorMaskObj,
            string pattern
        )
        {
            ...
            //if( match.Groups.Count == 3 /*&& !match.Groups[ 2 ].Success*/ ) // second group is the colormask MRT which isn't implemented yet
            {
                string property = string.Empty;
                if (
                    match.Groups[1].Success && IsInlineProperty(match.Groups[1].Value, ref property)
                )
                {
                ...
                else
                {
                    ...
                    try
                    {
                        for (int i = 0; i < match.Groups[1].Value.Length; i++)
                        {
                            ...
                            {
                                case 'r':
                                    colorMaskObj.ColorMaskData[0] = true;
                                    break;
                                case 'g':
                                    colorMaskObj.ColorMaskData[1] = true;
                                    break;
                                case 'b':
                                    colorMaskObj.ColorMaskData[2] = true;
                                    break;
                                case 'a':
                                    colorMaskObj.ColorMaskData[3] = true;
                                    break;
                                case '0':
                                {
                                    for (int j = 0; j < 4; j++)
        ...
        public static void CreateAlphaToMask(
            string alphaToMaskData,
            ref TemplateAlphaToMaskData alphaToMaskObj
        )
        {
            ...
            if (match.Groups.Count == 2)
            {
                ...
                else
                {
                    try
                    {
                        alphaToMaskObj.AlphaToMaskData =
                            match.Groups[1].Value == "On" ? true : false;
                        alphaToMaskObj.DataCheck = TemplateDataCheck.Valid;
                    }
                    catch (Exception e)
                    {
        ...
        public static void CreateCullMode(string cullModeData, ref TemplateCullModeData cullDataObj)
        {
            ...
            if (match.Groups.Count == 2)
            {
                ...
                else
                {
                    try
                    {
                        cullDataObj.CullModeData = (CullMode)
                            Enum.Parse(typeof(CullMode), match.Groups[1].Value);
                        cullDataObj.DataCheck = TemplateDataCheck.Valid;
                    }
                    catch (Exception e)
                    {
        ...
        public static void CreateBlendMode(
            string blendModeData,
            ref TemplateBlendData blendDataObj,
            string pattern
        )
        {
                ...
                if (match.Groups.Count <= 4 && match.Groups.Count >= 3)
                {
                    if (match.Groups[0].Success && match.Groups[2].Success)
                    {
                        try
                        {
                            ...
                            {
                                AvailableBlendFactor sourceAll = (AvailableBlendFactor)
                                    Enum.Parse(typeof(AvailableBlendFactor), match.Groups[2].Value);
                                blendDataObj.SourceFactorRGB = sourceAll;
                            }
                            if (
                                match.Groups[3].Success
                                && IsInlineProperty(match.Groups[3].Value, ref property)
                            )
                            {
                            ...
                            {
                                AvailableBlendFactor destAll = (AvailableBlendFactor)
                                    Enum.Parse(typeof(AvailableBlendFactor), match.Groups[3].Value);
                ...
                else if (match.Groups.Count >= 5)
                {
                    ...
                    if (match.Groups[0].Success && match.Groups[2].Success)
                    {
                        try
                        {
                            ...
                            {
                                AvailableBlendFactor sourceRGB = (AvailableBlendFactor)
                                    Enum.Parse(typeof(AvailableBlendFactor), match.Groups[2].Value);
                            ...
                            {
                                AvailableBlendFactor destRGB = (AvailableBlendFactor)
                                    Enum.Parse(typeof(AvailableBlendFactor), match.Groups[3].Value);
                            ...
                            if (match.Groups[4].Success && match.Groups[5].Success)
                            {
                                ...
                                {
                                    AvailableBlendFactor sourceA = (AvailableBlendFactor)
                                        Enum.Parse(
                                            typeof(AvailableBlendFactor),
                                ...
                                {
                                    AvailableBlendFactor destA = (AvailableBlendFactor)
                                        Enum.Parse(
                                            typeof(AvailableBlendFactor),
        ...
        public static void CreateBlendOp(
            string blendOpData,
            ref TemplateBlendData blendDataObj,
            string pattern
        )
                ...
                if (match.Groups.Count == 3)
                {
                    if (match.Groups[0].Success && match.Groups[2].Success)
                    {
                        try
                        {
                            ...
                            {
                                AvailableBlendOps blendOpsAll = (AvailableBlendOps)
                                    Enum.Parse(typeof(AvailableBlendOps), match.Groups[2].Value);
                ...
                else if (match.Groups.Count == 4)
                {
                    if (match.Groups[0].Success && match.Groups[2].Success)
                    {
                        try
                        {
                            ...
                            {
                                AvailableBlendOps blendOpsRGB = (AvailableBlendOps)
                                    Enum.Parse(typeof(AvailableBlendOps), match.Groups[2].Value);
                            ...
                            if (match.Groups[3].Success)
                            {
                                ...
                                {
                                    AvailableBlendOps blendOpsA = (AvailableBlendOps)
                                        Enum.Parse(
                                            typeof(AvailableBlendOps),
        ...
        public static string ProcessSRPConditionals(string body)
        {
            ...
            foreach (Match match in Regex.Matches(body, SRPConditionPattern))
            {
                ...
                if (
                    ...
                    && !processedSignatures.Contains(signature = match.Groups[0].Value)
                )
                {
        ...
        public static void FetchLocalVars(
            string body,
            ref List<TemplateLocalVarData> localVarList,
            TemplateFunctionData vertexFunction,
            TemplateFunctionData fragFunction
        )
        {
                ...
                if (match.Groups.Count == 4)
                {
                    if (CgToWirePortType.ContainsKey(match.Groups[2].Value))
                    {
                        ...
                        if (
                            ...
                            && ShortcutToInfo.ContainsKey(match.Groups[1].Value)
                        )
                        {
                            string id = match
                                .Groups[0]
                                .Value.Substring(0, match.Groups[0].Value.IndexOf("*/") + 2);
                            TemplateLocalVarData data = new TemplateLocalVarData(
                                ShortcutToInfo[match.Groups[1].Value],
                                id,
                                CgToWirePortType[match.Groups[2].Value],
                                category,
                                match.Groups[3].Value,
                                match.Index
                            );
        ...
        public static TemplateSRPType CreateTags(
            ref TemplateTagsModuleData tagsObj,
            bool isSubShader
        )
        {
            TemplateSRPType srpType = TemplateSRPType.BiRP;
            MatchCollection matchColl = Regex.Matches(
                tagsObj.TagsId,
                TagsPattern,
            ...
            if (count > 0)
            {
                for (int i = 0; i < count; i++)
                {
                    if (matchColl[i].Groups.Count == 3)
                    {
                        ...
                        tagsObj.Tags.Add(
                            new TemplatesTagData(
                                matchColl[i].Groups[1].Value,
                                matchColl[i].Groups[2].Value
                            )
                        );
                    }
                }
        ...
        public static void CreateZWriteMode(string zWriteData, ref TemplateDepthData depthDataObj)
        {
            ...
            if (match.Groups.Count == 2)
            {
                ...
                else
                {
                    try
                    {
                        depthDataObj.ZWriteModeValue = (ZWriteMode)
                            Enum.Parse(typeof(ZWriteMode), match.Groups[1].Value);
                        depthDataObj.DataCheck = TemplateDataCheck.Valid;
                        depthDataObj.ValidZWrite = true;
                    }
                    catch
        ...
        public static void CreateZTestMode(string zTestData, ref TemplateDepthData depthDataObj)
        {
            ...
            if (match.Groups.Count == 2)
            {
                ...
                else
                {
                    try
                    {
                        depthDataObj.ZTestModeValue = (ZTestMode)
                            Enum.Parse(typeof(ZTestMode), match.Groups[1].Value);
                        depthDataObj.DataCheck = TemplateDataCheck.Valid;
                        depthDataObj.ValidZTest = true;
                    }
                    catch
            ...
            if (match.Groups.Count == 3)
            {
                try
                {
                    ...
                    if (
                        ...
                        && IsInlineProperty(match.Groups[1].Value, ref property)
                    )
                    {
        ...
        public static List<TemplateVertexData> CreateVertexDataList(
            string vertexData,
                ...
                if (match.Groups.Count > 1)
                {
                    ...
                    try
                    {
                        semantics = (TemplateSemantics)
                            Enum.Parse(typeof(TemplateSemantics), match.Groups[3].Value);
                    }
                    catch (Exception e)
                    {
                        Debug.LogException(e);
                    }
                    TemplateVertexData templateVertexData = new TemplateVertexData(
                        semantics,
                        dataType,
                        varName
                    );
            ...
            if (!string.IsNullOrEmpty(parametersBody))
            {
                ...
                if (paramsArray.Length > 0)
                {
                    for (int i = 0; i < paramsArray.Length; i++)
                    {
                        ...
                        {
                            string[] swizzleInfoArr = paramDataArr[1]
                                .Split(IOUtils.FLOAT_SEPARATOR);
        ...
        public static TemplateInterpData CreateInterpDataList(
            string interpData,
            string fullLine,
        ...
        )
        {
            ...
            if (rangeMatch.Groups.Count > 0)
            {
                ...
                try
                {
                    ...
                    {
                        interpDataObj.AvailableInterpolators.Add(
                            new TemplateInterpElement(IntToSemantic[i])
                        );
                    }
                    if (minValArgs.Length > 1)
                    {
                        interpDataObj
                            .AvailableInterpolators[0]
                            .SetAvailableChannelsFromString(minValArgs[1]);
                    }
                }
                catch (Exception e)
                {
                ...
                string parametersBody = fullLine.Substring(
                    parametersBeginIdx,
                    parametersEnd - parametersBeginIdx
                );
                ...
                {
                    TemplateVertexData templateInterpData = new TemplateVertexData(
                        TemplateSemantics.SV_InstanceID,
                        WirePortDataType.UINT,
                        Constants.InstanceIdVariable
                    );
                ...
                Dictionary<string, TemplateVertexData> auxDict =
                    new Dictionary<string, TemplateVertexData>();
                    ...
                    for (int i = 0; i < paramsArray.Length; i++)
                    {
                        ...
                        if (paramDataArr.Length == 2)
                        {
                            ...
                            if (interpDataDict.ContainsKey(semantic))
                            {
                                ...
                                {
                                    string[] multiComponent = paramDataArr[0]
                                        .Split(IOUtils.FLOAT_SEPARATOR);
                                    ...
                                    if (multiComponent.Length > 1)
                                    {
                                        ...
                                        {
                                            templateInterpData = new TemplateVertexData(
                                                interpDataDict[semantic]
                                            );
                                            //if( swizzleInfoArr.Length > 1 )
                                            //{
                                            //	templateInterpData.DataSwizzle = "." + swizzleInfoArr[ 1 ];
                                            //}
                                            templateInterpData.DataInfo = ShortcutToInfo[
                                                multiComponent[0]
                                            ];
                                            templateInterpData.Available = true;
                                            interpDataList.Add(templateInterpData);
                                        ...
                                        if (swizzleInfoArr[1].Length == multiComponent[1].Length)
                                        {
                                            for (
                                                int channelIdx = 0;
                                                channelIdx < swizzleInfoArr[1].Length;
                                                channelIdx++
                                            )
                                            {
                                                templateInterpData.RegisterComponent(
                                                    multiComponent[1][channelIdx],
                                                    interpDataDict[semantic].VarName
                                                        + "."
                                                        + swizzleInfoArr[1][channelIdx]
                                                );
                                            }
                                        }
                                    }
                                    ...
                                    {
                                        TemplateVertexData templateInterpData =
                                            new TemplateVertexData(interpDataDict[semantic]);
                                        if (swizzleInfoArr.Length > 1)
                                        {
                                            templateInterpData.DataSwizzle =
                                                "." + swizzleInfoArr[1];
                                        }
                                        templateInterpData.DataInfo = ShortcutToInfo[
                                            paramDataArr[0]
        ...
        public static void FetchDependencies(TemplateInfoContainer dependencies, ref string body)
        {
            ...
            else
            {
                ...
                if (lastIndex > 0)
                {
                    body = body.Insert(
                        lastIndex,
                        "\t" + TemplatesManager.TemplateDependenciesListTag + "\n"
                    );
        ...
        public static void FetchCustomInspector(
            TemplateInfoContainer inspectorContainer,
            ref string body
        )
        {
            ...
            if (match != null && match.Groups.Count > 1)
            {
                ...
                if (
                    inspectorContainer.Data.Equals(
        ...
        public static string AutoSwizzleData(
            string dataVar,
            WirePortDataType from,
            WirePortDataType to,
            bool isPosition
        )
        {
                ...
                case WirePortDataType.FLOAT2:
                    {
                        switch (to)
                        {
                            case WirePortDataType.FLOAT4:
                                ...
                                break;
                            case WirePortDataType.FLOAT3:
                                dataVar = string.Format("float3({0},0)", dataVar);
                                break;
                            case WirePortDataType.INT:
                            case WirePortDataType.FLOAT:
                                dataVar += ".x";
                ...
                case WirePortDataType.FLOAT:
                    {
                        switch (to)
                        {
                            case WirePortDataType.FLOAT4:
                                ...
                                break;
                            case WirePortDataType.FLOAT3:
                                dataVar = string.Format("float3({0},0,0)", dataVar);
                                break;
                            case WirePortDataType.FLOAT2:
                                dataVar = string.Format("float2({0},0)", dataVar);
                                break;
                        }
                    }
                    break;
        ...
        public static string WorldSpaceViewDir(
        ...
        public static readonly string FetchDefaultDepthFormat =
            "SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, {0}.xy )";
        public static readonly string FetchDefaultDepthFormatVertex =
            "SAMPLE_DEPTH_TEXTURE_LOD( _CameraDepthTexture, float4( {0}.xy, 0, 0 ) )";

        public static readonly string FetchLWDepthFormat =
            "SHADERGRAPH_SAMPLE_SCENE_DEPTH( {0}.xy )";
        public static readonly string FetchLWDepthFormatVertex =
            "SHADERGRAPH_SAMPLE_SCENE_DEPTH_LOD( {0}.xy )";
        public static readonly string FetchHDDepthFormat = "SampleCameraDepth( {0}.xy )";

        public static string CreateDepthFetch(
            MasterNodeDataCollector dataCollector,
            string screenPos
        )
        {
            ...
            {
                if (
                    dataCollector.TemplateDataCollectorInstance.CurrentSRPType
                    == TemplateSRPType.URP
                )
                {
            ...
            {
                if (dataCollector.PortCategory == MasterNodePortCategory.Vertex)
                    screenDepthInstruction = string.Format(
                        FetchDefaultDepthFormatVertex,
                        screenPos
                    );
                else
        ...
        public static bool GetShaderModelForInterpolatorAmount(
            int interpAmount,
            ref string shaderModel
        )
        {
        ...
        public static void FillRenderingPlatform(
            TemplateRenderPlatformHelper renderPlatforms,
            string shaderBody
        )
        {
            ...
            else
            {
                ...
                {
                    renderPlatforms.InitByExcludeRenders(
                        excludePlatformsMatch.Index,
                        excludePlatformsMatch.Value
                    );
                    MatchCollection platformElements = Regex.Matches(
                        excludePlatformsMatch.Groups[1].Value,
                        PragmaRendererElement
                    );
                    try
                    {
                        for (int i = 0; i < platformElements.Count; i++)
                        {
                            if (platformElements[i].Success)
                                renderPlatforms.SetupPlatform(
                                    platformElements[i].Groups[1].Value,
                                    false
                                );
                        }
                    }
                ...
                {
                    Match onlyRendersPlatformsMatch = Regex.Match(
                        shaderBody,
                        PragmaOnlyRendersPattern
                    );
                    if (onlyRendersPlatformsMatch.Success)
                    {
                        renderPlatforms.InitByOnlyRenders(
                            onlyRendersPlatformsMatch.Index,
                            onlyRendersPlatformsMatch.Value
                        );
                        MatchCollection platformElements = Regex.Matches(
                            onlyRendersPlatformsMatch.Groups[1].Value,
                            PragmaRendererElement
                        );
                        try
                        {
