...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateModuleParent
    {
        ...
        public TemplateModuleParent(string moduleName)
        {
            m_moduleName = moduleName;
            m_unreadableMessage = UnreadableDataMessagePrefix + moduleName;
        }
        ...
        public virtual string GenerateShaderData(bool isSubShader)
        {
            return string.Empty;
        }
        ...
        public bool ValidAndIndependent
        {
            get { return m_validData && m_independentModule; }
        }
