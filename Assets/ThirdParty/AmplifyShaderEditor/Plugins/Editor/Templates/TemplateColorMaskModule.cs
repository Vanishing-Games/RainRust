...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateColorMaskModule : TemplateModuleParent
    {
        ...
        public TemplateColorMaskModule()
            : base("Color Mask") { }
        ...
        public override void Draw(UndoParentNode owner, bool style = true)
        {
            ...
            {
                m_inlineColorMask.CustomDrawer(
                    ref owner,
                    DrawColorMaskControls,
                    ColorMaskContent.text + m_target
                );
            }
        ...
        private void DrawColorMaskControls(UndoParentNode owner)
        {
            ...
            if (
                ...
                || m_middleToggleColorMask.normal.background == null
            )
            {
            ...
            EditorGUILayout.LabelField(
                "Color Mask" + m_target,
                GUILayout.Width(EditorGUIUtility.labelWidth - 3)
            );
        ...
        public InlineProperty InlineColorMask
        {
            get { return m_inlineColorMask; }
        }
    }
}
