...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateCodeSnippetBase : ScriptableObject
    {
        ...
        [SerializeField]
        private List<TemplateCodeSnippetElement> m_elements =
            new List<TemplateCodeSnippetElement>();
        ...
        public virtual bool CheckSnippet()
        {
            return true;
        }
        ...
        public void InsertSnippet(ref string shaderBody)
        {
            ...
            for (int i = 0; i < m_elements.Count; i++)
            {
                shaderBody = shaderBody.Replace(
                    m_elements[i].Id,
                    (insertSnippet ? m_elements[i].Snippet : string.Empty)
                );
            }
        }
        ...
        public TemplateCodeSnippetType Type
        {
            get { return m_type; }
        }
        public List<TemplateCodeSnippetElement> Elements
        {
