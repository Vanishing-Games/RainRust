...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateOptionPortItem
    {
        ...
        public TemplateOptionPortItem(
            TemplateMultiPassMasterNode owner,
            TemplateOptionsItem options
        )
        {
            m_options = options;
                        ...
                        case AseOptionsActionType.SetDefine:
                            {
                                ...
                                for (int nodeIdx = 0; nodeIdx < count; nodeIdx++)
                                {
                                    ...
                                    if (
                                        m_options
                                            .ActionsPerOption[optionId][i]
                                            .ActionData.StartsWith("pragma")
                                    )
                                    {
                                        defineValue =
                                            "#"
                                            + m_options.ActionsPerOption[optionId][i].ActionData;
                                        isPragma = true;
                                    }
                                    else
                                    {
                        ...
                        case AseOptionsActionType.SetShaderProperty:
                            {
                                TemplateShaderPropertyData data =
                                    owner.CurrentTemplate.GetShaderPropertyData(
                                        m_options.ActionsPerOption[optionId][i].ActionData
                                    );
                                if (data != null)
                                {
                                    string newPropertyValue = data.CreatePropertyForValue(
                                        m_options.ActionsPerOption[optionId][i].ActionBuffer
                                    );
        ...
        )
        {
            ...
            if (port != null)
            {
                ...
                {
                    if (
                        string.IsNullOrEmpty(m_options.ActionsPerOption[optionId][i].PassName)
                            ...
                            case AseOptionsActionType.SetDefine:
                                {
                                    ...
                                    owner.OptionsDefineContainer.AddDirective(
                                        defineValue,
                                        true,
                                        isPragma
                                    );
