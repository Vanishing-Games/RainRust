...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateShaderPropertyData
    {
        ...
        public TemplateShaderPropertyData(
            int index,
            string fullValue,
            string identation,
            string propertyInspectorName,
            string propertyName,
            WirePortDataType propertyDataType,
        ...
        )
        {
            ...
            PropertyInspectorName = string.IsNullOrEmpty(propertyInspectorName)
                ? propertyName
            ...
            ReplacementValueHelper =
                (idx >= 0) ? FullValue.Substring(0, idx + 1) + " " : FullValue + " = ";
            IsMacro = isMacro;
        ...
        public override string ToString()
        {
            return string.Format(
                ...
                PropertyName,
                PropertyInspectorName,
                UIUtils.WirePortToCgType(PropertyDataType)
            );
        }
    }
}
