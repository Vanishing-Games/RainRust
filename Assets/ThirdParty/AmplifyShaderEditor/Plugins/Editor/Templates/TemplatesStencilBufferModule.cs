...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TemplatesStencilBufferModule : TemplateModuleParent
    {
        ...
        [SerializeField]
        private InlineProperty m_reference = new InlineProperty(ReferenceDefaultValue);
        ...
        //Comparison Function
        [NonSerialized]
        private int ComparisonDefaultValue = 0;

        [SerializeField]
        private InlineProperty m_comparisonFunctionFrontIdx;

        [SerializeField]
        private InlineProperty m_comparisonFunctionBackIdx;

        //Pass Stencil Op
        [NonSerialized]
        private int PassStencilOpDefaultValue = 0;

        [SerializeField]
        private InlineProperty m_passStencilOpFrontIdx;

        [SerializeField]
        private InlineProperty m_passStencilOpBackIdx;

        //Fail Stencil Op
        [NonSerialized]
        private int FailStencilOpDefaultValue = 0;

        [SerializeField]
        private InlineProperty m_failStencilOpFrontIdx;
        ...
        //ZFail Stencil Op
        [NonSerialized]
        private int ZFailStencilOpDefaultValue = 0;

        [SerializeField]
        private InlineProperty m_zFailStencilOpFrontIdx;

        [SerializeField]
        private InlineProperty m_zFailStencilOpBackIdx;

        public TemplatesStencilBufferModule()
            : base("Stencil Buffer")
        {
        ...
        public void ConfigureFromTemplateData(TemplateStencilData stencilData)
        {
            ...
            if (newValidData && m_validData != newValidData)
            {
                ...
                if (string.IsNullOrEmpty(stencilData.ComparisonFrontInline))
                {
                    ...
                    {
                        m_comparisonFunctionFrontIdx.IntValue = m_comparisonDict[
                            stencilData.ComparisonFront.ToLower()
                        ];
                    }
                    else
                    {
                ...
                if (string.IsNullOrEmpty(stencilData.PassFrontInline))
                {
                    ...
                    {
                        m_passStencilOpFrontIdx.IntValue = m_stencilOpsDict[
                            stencilData.PassFront.ToLower()
                        ];
                    }
                    else
                    {
                ...
                if (string.IsNullOrEmpty(stencilData.FailFrontInline))
                {
                    ...
                    {
                        m_failStencilOpFrontIdx.IntValue = m_stencilOpsDict[
                            stencilData.FailFront.ToLower()
                        ];
                    }
                    else
                    {
                ...
                if (string.IsNullOrEmpty(stencilData.ZFailFrontInline))
                {
                    ...
                    {
                        m_zFailStencilOpFrontIdx.IntValue = m_stencilOpsDict[
                            stencilData.ZFailFront.ToLower()
                        ];
                    }
                    else
                    {
                ...
                if (string.IsNullOrEmpty(stencilData.ComparisonBackInline))
                {
                    ...
                    {
                        m_comparisonFunctionBackIdx.IntValue = m_comparisonDict[
                            stencilData.ComparisonBack.ToLower()
                        ];
                    }
                    else
                    {
                ...
                if (string.IsNullOrEmpty(stencilData.PassBackInline))
                {
                    ...
                    {
                        m_passStencilOpBackIdx.IntValue = m_stencilOpsDict[
                            stencilData.PassBack.ToLower()
                        ];
                    }
                    else
                    {
                ...
                if (string.IsNullOrEmpty(stencilData.FailBackInline))
                {
                    ...
                    {
                        m_failStencilOpBackIdx.IntValue = m_stencilOpsDict[
                            stencilData.FailBack.ToLower()
                        ];
                    }
                    else
                    {
                ...
                if (string.IsNullOrEmpty(stencilData.ZFailBackInline))
                {
                    ...
                    {
                        m_zFailStencilOpBackIdx.IntValue = m_stencilOpsDict[
                            stencilData.ZFailBack.ToLower()
                        ];
                    }
                    else
                    {
        ...
        public string CreateStencilOp(CullMode cullMode)
        {
            ...
            if (
                ...
                && (
                    m_comparisonFunctionBackIdx.IsValid
                    || m_comparisonFunctionBackIdx.IntValue != ComparisonDefaultValue
                    || m_passStencilOpBackIdx.IsValid
                    || m_passStencilOpBackIdx.IntValue != PassStencilOpDefaultValue
                    || m_failStencilOpBackIdx.IsValid
                    || m_failStencilOpBackIdx.IntValue != FailStencilOpDefaultValue
                    || m_zFailStencilOpBackIdx.IsValid
                    || m_zFailStencilOpBackIdx.IntValue != ZFailStencilOpDefaultValue
                )
            )
            {
                if (
                    m_comparisonFunctionFrontIdx.IsValid
                    || m_comparisonFunctionFrontIdx.IntValue != ComparisonDefaultValue
                )
                    result += string.Format(
                        "\tCompFront {0}\n",
                        m_comparisonFunctionFrontIdx.GetValueOrProperty(
                            StencilBufferOpHelper.StencilComparisonValues[
                                m_comparisonFunctionFrontIdx.IntValue
                            ]
                        )
                    );

                if (
                    m_passStencilOpFrontIdx.IsValid
                    || m_passStencilOpFrontIdx.IntValue != PassStencilOpDefaultValue
                )
                    result += string.Format(
                        "\tPassFront {0}\n",
                        m_passStencilOpFrontIdx.GetValueOrProperty(
                            StencilBufferOpHelper.StencilOpsValues[m_passStencilOpFrontIdx.IntValue]
                        )
                    );

                if (
                    m_failStencilOpFrontIdx.IsValid
                    || m_failStencilOpFrontIdx.IntValue != FailStencilOpDefaultValue
                )
                    result += string.Format(
                        "\tFailFront {0}\n",
                        m_failStencilOpFrontIdx.GetValueOrProperty(
                            StencilBufferOpHelper.StencilOpsValues[m_failStencilOpFrontIdx.IntValue]
                        )
                    );

                if (
                    m_zFailStencilOpFrontIdx.IsValid
                    || m_zFailStencilOpFrontIdx.IntValue != ZFailStencilOpDefaultValue
                )
                    result += string.Format(
                        "\tZFailFront {0}\n",
                        m_zFailStencilOpFrontIdx.GetValueOrProperty(
                            StencilBufferOpHelper.StencilOpsValues[
                                m_zFailStencilOpFrontIdx.IntValue
                            ]
                        )
                    );
                ...
                if (
                    ...
                    result += string.Format(
                        ...
                        m_comparisonFunctionBackIdx.GetValueOrProperty(
                            StencilBufferOpHelper.StencilComparisonValues[
                                m_comparisonFunctionBackIdx.IntValue
                            ]
                        )
                    );
                ...
                if (
                    ...
                    result += string.Format(
                        "\tPassBack {0}\n",
                        m_passStencilOpBackIdx.GetValueOrProperty(
                            StencilBufferOpHelper.StencilOpsValues[m_passStencilOpBackIdx.IntValue]
                        )
                    );
                ...
                if (
                    ...
                    result += string.Format(
                        "\tFailBack {0}\n",
                        m_failStencilOpBackIdx.GetValueOrProperty(
                            StencilBufferOpHelper.StencilOpsValues[m_failStencilOpBackIdx.IntValue]
                        )
                    );
                ...
                if (
                    ...
                    result += string.Format(
                        "\tZFailBack {0}\n",
                        m_zFailStencilOpBackIdx.GetValueOrProperty(
                            StencilBufferOpHelper.StencilOpsValues[m_zFailStencilOpBackIdx.IntValue]
                        )
                    );
            }
            else
        ...
        void DrawBlock(UndoParentNode owner, CullMode cullMode)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                {
                    m_comparisonFunctionFrontIdx.EnumTypePopup(
                        ref owner,
                        ComparisonFrontStr,
                        StencilBufferOpHelper.StencilComparisonLabels
                    );
                    m_passStencilOpFrontIdx.EnumTypePopup(
                        ref owner,
                        PassFrontStr,
                        StencilBufferOpHelper.StencilOpsLabels
                    );
                    m_failStencilOpFrontIdx.EnumTypePopup(
                        ref owner,
                        FailFrontStr,
                        StencilBufferOpHelper.StencilOpsLabels
                    );
                    m_zFailStencilOpFrontIdx.EnumTypePopup(
                        ref owner,
                        ZFailFrontStr,
                        StencilBufferOpHelper.StencilOpsLabels
                    );
        ...
        public InlineProperty Reference
        {
            get { return m_reference; }
        }
        public InlineProperty ReadMask
        {
            get { return m_readMask; }
        }
        public InlineProperty WriteMask
        {
            get { return m_writeMask; }
        }
        public InlineProperty ComparisonFunctionIdx
        {
            get { return m_comparisonFunctionFrontIdx; }
        }
        public InlineProperty ComparisonFunctionBackIdx
        {
            get { return m_comparisonFunctionBackIdx; }
        }
        public InlineProperty PassStencilOpIdx
        {
            get { return m_passStencilOpFrontIdx; }
        }
        public InlineProperty PassStencilOpBackIdx
        {
            get { return m_passStencilOpBackIdx; }
        }
        public InlineProperty FailStencilOpIdx
        {
            get { return m_failStencilOpFrontIdx; }
        }
        public InlineProperty FailStencilOpBackIdx
        {
            get { return m_failStencilOpBackIdx; }
        }
        public InlineProperty ZFailStencilOpIdx
        {
            get { return m_zFailStencilOpFrontIdx; }
        }
        public InlineProperty ZFailStencilOpBackIdx
        {
            get { return m_zFailStencilOpBackIdx; }
        }
        ...
        public int ReferenceValue
        {
            ...
            get { return m_reference.IntValue; }
        }
        ...
        public int ReadMaskValue
        {
            ...
            get { return m_readMask.IntValue; }
        }
        ...
        public int WriteMaskValue
        {
            ...
            get { return m_writeMask.IntValue; }
        }
        ...
        public int ComparisonFunctionIdxValue
        {
            ...
            get { return m_comparisonFunctionFrontIdx.IntValue; }
        }
        ...
        public int ComparisonFunctionBackIdxValue
        {
            ...
            get { return m_comparisonFunctionBackIdx.IntValue; }
        }
        ...
        public int PassStencilOpIdxValue
        {
            ...
            get { return m_passStencilOpFrontIdx.IntValue; }
        }
        ...
        public int PassStencilOpBackIdxValue
        {
            ...
            get { return m_passStencilOpBackIdx.IntValue; }
        }
        ...
        public int FailStencilOpIdxValue
        {
            ...
            get { return m_failStencilOpFrontIdx.IntValue; }
        }
        public int FailStencilOpBackIdxValue
        {
            ...
            get { return m_failStencilOpBackIdx.IntValue; }
        }
        ...
        public int ZFailStencilOpIdxValue
        {
            ...
            get { return m_zFailStencilOpFrontIdx.IntValue; }
        }
        ...
        public int ZFailStencilOpBackIdxValue
        {
            ...
            get { return m_zFailStencilOpBackIdx.IntValue; }
        }
    }
}
