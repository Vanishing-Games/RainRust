...
namespace AmplifyShaderEditor
{
    ...
    public class TemplatePass
    {
        ...
        [SerializeField]
        private List<TemplateShaderPropertyData> m_availableShaderGlobals =
        ...
        public TemplatePass(
            ...
            TemplateSubShader subShader,
            int subshaderIdx,
            int passIdx,
            TemplateIdManager idManager,
            string uniquePrefix,
            int offsetIdx,
            TemplatePassInfo passInfo,
        ...
        )
        {
            ...
            if (!m_isMainPass)
            {
                ...
                int idIndex = 0;
                m_isInvisible = TemplateHelperFunctions.FetchInvisibleInfo(
                    passInfo.Data,
                    ref m_invisibleOptions,
                    ref id,
                    ref idIndex
                );
                if (m_isInvisible)
            ...
            if (m_passNameContainer.Index > -1)
            {
                idManager.RegisterId(
                    m_passNameContainer.Index,
                    uniquePrefix + m_passNameContainer.Id,
                    m_passNameContainer.Id
                );
            }
            else
            {
...
#if CUSTOM_OPTIONS_AVAILABLE
            m_customOptionsContainer = TemplateOptionsToolsHelper.GenerateOptionsContainer(
                false,
                passInfo.Data
            );
            ...
            {
                idManager.RegisterId(
                    m_customOptionsContainer.Index,
                    uniquePrefix + m_customOptionsContainer.Body,
                    m_customOptionsContainer.Body,
                    true
                );
            }
            //m_customOptionsContainer.CopyPortOptionsFrom( subShader.CustomOptionsContainer, m_passNameContainer.Data );
#endif
            m_modules = new TemplateModulesData(
                m_customOptionsContainer,
                idManager,
            ...
            if (!m_modules.PassTag.IsValid)
            {
                ...
                m_templateProperties.AddId(
                    passInfo.Data,
                    m_modules.PassTag.Id,
                    passInfo.LocalStartIdx,
                    false
                );
                ...
                idManager.RegisterId(
                    m_modules.PassTag.StartIdx,
                    m_modules.UniquePrefix + m_modules.PassTag.Id,
                    string.Empty
                );
            }
            ...
            Dictionary<string, TemplateShaderPropertyData> ownDuplicatesDict = new Dictionary<
                string,
                TemplateShaderPropertyData
            >(duplicatesHelper);
            TemplateHelperFunctions.CreateShaderGlobalsList(
                passInfo.Data,
                ref m_availableShaderGlobals,
            ...
            {
                TemplateHelperFunctions.CheckUnityBuiltinGlobalMacros(
                    passInfo.Data,
                    ref m_availableShaderGlobals,
                    ref ownDuplicatesDict,
                    subshaderIdx,
            ...
            if (m_vertexDataContainer != null)
                idManager.RegisterId(
                    m_vertexDataContainer.VertexDataStartIdx,
                    uniquePrefix + m_vertexDataContainer.VertexDataId,
                    m_vertexDataContainer.VertexDataId
                );

            if (m_interpolatorDataContainer != null)
                idManager.RegisterId(
                    m_interpolatorDataContainer.InterpDataStartIdx,
                    uniquePrefix + m_interpolatorDataContainer.InterpDataId,
            ...
            if (m_vertexFunctionData != null)
                idManager.RegisterId(
                    m_vertexFunctionData.Position,
                    uniquePrefix + m_vertexFunctionData.Id,
                    m_vertexFunctionData.Id
                );
            ...
            if (m_fragmentFunctionData != null)
                idManager.RegisterId(
                    m_fragmentFunctionData.Position,
                    uniquePrefix + m_fragmentFunctionData.Id,
                    m_fragmentFunctionData.Id
                );
            ...
            if (m_tessVControlTag != null)
                idManager.RegisterId(
                    m_tessVControlTag.StartIdx,
                    uniquePrefix + m_tessVControlTag.Id,
                    m_tessVControlTag.Id
                );

            if (m_tessControlData != null)
                idManager.RegisterId(
                    m_tessControlData.StartIdx,
                    uniquePrefix + m_tessControlData.Id,
                    m_tessControlData.Id
                );

            if (m_tessDomainData != null)
                idManager.RegisterId(
                    m_tessDomainData.StartIdx,
                    uniquePrefix + m_tessDomainData.Id,
                    m_tessDomainData.Id
                );
            ...
            for (int i = 0; i < inputsCount; i++)
            {
                if (m_inputDataList[i] != null)
                    idManager.RegisterId(
                        m_inputDataList[i].TagGlobalStartIdx,
                        uniquePrefix + m_inputDataList[i].TagId,
                        m_inputDataList[i].TagId
                    );
            }
        ...
        void FetchTessellationData(
            TemplateMultiPass template,
            TemplateModulesData subShaderModule,
            int offsetIdx,
            string body
        )
        {
            ...
            try
            {
                ...
                {
                    int beginIdx =
                        controlCodeBegin + TemplatesManager.TemplateTessControlCodeArea.Length;
                    ...
                    string id = body.Substring(
                        controlCodeBegin,
                        endIdx + TemplatesManager.TemplateEndOfLine.Length - controlCodeBegin
                    );
                    string inParameters = parametersArr[0];
                    string outParameters =
                        (parametersArr.Length > 1) ? parametersArr[1] : string.Empty;

                    m_tessControlData = new TemplateTessControlData(
                        offsetIdx + controlCodeBegin,
                        id,
                        inParameters,
                        outParameters
                    );
            ...
            try
            {
                ...
                {
                    int beginIdx =
                        domainCodeBegin + TemplatesManager.TemplateTessDomainCodeArea.Length;
                    int endIdx = body.IndexOf(TemplatesManager.TemplateEndOfLine, beginIdx);
                    int length = endIdx - beginIdx;
                    ...
                    string id = body.Substring(
                        domainCodeBegin,
                        endIdx + TemplatesManager.TemplateEndOfLine.Length - domainCodeBegin
                    );
                    string inParameters =
                        (parametersArr.Length > 0) ? parametersArr[0] : string.Empty;
                    string outParameters =
                        (parametersArr.Length > 1) ? parametersArr[1] : string.Empty;
                    string baryParameters =
                        (parametersArr.Length > 2) ? parametersArr[2] : string.Empty;

                    m_tessDomainData = new TemplateTessDomainData(
                        offsetIdx + domainCodeBegin,
                        id,
                        inParameters,
                        outParameters,
                        baryParameters
        ...
        )
        {
            ...
            try
            {
                ...
                if (vertexDataTagBegin > -1)
                {
                    ...
                    int vertexDataTagEnd = body.IndexOf(
                        TemplatesManager.TemplateEndOfLine,
                        vertexDataTagBegin
                    );
                    m_vertexDataContainer.VertexDataId = body.Substring(
                        vertexDataTagBegin,
                        vertexDataTagEnd
                            + TemplatesManager.TemplateEndOfLine.Length
                            - vertexDataTagBegin
                    );
                    int dataBeginIdx = body.LastIndexOf(
                        '{',
                        vertexDataTagBegin,
                        vertexDataTagBegin
                    );
                    ...
                    string parameters = body.Substring(
                        parametersBegin,
            ...
            try
            {
                ...
                {
                    int interpDataEnd = body.IndexOf(
                        TemplatesManager.TemplateEndOfLine,
                        interpDataBegin
                    );
                    string interpDataId = body.Substring(
                        interpDataBegin,
        ...
        )
        {
            ...
            if (areaBeginIndexes > -1)
            {
                ...
                if (category == MasterNodePortCategory.Fragment)
                {
                    ...
                    Match mainBodyNameMatch = Regex.Match(
                        body,
                        TemplateHelperFunctions.FragmentPragmaPattern
                    );
                    if (mainBodyNameMatch != null && mainBodyNameMatch.Groups.Count == 2)
                    {
                        mainBodyName = mainBodyNameMatch.Groups[1].Value;
                        string pattern = string.Format(
                            TemplateHelperFunctions.FunctionBodyStartPattern,
                            mainBodyName
                        );
                ...
                else
                {
                    ...
                    Match mainBodyNameMatch = Regex.Match(
                        body,
                        TemplateHelperFunctions.VertexPragmaPattern
                    );
                    if (mainBodyNameMatch != null && mainBodyNameMatch.Groups.Count == 2)
                    {
                        mainBodyName = mainBodyNameMatch.Groups[1].Value;
                        ...
                        try
                        {
                            ...
                            if (inputDataArray.Length == 3)
                            {
                                ...
                                if (isInt)
                                {
                                    ...
                                    m_inputDataList.Add(
                                        new TemplateInputData(
                                            inputBeginIndexes[i],
                                            offset + inputBeginIndexes[i],
                                            tagId,
                                            portName,
                                            defaultValue,
                                            dataType,
                            ...
                            else
                            {
                                ...
                                string linkId =
                                    (portLinkIdx < inputDataArray.Length)
                                        ? inputDataArray[portLinkIdx]
                                        : string.Empty;
                                m_inputDataList.Add(
                                    new TemplateInputData(
                                        inputBeginIndexes[i],
        ...
        public TemplateTessVControlTag TessVControlTag
        {
            get { return m_tessVControlTag; }
        }
        public TemplateTessControlData TessControlData
        {
            get { return m_tessControlData; }
        }
        public TemplateTessDomainData TessDomainData
        {
            get { return m_tessDomainData; }
        }
        ...
        public TemplateInfoContainer PassNameContainer
        {
            get { return m_passNameContainer; }
        }
        public bool IsMainPass
        {
            get { return m_isMainPass; }
            set { m_isMainPass = value; }
        }
        public bool IsInvisible
        {
            get { return m_isInvisible; }
        }
        public int InvisibleOptions
        {
            get { return m_invisibleOptions; }
        }
        public int Idx
        {
            get { return m_idx; }
