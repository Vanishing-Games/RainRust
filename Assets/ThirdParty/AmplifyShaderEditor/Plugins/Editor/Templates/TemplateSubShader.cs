...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateSubShader
    {
        ...
        public TemplateSubShader(
            TemplateMultiPass template,
            int subShaderIx,
            TemplateIdManager idManager,
            string uniquePrefix,
            TemplateSubShaderInfo subShaderInfo,
        ...
        )
        {
            ...
            if (m_LODContainer.Index > -1)
            {
                idManager.RegisterId(
                    m_LODContainer.Index,
                    uniquePrefix + "Module" + m_LODContainer.Id,
                    m_LODContainer.Id
                );
            }
            ...
            m_modules = new TemplateModulesData(
                ...
                uniquePrefix + "Module",
                subShaderInfo.StartIdx,
                subShaderInfo.Modules,
                true
            );
            ...
            {
                TemplatePass newPass = new TemplatePass(
                    template,
                    this,
                    subShaderIx,
                    passIdx,
                    idManager,
                    uniquePrefix + "Pass" + passIdx,
                    subShaderInfo.Passes[passIdx].GlobalStartIdx,
                    subShaderInfo.Passes[passIdx],
                    ref ownDuplicatesDict
                );
