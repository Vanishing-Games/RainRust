...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TemplateAlphaToMaskModule : TemplateModuleParent
    {
        ...
        public TemplateAlphaToMaskModule()
            : base("Alpha To Coverage") { }
        ...
        public override void Draw(UndoParentNode owner, bool style = true)
        {
            ...
            m_inlineAlphaToMask.CustomDrawer(
                ref owner,
                (x) =>
                {
                    m_alphaToMask = owner.EditorGUILayoutToggle(AlphaToMaskStr, m_alphaToMask);
                },
                AlphaToMaskStr
            );
        ...
        {
            return AlphaToMaskFormatStr
                + m_inlineAlphaToMask.GetValueOrProperty(m_alphaToMask ? "On" : "Off");
        }
