...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateOptionsDefinesContainer
    {
        ...
        [NonSerialized]
        private Dictionary<string, PropertyDataCollector> m_directivesDict =
        ...
        {
            List<PropertyDataCollector> temporaries = m_directivesList.FindAll(
                (x) => (x.NodeId == 1)
            );
