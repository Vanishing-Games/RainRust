...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateIncludePragmaContainter
    {
        ...
        public List<string> IncludesList
        {
            get { return m_includesList; }
        }
        public List<string> PragmasList
        {
            get { return m_pragmasList; }
        }
        public List<string> DefinesList
        {
            get { return m_definesList; }
        }
        public List<string> NativeDirectivesList
        {
            get { return m_nativeDirectivesList; }
        }
        public int NativeTopIndex
        {
            get { return m_nativeTopIndex; }
        }
    }
    ...
    public class TemplateDataParent : ScriptableObject
    {
        ...
        public string Name
        {
            ...
            set
            {
                m_name = value.StartsWith("Hidden/")
                    ? value.Replace("Hidden/", string.Empty)
                    : value;
            }
        }
        public string GUID
        ...
        {
            get { return m_defaultShaderName; }
            set { m_defaultShaderName = value; }
        }
        public bool IsValid
        {
        ...
        public virtual void Init(string name, string guid, string path, bool isCommunity)
        {
            m_communityTemplate = isCommunity;
        }
    }
}
