...
namespace AmplifyShaderEditor
{
    public partial class Preferences
    {
        public class Project
        {
            ...
            {
                public static readonly GUIContent AutoSRP = new GUIContent(
                ...
                public static readonly GUIContent DefineSymbol = new GUIContent(
                ...
                public static readonly GUIContent TemplateExtensions = new GUIContent(
                    "Template Extensions",
                    "Supported file extensions for parsing shader templates."
                );
            }
            ...
            public static void LoadSettings()
            {
                ...
                catch (System.Exception e)
                {
                    if (e.GetType() == typeof(FileNotFoundException))
                    {
                        ...
                        Values.DefineSymbol = EditorPrefs.GetBool(
                            "ASEDefineSymbol",
                            Defaults.DefineSymbol
                        );
                    ...
                    {
                        Debug.LogWarning(
                            "[AmplifyTexture] Failed importing \""
                                + RelativePath
            ...
            public static void SaveSettings()
            {
                if (DefineSymbol)
                {
                    IOUtils.SetAmplifyDefineSymbolOnBuildTargetGroup(
                        EditorUserBuildSettings.selectedBuildTargetGroup
                    );
                }
                else
                {
                    IOUtils.RemoveAmplifyDefineSymbolOnBuildTargetGroup(
                        EditorUserBuildSettings.selectedBuildTargetGroup
                    );
                }
            ...
            public static void InspectorLayout()
            {
                ...
                Values.DefineSymbol = EditorGUILayout.Toggle(
                    Styles.DefineSymbol,
                    Values.DefineSymbol
                );
                Values.TemplateExtensions = EditorGUILayout.TextField(
                    Styles.TemplateExtensions,
                    Values.TemplateExtensions
                );
            }
        }
    }
