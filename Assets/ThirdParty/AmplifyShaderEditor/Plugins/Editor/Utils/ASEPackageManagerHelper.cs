...
namespace AmplifyShaderEditor
{
    ...
    public static class AssetDatabaseEX
    {
        ...
        public static System.Type Type
        {
            ...
            {
                return (type == null)
                    ? type = System.Type.GetType("UnityEditor.AssetDatabase, UnityEditor")
                    : type;
            }
        }
        ...
        {
            AssetDatabaseEX.Type.InvokeMember(
                "ImportPackageImmediately",
                BindingFlags.Static | BindingFlags.NonPublic | BindingFlags.InvokeMethod,
                null,
                null,
                new object[] { packagePath }
            );
        }
    }
    ...
    public static class ASEPackageManagerHelper
    {
        ...
        private static string NewVersionDetectedFormat =
            "A new {0} version {1} was detected and new templates are being imported.\nPlease hit the Update button on your ASE canvas to recompile your shader under the newest version.";
        ...
        private static Dictionary<int, ASESRPPackageDesc> m_srpPackageSupport = new Dictionary<
            int,
            ASESRPPackageDesc
        >()
        {
            {
                ...
                new ASESRPPackageDesc(
                    ...
                    "2243c8b4e1ab6914995699133f67ab5a"
                )
            },
            {
            ...
            },
            {
                ...
                new ASESRPPackageDesc(
                    ...
                    "57fcea0ed8b5eb347923c4c21fa31b57",
                    "9a5e61a8b3421b944863d0946e32da0a"
                )
            },
            {
            ...
            },
            {
                ...
                new ASESRPPackageDesc(
                    ...
                    "2e9da72e7e3196146bf7d27450013734",
            ...
            },
            {
                ...
                new ASESRPPackageDesc(
                    ...
                    "0904cdf24ddcd5042b024326476220d5",
            ...
            },
            {
                ...
                new ASESRPPackageDesc(
                    ...
                    "89da50d95d149b744bf10bd27babcf79",
                    "daf511a6dae20e641a9d69d025f023e4"
                )
            },
        };
        ...
        public static bool FoundURPVersion
        {
            get { return m_urpPackageInfo != null; }
        }
        public static bool FoundHDRPVersion
        {
            get { return m_hdrpPackageInfo != null; }
        }
        ...
        public static bool CheckImporter
        {
            get { return m_importingPackage != ASEImportFlags.None; }
        }
        public static bool IsProcessing
        {
            get { return m_requireUpdateList && m_importingPackage == ASEImportFlags.None; }
        }
        ...
        public static ASESRPBaseline CurrentURPBaseline
        {
            get { return m_currentURPBaseline; }
        }
        public static ASESRPBaseline CurrentHDRPBaseline
        {
            get { return m_currentHDRPBaseline; }
        }

        private static int m_packageURPVersion = -1; // @diogo: starts as missing
        private static int m_packageHDRPVersion = -1;

        public static int PackageSRPVersion
        {
            get
            {
                return (m_packageHDRPVersion >= m_packageURPVersion)
        ...
        {
            get { return UIUtils.CurrentWindow.MainGraphInstance.IsSRP ? PackageSRPVersion : -1; }
        }
        ...
        public static void CheckLatePackageImport()
        {
            if (
                ...
                && m_lateImport
                && !string.IsNullOrEmpty(m_latePackageToImport)
            )
            {
                m_lateImport = false;
        ...
        public static void StartImporting(string packagePath)
        {
            ...
            if (Application.isPlaying)
            {
                if (!m_lateImport)
                {
                    ...
                    Debug.LogWarning(
                        "Amplify Shader Editor requires the \""
                            + packagePath
                            + "\" package to be installed in order to continue. Please exit Play mode to proceed."
                    );
                }
                return;
            }
        ...
        private static int PackageVersionStringToCode(
            string version,
            out int major,
            out int minor,
            out int patch
        ...
        private static void CodeToPackageVersionElements(
            int versionCode,
            out int major,
            out int minor,
            out int patch
        ...
        private static void CheckPackageImport(
            ASEImportFlags flag,
            ASESRPBaseline baseline,
            string guid,
            string version
        )
        {
        ...
        public static void Update()
        {
            ...
            if (m_requireUpdateList && m_importingPackage == ASEImportFlags.None)
            {
                if (
                    ...
                    && m_packageListRequest.IsCompleted
                    && m_packageListRequest.Result != null
                )
                {
                    m_requireUpdateList = false;
                    foreach (
                        UnityEditor.PackageManager.PackageInfo pi in m_packageListRequest.Result
                    )
                    {
                        int version = PackageVersionStringToCode(
                            pi.version,
                            out int major,
                            out int minor,
                            out int patch
                        ...
                        if (
                            pi.name.Equals(URPPackageId)
                            && m_srpPackageSupport.TryGetValue(baseline, out match)
                        )
                        {
        ...
        public static void SetASEVersionInfoOnDataCollector(
        ...
        )
        {
            ...
            dataCollector.AddToDirectives(
                string.Format(ASEVersionKeywordFormat, VersionInfo.FullNumber),
                -1,
        ...
        public static void SetSRPInfoOnDataCollector(ref MasterNodeDataCollector dataCollector)
        {
            ...
            {
                dataCollector.AddToDirectives(
                    string.Format(SRPKeywordFormat, m_packageHDRPVersion),
                    -1,
                    AdditionalLineType.Define
                );
            }
            ...
            {
                dataCollector.AddToDirectives(
                    string.Format(SRPKeywordFormat, m_packageURPVersion),
                    -1,
                    AdditionalLineType.Define
                );
            }
