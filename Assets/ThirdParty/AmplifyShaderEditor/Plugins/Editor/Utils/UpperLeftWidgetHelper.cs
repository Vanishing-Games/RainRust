...
namespace AmplifyShaderEditor
{
    public class UpperLeftWidgetHelper
    {
        public int DrawWidget(ParentNode owner, int selectedIndex, GUIContent[] displayedOptions)
        {
            ...
            {
                int newValue = owner.EditorGUIPopup(
                    owner.DropdownRect,
                    selectedIndex,
                    displayedOptions,
        ...
        )
        {
            if (owner.DropdownEditing)
            {
                int newValue = owner.EditorGUIIntPopup(
                    owner.DropdownRect,
                    selectedIndex,
                    displayedOptions,
                    optionValues,
        ...
        // GC free version
        public void DrawWidget<TEnum>(
            ref TEnum selectedIndex,
            ParentNode owner,
