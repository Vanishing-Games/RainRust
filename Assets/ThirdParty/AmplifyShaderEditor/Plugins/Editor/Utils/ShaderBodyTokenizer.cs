...
namespace AmplifyShaderEditor
{
    ...
    public class ShaderBodyTokenTable
    {
        ...
        private Dictionary<string, List<LinkedListNode<TokenDesc>>> tokensByName =
            new Dictionary<string, List<LinkedListNode<TokenDesc>>>();
        private Dictionary<int, List<LinkedListNode<TokenDesc>>> tokensByLine =
            new Dictionary<int, List<LinkedListNode<TokenDesc>>>();

        private static List<LinkedListNode<TokenDesc>> EmptyTokenList =
            new List<LinkedListNode<TokenDesc>>();
