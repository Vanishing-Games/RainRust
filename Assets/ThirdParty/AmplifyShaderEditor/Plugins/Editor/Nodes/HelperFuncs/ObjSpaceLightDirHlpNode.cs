        ...
        )
        {
            if (dataCollector.IsTemplate)
            {
                ...
                return GetOutputVectorItem(
                    0,
                    outputId,
                    dataCollector.TemplateDataCollectorInstance.GetObjectSpaceLightDir(
            ...
            string vertexPos = GeneratorUtils.GenerateVertexPosition(
                ref dataCollector,
                UniqueId,
            ...
            return GetOutputVectorItem(
                0,
                outputId,
                GeneratorUtils.GenerateObjectLightDirection(
                    ref dataCollector,
                    UniqueId,
                    CurrentPrecisionType,
                    vertexPos
