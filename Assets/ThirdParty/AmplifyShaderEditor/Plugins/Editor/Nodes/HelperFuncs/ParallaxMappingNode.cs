    ...
    public sealed class ParallaxMappingNode : ParentNode
    {
        ...
        public override void SetPreviewInputs()
        {
            ...
            PreviewMaterial.SetFloat(
                m_cachedPropertyId,
                (m_selectedParallaxType == ParallaxType.Normal ? 0 : 1)
            );
        }
        ...
        public override void Draw(DrawInfo drawInfo)
        {
            ...
            m_selectedParallaxTypeInt = m_upperLeftWidget.DrawWidget(
                this,
        ...
        public override void ReadFromString(ref string[] nodeParams)
        {
            ...
            m_selectedParallaxType = (ParallaxType)
                Enum.Parse(typeof(ParallaxType), GetCurrentParam(ref nodeParams));
            switch (m_selectedParallaxType)
            {
                default:
                case ParallaxType.Normal:
