    ...
    public sealed class DitheringNode : ParentNode
    {
        ...
        protected override void CommonInit(int uniqueId)
        {
            ...
            SetAdditonalTitleText(
                string.Format(Constants.SubTitleTypeFormatStr, PatternsStr[m_selectedPatternInt])
            );
            UpdatePorts();
        }
        ...
        public override void Draw(DrawInfo drawInfo)
        {
            ...
            m_selectedPatternInt = m_upperLeftWidget.DrawWidget(
                this,
                m_selectedPatternInt,
                PatternsStr
            );
                ...
                case 0:
                    {
                        ...
                        m_functionHeader =
                            "Dither" + PatternsFuncStr[m_selectedPatternInt] + "( {0}, {1} )";
                        IOUtils.AddFunctionHeader(
                            ref m_functionBody,
                            "inline float Dither"
                                + PatternsFuncStr[m_selectedPatternInt]
                                + "( int x, int y )"
                        );
                ...
                case 2:
                    {
                        ...
                        m_functionBody = string.Empty;
                        m_functionHeader =
                            "Dither" + PatternsFuncStr[m_selectedPatternInt] + "( {0}, {1}, {2} )";
                        ...
                        string samplingCall = GeneratorUtils.GenerateSamplingCall(
                            ...
                            "noiseTexture",
                            "samplernoiseTexture",
                            "screenPos.xy * _ScreenParams.xy * noiseTexelSize.xy",
                            MipType.MipLevel,
                            "0"
                        );
                        IOUtils.AddFunctionLine(
                            ref m_functionBody,
                            "float dither = " + samplingCall + ".g;"
                        );
                        IOUtils.AddFunctionLine(
                            ref m_functionBody,
        ...
        )
        {
            ...
            if (m_customScreenPos && m_inputPorts[2].IsConnected)
            {
                ...
                string customScreenPosVal = m_inputPorts[2]
            ...
            else
            {
                ...
                {
                    varName = GeneratorUtils.GenerateScreenPositionPixelOnFrag(
                        ref dataCollector,
                        UniqueId,
                        CurrentPrecisionType
                    );
                ...
                else
                {
                    ...
                    {
                        varName = dataCollector.TemplateDataCollectorInstance.GetScreenPosPixel(
                            CurrentPrecisionType
                        );
                    }
                    else
                    {
                        varName = GeneratorUtils.GenerateScreenPositionPixel(
                            ref dataCollector,
                            UniqueId,
                            CurrentPrecisionType,
            ...
            switch (m_selectedPatternInt)
            {
                default:
                case 0:
                    functionResult = dataCollector.AddFunctions(
                        m_functionHeader,
                        m_functionBody,
                        "fmod( " + varName + ".x, 4 )",
                        "fmod( " + varName + ".y, 4 )"
