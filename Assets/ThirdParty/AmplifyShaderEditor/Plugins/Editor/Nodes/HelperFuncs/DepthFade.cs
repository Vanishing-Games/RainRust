    ...
    public sealed class DepthFade : ParentNode
    {
        ...
        )
        {
            ...
            if (vertexPosPort.IsConnected)
            {
                ...
                screenPosNorm = GeneratorUtils.GenerateScreenPositionNormalizedForValue(
                    vertexPosVar,
                    OutputId,
                    ref dataCollector,
                    UniqueId,
            ...
            string screenDepth = TemplateHelperFunctions.CreateDepthFetch(
                dataCollector,
                screenPosNorm
            );
            ...
            dataCollector.AddLocalVariable(
                UniqueId,
                "float screenDepth" + OutputId + " = " + screenDepth + ";"
            );
