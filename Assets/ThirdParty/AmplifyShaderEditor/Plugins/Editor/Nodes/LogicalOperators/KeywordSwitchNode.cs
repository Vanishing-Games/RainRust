...
namespace AmplifyShaderEditor
{
    ...
    [NodeAttributes(
        ...
        Deprecated = true,
        DeprecatedAlternativeType = typeof(StaticSwitch),
        DeprecatedAlternative = "Static Switch"
    )]
    public sealed class KeywordSwitchNode : ParentNode
    {
            ...
            if (m_inputPorts[otherPortId].IsConnected)
            {
                m_mainPortType =
                    (
                        ...
                        > UIUtils.GetPriority(m_inputPorts[otherPortId].DataType)
                    )
        ...
        )
        {
            ...
            dataCollector.AddLocalVariable(
                UniqueId,
                outType + " " + localVarName + " = " + trueCode + ";",
                true
            );
            dataCollector.AddLocalVariable(UniqueId, "#else", true);
            dataCollector.AddLocalVariable(
                UniqueId,
                outType + " " + localVarName + " = " + falseCode + ";",
                true
            );
