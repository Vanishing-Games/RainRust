...
namespace AmplifyShaderEditor
{
    ...
    [NodeAttributes(
        "Flip",
        "Vector Operators",
        "Flip value sign on specific channels from vectors or color components.",
        tags: "invert sign"
    )]
    public sealed class FlipNode : ParentNode
    {
        ...
        private void UpdateTitle()
        {
            ...
            SetAdditonalTitleText(
                (additionalText.Length > 0) ? "Value( " + additionalText + " )" : string.Empty
            );
        }
        ...
        )
        {
            ...
            string outputType = UIUtils.PrecisionWirePortToCgType(
