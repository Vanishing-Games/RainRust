...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TFHCIf : ParentNode
    {
        ...
        void TestMainInputDataType()
        {
            ...
            if (
                m_inputPorts[0].IsConnected
                && UIUtils.GetPriority(m_inputPorts[0].DataType) > UIUtils.GetPriority(newType)
            )
            {
            ...
            if (
                ...
                && (UIUtils.GetPriority(m_inputPorts[1].DataType) > UIUtils.GetPriority(newType))
            )
            {
            ...
            if (
                m_inputPorts[5].IsConnected
                && (UIUtils.GetPriority(m_inputPorts[5].DataType) > UIUtils.GetPriority(newType))
            )
            {
