...
namespace AmplifyShaderEditor
{
    ...
    public sealed class HDEmissionNode : ParentNode
    {
        ...
        public const string CommonLightingLib =
        ...
        public const string ErrorOnCompilationMsg =
            "Attempting to use HDRP specific node on incorrect SRP or Builtin RP.";
        public const string MinorVersionMsg =
            "This node require at least Unity 2019.1/HDRP v5 to properly work.";
        ...
        {
            base.DrawProperties();
            m_intensityUnit = (HDEmissionIntensityUnit)EditorGUILayoutEnumPopup(
                IntensityUnityLabel,
                m_intensityUnit
            );
        ...
        )
        {
            ...
            string expositionWeightValue = m_inputPorts[2]
            ...
            if (m_normalizeColor)
            {
                ...
                dataCollector.AddFunction(
                    EmissionFunctionWithNormalize[0],
                    EmissionFunctionWithNormalize,
                    false
                );
            }
            else
        ...
        public override void ReadFromString(ref string[] nodeParams)
        {
            ...
            Enum.TryParse<HDEmissionIntensityUnit>(
