...
namespace AmplifyShaderEditor
{
    ...
    public class ObjectBoundsNode : ParentNode
    {
        public const string NodeErrorMsg =
            "This node requires Universal or High-definition rendering pipeline version 14.0.4 or higher.";
        ...
        )
        {
            ...
            if (outputId == 0)
            {
                return dataCollector.TemplateDataCollectorInstance.GenerateObjectBoundsMin(
                    ref dataCollector,
                    UniqueId
                );
            }
            ...
            {
                return dataCollector.TemplateDataCollectorInstance.GenerateObjectBoundsMax(
                    ref dataCollector,
                    UniqueId
                );
            }
            ...
            {
                return dataCollector.TemplateDataCollectorInstance.GenerateObjectBoundsSize(
                    ref dataCollector,
                    UniqueId
                );
            }
