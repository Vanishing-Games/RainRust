...
namespace AmplifyShaderEditor
{
    ...
    public class ObjectScaleNode : ParentNode
    {
        ...
        public override void DrawProperties()
        {
            ...
            m_rotationIndependentScale = EditorGUILayoutToggle(
                RotationIndependentScaleStr,
                m_rotationIndependentScale
            );
        ...
        {
            string objectScale = m_rotationIndependentScale
                ? GeneratorUtils.GenerateRotationIndependentObjectScale(ref dataCollector, UniqueId)
