...
namespace AmplifyShaderEditor
{
    ...
    public class UndoParentNode : ScriptableObject
    {
        ...
        public string EditorGUILayoutStringField(
            string name,
            string value,
        ...
        public string EditorGUILayoutTextField(
            GUIContent label,
            string text,
            params GUILayoutOption[] options
        )
        ...
        public Enum EditorGUILayoutEnumPopup(
            GUIContent label,
            Enum selected,
            params GUILayoutOption[] options
        )
        ...
        public Enum EditorGUILayoutEnumPopup(Enum selected, params GUILayoutOption[] options)
        {
            ...
            if (!newValue.ToString().Equals(selected.ToString()))
            {
                UndoRecordObject(
                    string.Concat(
                        "Changing value EditorGUILayoutEnumPopup on node ",
                        ((m_nodeAttribs != null) ? m_nodeAttribs.Name : GetType().ToString())
                    )
                );
        ...
        public int EditorGUILayoutIntPopup(
            string label,
            int selectedValue,
        ...
        public bool EditorGUILayoutToggle(
            GUIContent label,
            bool value,
            params GUILayoutOption[] options
        )
        ...
        public int EditorGUILayoutIntField(
            GUIContent label,
            int value,
            params GUILayoutOption[] options
        )
        ...
        public float EditorGUILayoutFloatField(
            GUIContent label,
            float value,
            params GUILayoutOption[] options
        )
        ...
        public Color EditorGUILayoutColorField(
            string label,
            Color value,
            params GUILayoutOption[] options
        )
        ...
        public UnityEngine.Object EditorGUILayoutObjectField(
            string label,
        ...
        public Vector4 EditorGUILayoutVector4Field(
            string label,
            Vector4 value,
            params GUILayoutOption[] options
        )
        ...
        public bool EditorGUILayoutToggleLeft(
            string label,
            bool value,
            params GUILayoutOption[] options
        )
        ...
        public string EditorGUILayoutTextArea(
            string text,
            GUIStyle style,
            params GUILayoutOption[] options
        )
        ...
        public string EditorGUITextArea(
            Rect position,
            string text,
            [UnityEngine.Internal.DefaultValue("EditorStyles.textField")] GUIStyle style
        )
        {
        ...
        public string EditorGUITextField(
            Rect position,
            string label,
            string text,
            [UnityEngine.Internal.DefaultValue("EditorStyles.textField")] GUIStyle style
        ...
        public Color EditorGUIColorField(
            Rect position,
            GUIContent label,
            Color value,
            bool showEyedropper,
        ...
        public int EditorGUIIntField(
            Rect position,
            string label,
            int value,
            [UnityEngine.Internal.DefaultValue("EditorStyles.numberField")] GUIStyle style
        )
        {
        ...
        public float GUIHorizontalSlider(
            Rect position,
            float value,
            float leftValue,
            float rightValue,
        ...
        public Enum EditorGUIEnumPopup(Rect position, Enum selected)
        {
            ...
            if (!newValue.ToString().Equals(selected.ToString()))
            {
                UndoRecordObject(
                    string.Concat(
                        "Changing value EditorGUIEnumPopup on node ",
                        ((m_nodeAttribs != null) ? m_nodeAttribs.Name : GetType().ToString())
                    )
                );
        ...
        public Enum EditorGUIEnumPopup(
            Rect position,
            Enum selected,
            [UnityEngine.Internal.DefaultValue("EditorStyles.popup")] GUIStyle style
        )
        {
        ...
        {
            int newValue = EditorGUI.IntPopup(
                position,
                selectedValue,
                displayedOptions,
                optionValues,
        ...
        public UnityEngine.Object EditorGUIObjectField(
            Rect position,
            UnityEngine.Object obj,
            System.Type objType,
            bool allowSceneObjects
