...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TFHCGrayscale : ParentNode
    {
        ...
        [SerializeField]
        private readonly string[] m_GrayscaleStyleValues =
        {
            "Luminance",
            "Natural Classic",
            "Old School",
        ...
        public override void Draw(DrawInfo drawInfo)
        {
            ...
            m_grayscaleStyle = m_upperLeftWidget.DrawWidget(
                this,
                m_grayscaleStyle,
                m_GrayscaleStyleValues
            );
        ...
        public override void DrawProperties()
        {
            base.DrawProperties();
            EditorGUI.BeginChangeCheck();
            m_grayscaleStyle = EditorGUILayoutPopup(
                GrayscaleStyleStr,
                m_grayscaleStyle,
                m_GrayscaleStyleValues
            );
        ...
        )
        {
            ...
            switch (m_grayscaleStyle)
            {
                case 1:
                    {
                        grayscale = "dot(" + i + ", float3(0.299,0.587,0.114))";
                    }
                    break;
                case 2:
                    {
                        grayscale = "(" + i + ".r + " + i + ".g + " + i + ".b) / 3";
                    }
                    break;
                default:
                    {
                        grayscale = "Luminance(" + i + ")";
                    }
                    break;
            }
