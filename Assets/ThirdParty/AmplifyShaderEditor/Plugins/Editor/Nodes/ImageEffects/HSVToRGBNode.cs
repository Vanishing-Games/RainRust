...
namespace AmplifyShaderEditor
{
    ...
    public sealed class HSVToRGBNode : ParentNode
    {
        ...
        public static readonly string[] HSVToRGBFunction =
        {
            "{0}3 HSVToRGB( {0}3 c )\n",
            "{\n",
        ...
        public static readonly bool[] HSVToRGBFlags = { true, false, true, true, false, false };
        ...
        public static void AddHSVToRGBFunction(
            ...
            if (!dataCollector.HasFunction(HSVToRGBHeader))
            {
                ...
                for (int i = 0; i < HSVToRGBFunction.Length; i++)
                {
                    finalFunction +=
                        ...
                        + (
                            HSVToRGBFlags[i]
                                ? string.Format(HSVToRGBFunction[i], precisionString)
                                : HSVToRGBFunction[i]
                        );
                }
        ...
        )
        {
            ...
            string precisionString = UIUtils.PrecisionWirePortToCgType(
            ...
            RegisterLocalVariable(
                0,
                string.Format(HSVToRGBHeader, precisionString, hue, saturation, value),
                ref dataCollector,
                "hsvTorgb" + OutputId
            );
            return GetOutputVectorItem(
