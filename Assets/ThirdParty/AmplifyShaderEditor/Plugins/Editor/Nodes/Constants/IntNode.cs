...
namespace AmplifyShaderEditor
{
    ...
    public sealed class IntNode : PropertyNode
    {
        ...
        public IntNode(int uniqueId, float x, float y, float width, float height)
        ...
        private void DrawSetAsUINT()
        {
            ...
            {
                WirePortDataType portType = m_setAsUINT
        ...
        public override void DrawMaterialProperties()
        {
            ...
            m_materialValue = EditorGUILayoutIntField(
        ...
        public override void Draw(DrawInfo drawInfo)
        {
            ...
            if (m_isEditingFields && m_currentParameterType != PropertyType.Global)
            {
                ...
                {
                    EditorGUI.BeginChangeCheck();
                    m_materialValue = EditorGUIIntField(
                        m_propertyDrawPos,
                        "  ",
                        m_materialValue,
                ...
                else
                {
                    ...
                    m_defaultValue = EditorGUIIntField(
                        m_propertyDrawPos,
                        "  ",
                        m_defaultValue,
                        UIUtils.MainSkin.textField
            ...
            return (m_materialMode && m_currentParameterType != PropertyType.Constant)
                ? m_materialValue.ToString(
                    Mathf.Abs(m_materialValue) > 1000
                        ? Constants.PropertyBigIntFormatLabel
                        : Constants.PropertyIntFormatLabel
                )
        ...
        {
            Shader.SetGlobalInt(m_propertyName, m_defaultValue);
        }

        public override void FetchGlobalValue()
        {
            m_materialValue = Shader.GetGlobalInt(m_propertyName);
        }
