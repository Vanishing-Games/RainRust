...
namespace AmplifyShaderEditor
{
    ...
    public sealed class Vector2Node : PropertyNode
    {
        ...
        public Vector2Node(int uniqueId, float x, float y, float width, float height)
        ...
        {
            m_defaultValue = EditorGUILayoutVector2Field(
        ...
        public override void DrawMaterialProperties()
        {
            ...
            m_materialValue = EditorGUILayoutVector2Field(
        ...
        public override void SetPreviewInputs()
        {
            ...
            if (m_materialMode && m_currentParameterType != PropertyType.Constant)
                PreviewMaterial.SetVector(
                    m_cachedPropertyId,
                    new Vector4(m_materialValue[0], m_materialValue[1], 0, 0)
                );
            else
                PreviewMaterial.SetVector(
                    m_cachedPropertyId,
                    new Vector4(m_defaultValue[0], m_defaultValue[1], 0, 0)
                );
        }
        ...
        )
        {
            ...
            if (result.Equals(string.Empty))
            {
                UIUtils.ShowMessage(
                    UniqueId,
                    "Vector2Node generating empty code",
