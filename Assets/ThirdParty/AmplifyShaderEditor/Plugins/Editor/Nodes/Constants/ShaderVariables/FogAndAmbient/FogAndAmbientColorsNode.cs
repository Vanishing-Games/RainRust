...
namespace AmplifyShaderEditor
{
    ...
    public sealed class FogAndAmbientColorsNode : ShaderVariablesNode
    {
        ...
        [SerializeField]
        private BuiltInFogAndAmbientColors m_selectedType =
            BuiltInFogAndAmbientColors.UNITY_LIGHTMODEL_AMBIENT;
        ...
        public override void Draw(DrawInfo drawInfo)
        {
            ...
            m_selectedType = (BuiltInFogAndAmbientColors)
                m_upperLeftWidget.DrawWidget(this, (int)m_selectedType, ColorValuesStr);
        ...
        public override void DrawProperties()
        {
            base.DrawProperties();
            EditorGUI.BeginChangeCheck();
            m_selectedType = (BuiltInFogAndAmbientColors)EditorGUILayoutPopup(
                ColorLabelStr,
                (int)m_selectedType,
                ColorValuesStr
            );
        ...
        public override void ReadFromString(ref string[] nodeParams)
        {
            ...
            m_selectedType = (BuiltInFogAndAmbientColors)
                Enum.Parse(typeof(BuiltInFogAndAmbientColors), GetCurrentParam(ref nodeParams));
            ChangeOutputName(0, ColorValuesStr[(int)m_selectedType]);
        }
