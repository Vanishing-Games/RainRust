...
namespace AmplifyShaderEditor
{
    ...
    public sealed class CameraProjectionNode : ShaderVariablesNode
    {
        ...
        [SerializeField]
        private BuiltInShaderCameraTypes m_selectedType =
            BuiltInShaderCameraTypes.unity_CameraProjection;
        ...
        protected override void CommonInit(int uniqueId)
        {
            ...
            ChangeOutputProperties(
                0,
                _projMatrixValuesStr[(int)m_selectedType],
        ...
        public override void Draw(DrawInfo drawInfo)
        {
            ...
            m_selectedType = (BuiltInShaderCameraTypes)
                m_upperLeftWidget.DrawWidget(this, (int)m_selectedType, _projMatrixValuesStr);
        ...
        public override void DrawProperties()
        {
            base.DrawProperties();
            EditorGUI.BeginChangeCheck();
            m_selectedType = (BuiltInShaderCameraTypes)EditorGUILayoutPopup(
                _projMatrixLabelStr,
                (int)m_selectedType,
        ...
        public override void ReadFromString(ref string[] nodeParams)
        {
            ...
            m_selectedType = (BuiltInShaderCameraTypes)
                Enum.Parse(typeof(BuiltInShaderCameraTypes), GetCurrentParam(ref nodeParams));
            ChangeOutputName(0, _projMatrixValuesStr[(int)m_selectedType]);
        }
