        ...
        )
        {
            ...
            if (dataCollector.PortCategory == MasterNodePortCategory.Vertex)
            {
                if (dataCollector.TesselationActive)
                {
                    UIUtils.ShowMessage(
                        UniqueId,
                        m_nodeAttribs.Name + " does not work properly on Vertex/Tessellation ports"
                    );
                    return GenerateErrorValue();
                }
                else
                {
                    UIUtils.ShowMessage(
                        UniqueId,
                        FaceVariableNode.FaceOnVertexWarning,
            ...
            else
            {
                variable =
                    ...
                    + "."
                    + Constants.IsFrontFacingVariable;
            }
