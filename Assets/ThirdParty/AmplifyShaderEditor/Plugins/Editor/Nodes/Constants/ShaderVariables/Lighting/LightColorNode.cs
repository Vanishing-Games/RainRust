...
namespace AmplifyShaderEditor
{
    ...
    [NodeAttributes(
        "Main Light Color",
        "Lighting",
        "Light color of main Directional light. RGB value already contains light intensity while A only contains light intensity."
    )]
        ...
        )
        {
            ...
            if (dataCollector.IsTemplate && dataCollector.IsSRP)
            {
                ...
                )
                {
                    ...
                    constantVar = string.Format(
                        TemplateHelperFunctions.HDLightInfoFormat,
                        "0",
                        "color"
                    );
                    ;
            ...
            switch (outputId)
            {
                default:
                case 0:
                    return m_localColorVar;
                case 1:
                    return m_localColorVar + ".rgb";
                case 2:
                    return m_localColorVar + ".a";
            }
        }
    }
}
