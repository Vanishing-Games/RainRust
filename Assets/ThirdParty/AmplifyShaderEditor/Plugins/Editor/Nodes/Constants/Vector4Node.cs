...
namespace AmplifyShaderEditor
{
    ...
    public sealed class Vector4Node : PropertyNode
    {
        ...
        public Vector4Node(int uniqueId, float x, float y, float width, float height)
        ...
        {
            m_defaultValue = EditorGUILayoutVector4Field(
        ...
        public override void DrawMaterialProperties()
        {
            ...
            m_materialValue = EditorGUILayoutVector4Field(
        ...
        )
        {
            ...
            if (result.Equals(string.Empty))
            {
                UIUtils.ShowMessage(
                    UniqueId,
                    "Vector4Node generating empty code",
        ...
        public override string GetPropertyValStr()
        {
            return (m_materialMode && m_currentParameterType != PropertyType.Constant)
                ? m_materialValue.x.ToString(
                    ...
                    + IOUtils.VECTOR_SEPARATOR
                    + m_materialValue.w.ToString(
                        Mathf.Abs(m_materialValue.w) > 1000
                            ? Constants.PropertyBigVectorFormatLabel
                            : Constants.PropertyVectorFormatLabel
                    )
                : m_defaultValue.x.ToString(
                    ...
                    + m_defaultValue.w.ToString(
                        Mathf.Abs(m_defaultValue.w) > 1000
                            ? Constants.PropertyBigVectorFormatLabel
                            : Constants.PropertyVectorFormatLabel
                    );
        }
