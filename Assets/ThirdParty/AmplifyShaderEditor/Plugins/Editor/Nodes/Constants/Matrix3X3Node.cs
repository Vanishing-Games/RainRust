...
namespace AmplifyShaderEditor
{
    ...
    {
        private string[,] m_fieldText = new string[3, 3]
        {
            { "0", "0", "0" },
            { "0", "0", "0" },
            { "0", "0", "0" },
        ...
        public Matrix3X3Node()
            : base() { }

        public Matrix3X3Node(int uniqueId, float x, float y, float width, float height)
        ...
        protected override void CommonInit(int uniqueId)
        {
            ...
            m_insideSize.Set(
                Constants.FLOAT_DRAW_WIDTH_FIELD_SIZE * 3 + Constants.FLOAT_WIDTH_SPACING * 2,
                Constants.FLOAT_DRAW_HEIGHT_FIELD_SIZE * 3
                    + Constants.FLOAT_WIDTH_SPACING * 2
        ...
        )
        {
            ...
            if (m_currentParameterType != PropertyType.Constant)
            {
                ...
                string localVarValue = string.Format(
