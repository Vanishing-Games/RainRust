    ...
    public sealed class GrabScreenPosition : ParentNode
    {
        ...
        void ConfigureHeader()
        {
            SetAdditonalTitleText(
                string.Format(Constants.SubTitleTypeFormatStr, m_outputTypeStr[m_outputTypeInt])
            );
        }
        ...
        )
        {
            ...
            if (m_outputTypeInt == 0)
                localVarName = GeneratorUtils.GenerateGrabScreenPositionNormalized(
                    ref dataCollector,
                    UniqueId,
                ...
                localVarName = GeneratorUtils.GenerateGrabScreenPosition(
                    ref dataCollector,
                    UniqueId,
                    CurrentPrecisionType,
                    !dataCollector.UsingCustomScreenPos
