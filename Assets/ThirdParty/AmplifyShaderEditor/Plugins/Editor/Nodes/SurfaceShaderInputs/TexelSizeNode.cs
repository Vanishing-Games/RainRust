...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TexelSizeNode : ParentNode
    {
        ...
        public override void DrawProperties()
        {
            ...
            m_variableMode = (VariableMode)EditorGUILayoutEnumPopup(
                "Variable Mode",
                m_variableMode
            );
        }
        ...
        )
        {
            ...
            {
                texelName =
                    m_inputPorts[0].GeneratePortInstructions(ref dataCollector) + "_TexelSize";
            }
            ...
            else
            {
                ...
                UIUtils.ShowMessage(
                    UniqueId,
                    "Please specify a texture sample on the Texel Size node",
