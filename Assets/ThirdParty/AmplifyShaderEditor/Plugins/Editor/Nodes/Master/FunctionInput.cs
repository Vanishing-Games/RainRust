...
namespace AmplifyShaderEditor
{
    ...
    public sealed class FunctionInput : ParentNode
    {
        ...
        public delegate string PortGeneration(
        ...
        public override void SetPreviewInputs()
        {
            ...
            else
            {
                ...
                if (input != null && (!InputPorts[0].IsConnected || input.IsConnected))
                {
                    ...
                    {
                        SpherePreview = Fnode
                            .ContainerGraph.GetNode(input.ExternalReferences[0].NodeId)
                            .SpherePreview;
                    }
                    else
                    {
            ...
            if (
                m_inputPorts[0].DataType == WirePortDataType.FLOAT
                || m_inputPorts[0].DataType == WirePortDataType.INT
            )
        ...
        public override bool RecursivePreviewUpdate(Dictionary<string, bool> duplicatesDict = null)
        {
            ...
            for (int i = 0; i < InputPorts.Count; i++)
            {
                ...
                if (Fnode != null)
                {
                    ...
                    {
                        outNode = ContainerGraph.GetNode(
                            InputPorts[i].ExternalReferences[0].NodeId
                        );
                    }
                }
                else
        ...
        public override void Draw(DrawInfo drawInfo)
        {
            ...
            if (ContainerGraph.LodLevel <= ParentGraph.NodeLOD.LOD3)
            {
                ...
                if (m_isEditing || m_startEditing)
                {
                    ...
                    m_inputName = EditorGUITextField(
                        m_titleClickArea,
                        string.Empty,
                        m_inputName,
        ...
        public override void DrawProperties()
        {
            ...
            EditorGUI.BeginChangeCheck();
            m_selectedInputTypeInt = EditorGUILayoutPopup(
                InputTypeStr,
        ...
        void UpdatePorts()
        {
            ...
            m_outputPorts[0]
                .ChangeTypeWithRestrictions(
                    m_selectedInputType,
                    PortCreateRestriction(m_selectedInputType)
                );
            m_sizeIsDirty = true;
        }
        ...
        )
        {
            ...
            if (OnPortGeneration != null)
                result = OnPortGeneration(
                    ref dataCollector,
                    m_orderIndex,
                    ContainerGraph.ParentWindow.CustomGraph
                );
            else
