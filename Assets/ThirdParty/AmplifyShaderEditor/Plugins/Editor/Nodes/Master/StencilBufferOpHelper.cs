...
namespace AmplifyShaderEditor
{
    ...
    public class StencilBufferOpHelper
    {
        ...
        public static readonly Dictionary<string, int> StencilComparisonValuesDict = new Dictionary<
            string,
            int
        >()
        {
        ...
        public static readonly Dictionary<string, int> StencilOpsValuesDict = new Dictionary<
            string,
            int
        >()
        {
        ...
        [SerializeField]
        private InlineProperty m_comparisonFunctionBackIdx = new InlineProperty(
            ComparisonDefaultValue
        );
        ...
        [SerializeField]
        private InlineProperty m_passStencilOpBackIdx = new InlineProperty(
            PassStencilOpDefaultValue
        );
        ...
        [SerializeField]
        private InlineProperty m_failStencilOpBackIdx = new InlineProperty(
            FailStencilOpDefaultValue
        );
        ...
        [SerializeField]
        private InlineProperty m_zFailStencilOpBackIdx = new InlineProperty(
            ZFailStencilOpDefaultValue
        );
        ...
        public string CreateStencilOp(UndoParentNode owner)
        {
            ...
            {
                if (
                    m_comparisonFunctionIdx.IntValue != ComparisonDefaultValue
                    || m_comparisonFunctionIdx.Active
                )
                ...
                if (
                    m_passStencilOpIdx.IntValue != PassStencilOpDefaultValue
                    || m_passStencilOpIdx.Active
                )
                    result += string.Format(
                        "\t\t\tPassFront {0}\n",
                        m_passStencilOpIdx.GetValueOrProperty(
                            StencilOpsValues[m_passStencilOpIdx.IntValue]
                        )
                    );
                if (
                    m_failStencilOpIdx.IntValue != FailStencilOpDefaultValue
                    || m_failStencilOpIdx.Active
                )
                    result += string.Format(
                        "\t\t\tFailFront {0}\n",
                        m_failStencilOpIdx.GetValueOrProperty(
                            StencilOpsValues[m_failStencilOpIdx.IntValue]
                        )
                    );
                if (
                    m_zFailStencilOpIdx.IntValue != ZFailStencilOpDefaultValue
                    || m_zFailStencilOpIdx.Active
                )
                    result += string.Format(
                        "\t\t\tZFailFront {0}\n",
                        m_zFailStencilOpIdx.GetValueOrProperty(
                            StencilOpsValues[m_zFailStencilOpIdx.IntValue]
                        )
                    );
        ...
        public void Draw(UndoParentNode owner)
        {
            ...
            owner.ContainerGraph.ParentWindow.InnerWindowVariables.ExpandedStencilOptions =
                foldoutValue;
        }
