...
namespace AmplifyShaderEditor
{
    ...
    public class AdditionalIncludesHelper
    {
        ...
        {
            get { return m_outsideIncludes; }
            set { m_outsideIncludes = value; }
        }
        ...
        public void Draw(ParentNode owner)
        {
            ...
            NodeUtils.DrawPropertyGroup(
                ref value,
                AdditionalIncludesStr,
                DrawMainBody,
                DrawButtons
            );
            owner.ContainerGraph.ParentWindow.InnerWindowVariables.ExpandedAdditionalIncludes =
                value;
        }
        ...
        void DrawMainBody()
        {
            ...
            for (int i = 0; i < itemCount; i++)
            {
                EditorGUILayout.BeginHorizontal();
                {
                    ...
                    {
                        m_additionalIncludes[i] = UIUtils.RemoveShaderInvalidCharacters(
                            m_additionalIncludes[i]
                        );
                    }
