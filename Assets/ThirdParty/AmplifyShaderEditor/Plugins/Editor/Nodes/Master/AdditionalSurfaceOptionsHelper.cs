    ...
    public class AdditionalSurfaceOptionsHelper
    {
        ...
        public void Draw(ParentNode owner)
        {
            ...
            owner
                ...
                .ParentWindow
                .InnerWindowVariables
                .ExpandedAdditionalSurfaceOptions = value;
        }
        ...
        void DrawMainBody()
        {
            ...
            for (int i = 0; i < itemCount; i++)
            {
                ...
                m_availableOptions[i] = EditorGUILayout.TextField(
                    "[" + i + "] -",
                    m_availableOptions[i]
                );
                if (EditorGUI.EndChangeCheck())
                {
                    m_availableOptions[i] = UIUtils.RemoveShaderInvalidCharacters(
                        m_availableOptions[i]
                    );
                }
