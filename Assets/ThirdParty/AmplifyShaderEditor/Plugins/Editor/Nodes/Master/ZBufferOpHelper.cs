...
namespace AmplifyShaderEditor
{
    ...
    class ZBufferOpHelper
    {
        ...
        public static readonly string[] ZWriteModeValues = { "<Default>", "On", "Off" };

        public static readonly Dictionary<ZTestMode, int> ZTestModeDict = new Dictionary<
            ZTestMode,
            int
        >
        {
        ...
        public static readonly Dictionary<ZWriteMode, int> ZWriteModeDict = new Dictionary<
            ZWriteMode,
            int
        >
        {
        ...
        public void Draw(UndoParentNode owner, GUIStyle toolbarstyle, bool customBlendAvailable)
        {
            ...
            if (m_parentSurface.ContainerGraph.ParentWindow.InnerWindowVariables.ExpandedDepth)
            {
                ...
                {
                    EditorGUI.indentLevel++;
                    m_extrazTestMode = owner.EditorGUILayoutPopup(
                        DepthZTestStr,
                        m_extrazTestMode,
                        ZTestModeLabels
                    );
        ...
        public bool IsActive
        {
            get
            {
                return m_zTestMode.IntValue != 0
                    || m_zWriteMode.IntValue != 0
                    || m_offsetEnabled
                    || m_zTestMode.Active
                    || m_zWriteMode.Active;
            }
