...
namespace AmplifyShaderEditor
{
    ...
    public class AdditionalPragmasHelper
    {
        ...
        public void Draw(ParentNode owner)
        {
            ...
            owner.ContainerGraph.ParentWindow.InnerWindowVariables.ExpandedAdditionalPragmas =
                value;
        }
        ...
        void DrawMainBody()
        {
            ...
            for (int i = 0; i < itemCount; i++)
            {
                EditorGUILayout.BeginHorizontal();
                {
                    ...
                    {
                        m_additionalPragmas[i] = UIUtils.RemoveShaderInvalidCharacters(
                            m_additionalPragmas[i]
                        );
                    }
