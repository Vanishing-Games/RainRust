...
namespace AmplifyShaderEditor
{
    ...
    {
        private const string FunctionHeader =
        ...
        protected override void CommonInit(int uniqueId)
        {
            ...
            AddInputPort(
                ...
                false,
                m_normalizeAxis ? NormalizeAxisLabel : NonNormalizeAxisLabel
            );
        ...
        )
        {
            ...
            RegisterLocalVariable(
                0,
                string.Format(FunctionCall, pivotPoint, position, normalizeRotAxis, rotationAngle),
                ref dataCollector,
                "rotatedValue" + OutputId
            );
            return m_outputPorts[0].LocalValue(dataCollector.PortCategory);
        }
