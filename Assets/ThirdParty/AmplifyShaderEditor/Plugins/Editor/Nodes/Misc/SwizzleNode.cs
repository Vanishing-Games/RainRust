...
namespace AmplifyShaderEditor
{
    ...
    public sealed class SwizzleNode : SingleInputOp
    {
        ...
        private readonly string[] SwizzleChannelLabels =
        {
            "Channel 0",
            "Channel 1",
            "Channel 2",
        ...
        private readonly string[] m_outputValueTypes =
        {
            "Float",
            "Vector 2",
            "Vector 3",
        ...
        public override void Draw(DrawInfo drawInfo)
        {
            ...
            if (m_dropdownEditing)
            {
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    ...
                    {
                        case 0:
                            m_selectedOutputType = WirePortDataType.FLOAT;
                            break;
                        case 1:
        ...
        public override void DrawProperties()
        {
            ...
            if (m_inputPorts[0].DataType == WirePortDataType.COLOR)
            {
                ...
                {
                    m_selectedOutputSwizzleTypes[i] = EditorGUILayoutPopup(
                        SwizzleChannelLabels[i],
                        m_selectedOutputSwizzleTypes[i],
                        SwizzleColorChannels
                    );
                }
            }
            else
