...
namespace AmplifyShaderEditor
{
    ...
    public sealed class MatrixFromVectors : ParentNode
    {
        ...
        [SerializeField]
        private Vector4[] m_defaultValuesV4 =
        {
            Vector4.zero,
            Vector4.zero,
            Vector4.zero,
        ...
        private readonly string[] _outputValueTypes = { "Matrix3X3", "Matrix4X4" };
        ...
        public override void Draw(DrawInfo drawInfo)
        {
            ...
            m_selectedOutputTypeInt = m_upperLeftWidget.DrawWidget(
                this,
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                {
                    case 0:
                        m_selectedOutputType = WirePortDataType.FLOAT3x3;
                        break;
                    case 1:
                        m_selectedOutputType = WirePortDataType.FLOAT4x4;
                        break;
                }
        ...
        public override void DrawProperties()
        {
            ...
            switch (m_selectedOutputType)
            {
                case WirePortDataType.FLOAT3x3:
                    ...
                    for (int i = 0; i < count; i++)
                    {
                        if (!m_inputPorts[i].IsConnected)
                            m_defaultValuesV3[i] = EditorGUILayoutVector3Field(
                                m_defaultValuesStr[i],
                                m_defaultValuesV3[i]
                            );
                    }
                    break;
                case WirePortDataType.FLOAT4x4:
                    ...
                    {
                        if (!m_inputPorts[i].IsConnected)
                            m_defaultValuesV4[i] = EditorGUILayoutVector4Field(
                                m_defaultValuesStr[i],
                                m_defaultValuesV4[i]
                            );
                    }
            ...
            switch (m_selectedOutputType)
            {
                ...
                case WirePortDataType.FLOAT4x4:
                    ...
                    else
                    {
                        ...
                        result = string.Format(
                            "float4x4( {0}.x,{1}.x,{2}.x,{3}.x,{0}.y,{1}.y,{2}.y,{3}.y,{0}.z,{1}.z,{2}.z,{3}.z,{0}.w,{1}.w,{2}.w,{3}.w )",
                            vec0,
                            vec1,
                            vec2,
                            vec3
