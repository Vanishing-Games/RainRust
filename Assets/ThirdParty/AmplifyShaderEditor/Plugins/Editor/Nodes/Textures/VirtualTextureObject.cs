...
namespace AmplifyShaderEditor
{
    ...
    public class VirtualTextureObject : TexturePropertyNode
    {
        ...
        private const string VirtualTextureObjectInfo =
            "Can only be used alongside a Texture Sample node by connecting to its Tex Input Port.\n"
        ...
        new void ShowDefaults()
        {
            ...
            m_virtualPreset = (VirtualPreset)EditorGUILayoutEnumPopup(
                VirtualPresetStr,
                m_virtualPreset
            );
        ...
        public override void ReadFromString(ref string[] nodeParams)
        {
            ...
            m_virtualPreset = (VirtualPreset)
                Enum.Parse(typeof(VirtualPreset), GetCurrentParam(ref nodeParams));
        ...
        public override bool IsNormalMap
        {
            get { return m_isNormalMap || m_virtualChannel == VirtualChannel.Normal; }
        }
        public VirtualChannel Channel
        {
            get { return m_virtualChannel; }
        }
    }
}
