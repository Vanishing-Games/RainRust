...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TFHCFlipBookUVAnimation : ParentNode
    {
        ...
        [SerializeField]
        private readonly string[] m_textureVerticalDirectionValues =
        {
            "Top To Bottom",
            "Bottom To Top",
        };
        ...
        [SerializeField]
        private readonly string[] m_negativeSpeedBehaviorValues =
        {
            "Switch to Positive",
            "Reverse Animation",
        };
        ...
        public override void DrawProperties()
        {
            ...
            m_selectedTextureVerticalDirection = EditorGUILayoutPopup(
                TextureVerticalDirectionStr,
                m_selectedTextureVerticalDirection,
                m_textureVerticalDirectionValues
            );
            m_negativeSpeedBehavior = EditorGUILayoutPopup(
                NegativeSpeedBehaviorStr,
                m_negativeSpeedBehavior,
                m_negativeSpeedBehaviorValues
            );
        ...
        )
        {
            ...
            string timer = m_inputPorts[5].IsConnected
            ...
            {
                vtotaltiles =
                    "float fbtotaltiles" + OutputId + " = " + columns + " * " + rows + ";";
            }
            ...
            string vcurrenttileindex =
                "float fbcurrenttileindex"
                + OutputId
                + " = floor( fmod( fbspeed"
                + OutputId
                + " + "
            ...
            string voffsetx1 =
                "float fblinearindextox"
                + OutputId
                + " = round ( fmod ( fbcurrenttileindex"
                + OutputId
                + ", "
                + columns
                + " ) );";
            ...
            string frame =
                "int flipbookFrame" + OutputId + " = ( ( int )fbcurrenttileindex" + OutputId + ");";
