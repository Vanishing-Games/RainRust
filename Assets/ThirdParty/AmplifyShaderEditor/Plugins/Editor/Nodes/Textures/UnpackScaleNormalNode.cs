    ...
    public class UnpackScaleNormalNode : ParentNode
    {
        ...
        )
        {
            ...
            string scaleValue = isScaledNormal
                ...
                : "1.0";
            normalMapUnpackMode = GeneratorUtils.GenerateUnpackNormalStr(
                ref dataCollector,
            ...
            if (outputUsage > 1 && !dataCollector.IsSRP)
            {
                ...
                dataCollector.AddLocalVariable(
                    UniqueId,
                    "float3 " + varName + " = " + normalMapUnpackMode + ";"
                );
        ...
        public override void ReadFromString(ref string[] nodeParams)
        {
            ...
            {
                m_inputMode = (UnpackInputMode)
                    Enum.Parse(typeof(UnpackInputMode), GetCurrentParam(ref nodeParams));
            }
        }
    }
}
