    ...
    public sealed class TextureTransformNode : ParentNode
    {
        ...
        )
        {
            if (!m_outputPorts[0].IsLocalValue(dataCollector.PortCategory))
            {
                ...
                {
                    texTransform =
                        m_inputPorts[0].GeneratePortInstructions(ref dataCollector) + "_ST";
                }
                else if (m_referenceNode != null)
                {
                ...
                else
                {
                    ...
                    UIUtils.ShowMessage(
                        UniqueId,
                        "Please specify a texture sample on the Texture Transform Size node",
                ...
                texTransform = m_texCoordsHelper.GenerateShaderForOutput(
                    0,
                    ref dataCollector,
                    false
                );
