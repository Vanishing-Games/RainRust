    ...
    public class SamplerStateNode : ParentNode
    {
        ...
        )
        {
            ...
            m_inputReferenceNode =
                m_inputPorts[0].GetOutputNodeWhichIsNotRelay() as TexturePropertyNode;
            UpdateTitle();
        }
        ...
        public override void DrawProperties()
        {
            ...
            m_anisoMode = (AnisoModes)EditorGUILayoutEnumPopup(
                AnisotropicFilteringStr,
                m_anisoMode
            );
#endif
        ...
        public override void OnNodeLogicUpdate(DrawInfo drawInfo)
        {
            ...
            if (
                ...
                && ContainerGraph.CurrentShaderFunction == null
            )
        ...
        public override void Draw(DrawInfo drawInfo)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                if (arr != null && arr.Count > 0)
                {
                    ...
                    GUI.enabled = true && (!m_inputPorts[0].IsConnected);
                    m_referenceSamplerId =
                        m_upperLeftWidget.DrawWidget(this, m_referenceSamplerId + 1, arr.ToArray())
                        - 1;
                }
                else
                {
        ...
        )
        {
            if (!m_outputPorts[0].IsLocalValue(dataCollector.PortCategory))
            {
                ...
                {
                    m_referenceNode.BaseGenerateShaderForOutput(
                        outputId,
                        ref dataCollector,
                        ignoreLocalvar
                    );
                ...
                string sampler = GeneratorUtils.GenerateSamplerState(
                    ref dataCollector,
                    UniqueId,
                    propertyOrOptions,
                    VariableMode.Create
        ...
        public override void ReadFromString(ref string[] nodeParams)
        {
            ...
            {
                m_anisoMode = (AnisoModes)
                    Enum.Parse(typeof(AnisoModes), GetCurrentParam(ref nodeParams));
            }
        }
