...
namespace AmplifyShaderEditor
{
    ...
    public sealed class LerpOp : ParentNode
    {
        ...
        void UpdateConnection(int portId)
        {
            ...
            if (
                m_inputPorts[2].IsConnected
                && (typealpha == WirePortDataType.FLOAT || typealpha == WirePortDataType.INT)
            )
