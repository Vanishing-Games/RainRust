...
namespace AmplifyShaderEditor
{
    ...
    {
        private const string FWidthErrorMsg =
            "Attempting to connect an FWidth to a {0} type port. It is only valid on Fragment type ports";
        ...
        )
        {
            ...
            )
            {
                UIUtils.ShowMessage(
                    UniqueId,
                    string.Format(FWidthErrorMsg, dataCollector.PortCategory),
