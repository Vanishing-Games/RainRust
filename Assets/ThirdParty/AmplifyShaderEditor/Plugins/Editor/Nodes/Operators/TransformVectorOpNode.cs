...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TransformVectorOpNode : ParentNode
    {
        ...
        )
        {
            ...
            switch (m_source)
            {
                ...
                case CoordinateSpaces.View:
                {
                    UIUtils.ShowMessage(
                        UniqueId,
                        "View as Source is not supported",
        ...
        public override void ReadFromString(ref string[] nodeParams)
        {
            ...
            m_source = (CoordinateSpaces)
                Enum.Parse(typeof(CoordinateSpaces), GetCurrentParam(ref nodeParams));
            m_destination = (CoordinateSpaces)
                Enum.Parse(typeof(CoordinateSpaces), GetCurrentParam(ref nodeParams));
        }
