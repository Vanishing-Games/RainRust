...
namespace AmplifyShaderEditor
{
    public class NodeUtils
    {
        ...
        public static void DrawNestedPropertyGroup(
            ref bool foldoutValue,
            string sectionName,
            DrawPropertySection DrawSection,
        ...
        public static void DrawNestedPropertyGroup(
            ...
            string sectionName,
            DrawPropertySection DrawSection,
            DrawPropertySection HeaderSection
        )
        {
            GUILayout.BeginHorizontal();
            {
        ...
        public static bool DrawPropertyGroup(
            UndoParentNode owner,
            ref bool foldoutValue,
            ref bool enabledValue,
            string sectionName,
