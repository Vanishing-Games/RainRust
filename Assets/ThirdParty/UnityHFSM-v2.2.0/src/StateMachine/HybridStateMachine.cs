...
namespace UnityHFSM
{
    ...
    /// </summary>
    public class HybridStateMachine<TOwnId, TStateId, TEvent>
        : StateMachine<TOwnId, TStateId, TEvent>
    {
        ...
        /// <returns>Itself</returns>
        public HybridStateMachine<TOwnId, TStateId, TEvent> AddAction<TData>(
            TEvent trigger,
            Action<TData> action
        )
        {
    ...
    /// <inheritdoc />
    public class HybridStateMachine<TStateId, TEvent>
        : HybridStateMachine<TStateId, TStateId, TEvent>
    {
        /// <inheritdoc />
        public HybridStateMachine(
