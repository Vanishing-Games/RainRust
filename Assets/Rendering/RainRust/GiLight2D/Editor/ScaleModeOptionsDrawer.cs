...
namespace GiLight2D.Editor
{
    ...
    public class ScaleModeOptionsDrawer : PropertyDrawer
    {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            var scaleMode = (GiLight2D.ScaleMode)
                property
                    .FindPropertyRelative(nameof(GiLight2D.ScaleModeOptions._scaleMode))
                    .intValue;
        ...
        {
            var scaleMode = property.FindPropertyRelative(
                nameof(GiLight2D.ScaleModeOptions._scaleMode)
            );
            ...
            scaleMode.intValue = (int)
                (GiLight2D.ScaleMode)
                    EditorGUI.EnumPopup(
                        ...
                        label,
                        (GiLight2D.ScaleMode)scaleMode.intValue
                    );
