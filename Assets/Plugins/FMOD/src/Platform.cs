...
namespace FMODUnity
{
    ...
    public abstract class Platform : ScriptableObject
    {
        ...
        protected virtual IEnumerable<string> GetBinaryPaths(
        ...
        internal IEnumerable<BinaryFileInfo> GetBinaryFileInfo(
            BuildTarget buildTarget,
            BinaryType binaryType
        )
        {
        ...
        internal class SourceFileInfo : FileInfo
        {
            ...
            protected override string GetBasePath(FileLayout layout)
            {
                BinaryAssetFolderInfo info = platform.GetBinaryAssetFolder(
                    platform.GetBuildTargets().First()
                );
        ...
        internal BinaryFileInfo CreateFileInfo(
            FileRecord record,
            BuildTarget buildTarget,
            BinaryType binaryType
        )
        ...
        internal virtual IEnumerable<string> GetBinaryFilePaths(
            BuildTarget buildTarget,
            BinaryType binaryType
        )
        {
        ...
        internal virtual IEnumerable<string> GetBinaryAssetPaths(
            BuildTarget buildTarget,
            BinaryType binaryType
        )
        {
        ...
        protected abstract IEnumerable<FileRecord> GetBinaryFiles(
            BuildTarget buildTarget,
            bool allVariants,
            string suffix
        );

        protected virtual IEnumerable<FileRecord> GetOptionalBinaryFiles(
            BuildTarget buildTarget,
            bool allVariants
        )
        {
        ...
        internal virtual string GetPluginPath(string pluginName)
        {
            throw new NotImplementedException(
                string.Format("Plugins are not implemented on platform {0}", Identifier)
            );
        }

        // Loads static and dynamic FMOD plugins for this platform.
        internal virtual void LoadPlugins(
        ...
        internal virtual void LoadDynamicPlugins(
            FMOD.System coreSystem,
            Action<FMOD.RESULT, string> reportResult
        )
        {
            ...
            foreach (string pluginName in pluginNames)
            {
                ...
                reportResult(
                    result,
                    string.Format("Loading plugin '{0}' from '{1}'", pluginName, pluginPath)
                );
            }
        }

        // Loads static FMOD plugins for this platform.
        internal virtual void LoadStaticPlugins(
            FMOD.System coreSystem,
            Action<FMOD.RESULT, string> reportResult
        )
        {
        ...
        internal static class PropertyAccessors
        {
            public static readonly PropertyAccessor<TriStateBool> LiveUpdate =
                new PropertyAccessor<TriStateBool>(
                    properties => properties.LiveUpdate,
                    TriStateBool.Disabled
                );

            public static readonly PropertyAccessor<int> LiveUpdatePort = new PropertyAccessor<int>(
                properties => properties.LiveUpdatePort,
                9264
            );

            public static readonly PropertyAccessor<TriStateBool> Overlay =
                new PropertyAccessor<TriStateBool>(
                    properties => properties.Overlay,
                    TriStateBool.Disabled
                );

            public static readonly PropertyAccessor<ScreenPosition> OverlayPosition =
                new PropertyAccessor<ScreenPosition>(
                    properties => properties.OverlayPosition,
            ...
            public static readonly PropertyAccessor<int> SampleRate = new PropertyAccessor<int>(
                properties => properties.SampleRate,
                0
            );
            ...
            public static readonly PropertyAccessor<FMOD.SPEAKERMODE> SpeakerMode =
                new PropertyAccessor<FMOD.SPEAKERMODE>(
                    properties => properties.SpeakerMode,
            ...
            public static readonly PropertyAccessor<int> DSPBufferCount = new PropertyAccessor<int>(
                properties => properties.DSPBufferCount,
                0
            );

            public static readonly PropertyAccessor<List<string>> Plugins = new PropertyAccessor<
                List<string>
            >(properties => properties.Plugins, null);
            ...
            public static readonly PropertyAccessor<PlatformCallbackHandler> CallbackHandler =
                new PropertyAccessor<PlatformCallbackHandler>(
                    properties => properties.CallbackHandler,
                    null
                );
        }
        ...
        internal Platform Parent
        {
            get
            {
                return (ParentIdentifier != null)
                    ? Settings.Instance.FindPlatform(ParentIdentifier)
                    : null;
            }
        }
