...
#pragma warning restore 0649
        ...
        )
        {
            ...
            int maxLogLength = isExpanded
                ? listView.manager.maxExpandedLogLength
                : listView.manager.maxCollapsedLogLength;
            ...
            else
            {
                ...
                if (isExpanded)
                {
                    ...
                    sb.Append(": ")
                        .Append(text, 0, Mathf.Min(text.Length, maxLogLength - sb.Length));
                }
                else
                {
