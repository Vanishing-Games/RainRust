...
namespace Sirenix.OdinInspector.Modules.Addressables.Editor
{
    ...
    /// </summary>
    public class DisallowAddressableSubAssetFieldAttributeValidator
        : AttributeValidator<DisallowAddressableSubAssetFieldAttribute, AssetReference>
    {
        protected override void Validate(ValidationResult result)
        {
            ...
            {
                result
                    .AddError("Sub-asset references is not allowed on this field.")
