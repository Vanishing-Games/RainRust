    ...
    public static class OdinLocalizationGUI
    {
        public static GUIStyle RichLabelTextCenteredMultiLine
        {
            get
            {
                ...
                {
                    _richLabelTextCenteredMultiLine = new GUIStyle(
        ...
        public static FancyColor Background =>
        ...
        public static FancyColor PanelGap =>
            EditorGUIUtility.isProSkin ? DarkPanelGap : LightPanelGap;

        public static FancyColor Selected =>
            EditorGUIUtility.isProSkin ? DarkSelected : LightSelected;
        ...
        public static FancyColor RowBorder =>
            EditorGUIUtility.isProSkin ? DarkRowBorder : LightRowBorder;
        ...
        public static FancyColor TabHover =>
            EditorGUIUtility.isProSkin ? DarkTabHover : LightTabHover;
        public static FancyColor TabSelected =>
            EditorGUIUtility.isProSkin ? DarkTabSelected : LightTabSelected;
        ...
        static OdinLocalizationGUI()
        {
            ...
            DarkRowEvenBackground2 = darkRowEvenBackground.Blend(
                rowBaseBlend,
                FancyColor.BlendMode.Overlay
            );
            DarkRowOddBackground2 = darkRowOddBackground.Blend(
                rowBaseBlend,
                FancyColor.BlendMode.Overlay
            );
            ...
            LightRowEvenBackground2 = lightRowEvenBackground.Blend(
                rowBaseBlend,
                FancyColor.BlendMode.Overlay
            );
            LightRowOddBackground2 = lightRowOddBackground.Blend(
                rowBaseBlend,
                FancyColor.BlendMode.Overlay
            );
        ...
        public static TEnum Tabs<TEnum>(Rect rect, TEnum value, float width)
            where TEnum : Enum
        {
            EnumTypeUtilities<TEnum>.EnumMember[] infos =
                EnumTypeUtilities<TEnum>.VisibleEnumMemberInfos;
            ...
            for (var i = 0; i < infos.Length; i++)
            {
                ...
                Vector2 textSize = EditorStyles.label.CalcSize(
                    GUIHelper.TempContent(infos[i].NiceName)
                );
        ...
        )
        {
            ...
            ref SirenixAnimationUtility.InterpolatedFloat t =
                ref SirenixAnimationUtility.GetTemporaryFloat(position, isMouseOver ? 1.0f : 0.0f);
            ...
            if (invert)
            {
                SirenixEditorGUI.DrawRoundRect(
                    position,
                    new Color(0, 0, 0, 0.2f * inverseValue),
                    5.0f,
                    new Color(0, 0, 0, 0.05f * inverseValue),
                    1
                );
                SirenixEditorGUI.DrawRoundRect(
                    position,
                    new Color(0, 0, 0, 0.4f * value),
                    5.0f,
                    new Color(1.0f, 1.0f, 1.0f, 0.05f * value),
                    1
                );
            }
            else
            {
                SirenixEditorGUI.DrawRoundRect(
                    position,
                    new Color(1, 1, 1, 0.2f * inverseValue),
                    5.0f,
                    new Color(0, 0, 0, 0.05f * inverseValue),
                    1
                );
        ...
        public static bool Metadata(Type metadataType, bool isFirst)
        {
            ...
            SdfIcons.DrawIcon(
                rect.TakeFromLeft(iconWidth).Padding(iconPadding.x, iconPadding.y),
        ...
        public static void DrawRoundBlur20(Rect position, Color color)
        {
            ...
            SirenixEditorGUI.DrawTextureSliced(
                position,
                OdinLocalizationGUITextures.RoundBlur20,
                color,
                63
            );
        }
        ...
        public static void DrawRoundBlur6(Rect position, Color color)
        {
            ...
            SirenixEditorGUI.DrawTextureSliced(
                position,
                OdinLocalizationGUITextures.RoundBlur6,
                color,
                10
            );
        }
