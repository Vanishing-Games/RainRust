...
namespace Sirenix.OdinInspector.Modules.Localization.Editor.Internal
{
    public static class OdinLocalizationReflectionValues
    {
        ...
        private const BindingFlags INSTANCE_NON_PUBLIC =
        ...
        {
            TableEntry_Data_Property = typeof(TableEntry).GetProperty(
                TABLE_ENTRY__DATA__PATH,
                INSTANCE_ALL
            );
            AssetTableEntry_Data_Property = typeof(AssetTableEntry).BaseType.GetProperty(
                TABLE_ENTRY__DATA__PATH,
                INSTANCE_ALL
            );
            StringTableEntry_Data_Property = typeof(StringTableEntry).BaseType.GetProperty(
                TABLE_ENTRY__DATA__PATH,
                INSTANCE_ALL
            );

            Type tableEntryDataType = TwoWaySerializationBinder.Default.BindToType(
                "UnityEngine.Localization.Tables.TableEntryData, Unity.Localization"
            );

            TableEntryData_m_Metadata_Field = tableEntryDataType?.GetField(
                TABLE_ENTRY_DATA__METADATA__PATH,
                INSTANCE_ALL
            );
            MetadataCollection_m_Items_Field = typeof(MetadataCollection).GetField(
                METADATA_COLLECTION__ITEMS__PATH,
                INSTANCE_ALL
            );

            LocalizationEditorSettings_Instance = typeof(LocalizationEditorSettings).GetProperty(
                "Instance",
                STATIC_NON_PUBLIC
            );
            LocalizationEditorSettings_GetAddressableAssetSettings =
                typeof(LocalizationEditorSettings).GetMethod(
            ...
            RaiseTableEntryModified_Method = LocalizationEditorSettings
                .EditorEvents.GetType()
                .GetMethod("RaiseTableEntryModified", INSTANCE_ALL);
            RaiseTableEntryAdded_Method = LocalizationEditorSettings
                .EditorEvents.GetType()
                .GetMethod("RaiseTableEntryAdded", INSTANCE_ALL);
            RaiseTableEntryRemoved_Method = LocalizationEditorSettings
                .EditorEvents.GetType()
                .GetMethod("RaiseTableEntryRemoved", INSTANCE_ALL);
            RaiseAssetTableEntryAdded_Method = LocalizationEditorSettings
                .EditorEvents.GetType()
                .GetMethod("RaiseAssetTableEntryAdded", INSTANCE_ALL);
            RaiseAssetTableEntryRemoved_Method = LocalizationEditorSettings
                .EditorEvents.GetType()
                .GetMethod("RaiseAssetTableEntryRemoved", INSTANCE_ALL);
            AssetTableCollection_SetEntryAssetType_PrivateMethod =
                typeof(AssetTableCollection).GetMethod("SetEntryAssetType", INSTANCE_NON_PUBLIC);
            AssetTableCollection_RemoveEntryAssetType_PrivateMethod =
                typeof(AssetTableCollection).GetMethod("RemoveEntryAssetType", INSTANCE_NON_PUBLIC);

            if (
                LocalizationEditorSettings_Instance != null
                && LocalizationEditorSettings_GetAddressableAssetSettings != null
            )
            {
                LocalizationEditorSettings_GetAddressableAssetSettingsFunc =
                    (Func<bool, AddressableAssetSettings>)
                        Delegate.CreateDelegate(
                            typeof(Func<bool, AddressableAssetSettings>),
                            LocalizationEditorSettings_Instance.GetValue(null),
                            LocalizationEditorSettings_GetAddressableAssetSettings
                        );
            }

            AddressHelper = TwoWaySerializationBinder.Default.BindToType(
                "UnityEngine.Localization.AddressHelper"
            );

            FormatAssetLabelMethod = AddressHelper?.GetMethod(
                "FormatAssetLabel",
            ...
            UpdateAssetGroupMethod = typeof(AssetTableCollection).GetMethod(
                "UpdateAssetGroup",
                BindingFlags.Instance | BindingFlags.NonPublic,
                null,
                new[]
        ...
        public static Action<SharedTableData.SharedTableEntry> Create_RaiseTableEntryModified_Method_Delegate(
            LocalizationEditorEvents events
        )
        {
            return (Action<SharedTableData.SharedTableEntry>)
                Delegate.CreateDelegate(
                    typeof(Action<SharedTableData.SharedTableEntry>),
                    events,
        ...
        > Create_RaiseTableEntryAdded_Method_Delegate(LocalizationEditorEvents events)
        {
            return (Action<LocalizationTableCollection, SharedTableData.SharedTableEntry>)
                Delegate.CreateDelegate(
                    typeof(Action<LocalizationTableCollection, SharedTableData.SharedTableEntry>),
                    events,
        ...
        public static Action<
            LocalizationTableCollection,
            SharedTableData.SharedTableEntry
        > Create_RaiseTableEntryRemoved_Method_Delegate(LocalizationEditorEvents events)
        {
            return (Action<LocalizationTableCollection, SharedTableData.SharedTableEntry>)
                Delegate.CreateDelegate(
                    typeof(Action<LocalizationTableCollection, SharedTableData.SharedTableEntry>),
        ...
        public static Action<
            ...
            AssetTable,
            AssetTableEntry
        > Create_AssetTableEntryAdded_Method_Delegate(LocalizationEditorEvents events)
        {
            return (Action<AssetTableCollection, AssetTable, AssetTableEntry>)
                Delegate.CreateDelegate(
                    typeof(Action<AssetTableCollection, AssetTable, AssetTableEntry>),
                    events,
        ...
        public static Action<
            ...
            AssetTableEntry,
            string
        > Create_AssetTableEntryRemoved_Method_Delegate(LocalizationEditorEvents events)
        {
            return (Action<AssetTableCollection, AssetTable, AssetTableEntry, string>)
                Delegate.CreateDelegate(
                    typeof(Action<AssetTableCollection, AssetTable, AssetTableEntry, string>),
                    events,
        ...
        public static Action<
            ...
            Type,
            string
        > Create_AssetTableCollection_SetEntryAssetType_PrivateMethod_Delegate(
            AssetTableCollection collection
        )
        {
            return (Action<TableEntryReference, Type, string>)
                Delegate.CreateDelegate(
                    typeof(Action<TableEntryReference, Type, string>),
                    collection,
                    AssetTableCollection_SetEntryAssetType_PrivateMethod
                );
        }
        ...
        {
            return (Action<TableEntryReference, string>)
                Delegate.CreateDelegate(
                    typeof(Action<TableEntryReference, string>),
                    collection,
                    AssetTableCollection_RemoveEntryAssetType_PrivateMethod
                );
        }
