    ...
    public static class OdinLocalizationEditorSettings
    {
        public static LocalizationEditorSettings Instance =>
            (LocalizationEditorSettings)
                OdinLocalizationReflectionValues.LocalizationEditorSettings_Instance.GetValue(null);

        public static AddressableAssetSettings GetAddressableAssetSettings(bool create)
        {
            return OdinLocalizationReflectionValues.LocalizationEditorSettings_GetAddressableAssetSettingsFunc(
                create
            );
        }

        public static bool IsTableNameValid(
            Type collectionType,
            string name,
        ...
        {
            errorMessage = (string)
                OdinLocalizationReflectionValues.LocalizationEditorSettings_IsTableNameValid.Invoke(
                    Instance,
        ...
        public static bool CreateDefaultLocalizationSettingsAsset()
        {
            ...
            string localizationSettingsPath = EditorUtility.SaveFilePanelInProject(
