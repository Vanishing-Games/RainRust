...
namespace Cysharp.Threading.Tasks
{
    ...
    public partial struct UniTask
    {
        ...
        {
            return new UniTask(
                YieldPromise.Create(timing, cancellationToken, cancelImmediately, out var token),
                token
            );
        }
        ...
        {
            return new UniTask(
                NextFramePromise.Create(timing, CancellationToken.None, false, out var token),
                token
            );
        }
        ...
        sealed class WaitForEndOfFramePromise
            : IUniTaskSource,
                ...
                System.Collections.IEnumerator
        {
            ...
            static readonly WaitForEndOfFrame waitForEndOfFrameYieldInstruction =
        ...
        sealed class DelayFramePromise
            : IUniTaskSource,
                IPlayerLoopItem,
        ...
        sealed class DelayRealtimePromise
            : IUniTaskSource,
                IPlayerLoopItem,
