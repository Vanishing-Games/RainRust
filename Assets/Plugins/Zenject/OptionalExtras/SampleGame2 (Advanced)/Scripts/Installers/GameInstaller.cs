...
namespace Zenject.SpaceFighter
{
    ...
    public class GameInstaller : MonoInstaller
    {
        ...
        public override void InstallBindings()
        {
            ...
            Container
                .BindFactory<float, float, EnemyFacade, EnemyFacade.Factory>()
                ...
                .FromPoolableMemoryPool<float, float, EnemyFacade, EnemyFacadePool>(poolBinder =>
                    poolBinder
            ...
            Container
                .BindFactory<float, float, BulletTypes, Bullet, Bullet.Factory>()
                // We could just use FromMonoPoolableMemoryPool here instead, but
                // for IL2CPP to work we need our pool class to be used explicitly here
                .FromPoolableMemoryPool<float, float, BulletTypes, Bullet, BulletPool>(poolBinder =>
                    poolBinder
            ...
            Container
                ...
                // We could just use FromMonoPoolableMemoryPool here instead, but
                // for IL2CPP to work we need our pool class to be used explicitly here
                .FromPoolableMemoryPool<Explosion, ExplosionPool>(poolBinder =>
                    poolBinder
        ...
        class BulletPool
            : MonoPoolableMemoryPool<float, float, BulletTypes, IMemoryPool, Bullet> { }
