...
namespace LDtkUnity.Editor
{
    ...
    internal sealed class LDtkReferenceToAnEntityInstanceDrawer : PropertyDrawer
    {
        ...
        private static readonly GUIContent GUIEntity = new GUIContent(
            "Entity",
            LDtkIconUtility.LoadEntityIcon()
        );
        private static readonly GUIContent GUILayer = new GUIContent(
            "Layer",
            LDtkIconUtility.LoadLayerIcon()
        );
        private static readonly GUIContent GUILevel = new GUIContent(
            "Level",
            LDtkIconUtility.LoadLevelIcon()
        );
        private static readonly GUIContent GUIWorld = new GUIContent(
            "World",
            LDtkIconUtility.LoadWorldIcon()
        );
        ...
        {
            _propEntity = property.FindPropertyRelative(
                LDtkReferenceToAnEntityInstance.PROPERTY_ENTITY
            );
            _propLayer = property.FindPropertyRelative(
                LDtkReferenceToAnEntityInstance.PROPERTY_LAYER
            );
            _propLevel = property.FindPropertyRelative(
                LDtkReferenceToAnEntityInstance.PROPERTY_LEVEL
            );
            _propWorld = property.FindPropertyRelative(
                LDtkReferenceToAnEntityInstance.PROPERTY_WORLD
            );
        }
