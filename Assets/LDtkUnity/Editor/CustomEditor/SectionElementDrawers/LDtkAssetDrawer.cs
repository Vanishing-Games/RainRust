...
namespace LDtkUnity.Editor
{
    ...
    /// </summary>
    internal abstract class LDtkAssetDrawer<TData, TAsset> : LDtkContentDrawer<TData>
        ...
        where TAsset : Object
    {
        ...
        protected LDtkAssetDrawer(TData data, SerializedProperty prop)
            : base(data)
        {
            if (prop == null)
            {
            ...
            {
                LDtkDebug.LogError(
                    "A serialized value's key string value is null/empty. This should never be expected."
                );
            }
        }
        ...
        protected void DrawField(Texture tex = null)
        {
            ...
            GUIContent guiContent = new GUIContent() { text = _data.Identifier, image = tex };
        ...
        protected void DrawField(Color iconColor)
        {
            ...
            GUIContent guiContent = new GUIContent() { text = identifier, image = icon };
