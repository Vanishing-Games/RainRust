...
namespace LDtkUnity.Editor
{
    internal abstract class LDtkJsonFileEditor<T> : LDtkEditor
    {
        ...
        protected void DrawCountOfItems(
            int? count,
            string single,
            string plural,
            Texture2D icon = null
        ...
        {
            GUIContent content = new GUIContent() { text = text, image = icon };
        ...
        private void DrawBox()
        {
            EditorGUILayout.HelpBox(
                $"This object contains the raw json data. Reference this object and get the FromJson property to get the json data if needed",
                MessageType.None
            );
        }
    }
