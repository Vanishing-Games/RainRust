...
namespace LDtkUnity.Editor
{
    internal sealed class LDtkSectionEnums : LDtkSectionDataDrawer<EnumDefinition>
    {
        ...
        private readonly GUIContent _pathLabel = new GUIContent
        {
            text = "Script Path",
            tooltip =
                "Use the folder button to set a relative path for the script to be generated.\n"
        ...
        public LDtkSectionEnums(LDtkImporterEditor editor, SerializedObject serializedObject)
        ...
        protected override void GetDrawers(
            EnumDefinition[] defs,
            List<LDtkContentDrawer<EnumDefinition>> drawers
        )
        {
            //NO drawers
        }
        ...
        {
            LDtkEditorGUI.PropertyFieldWithDefaultText(
                _enumNamespaceProp,
                _namespaceLabel,
                "<Global namespace>"
            );
