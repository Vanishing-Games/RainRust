...
namespace LDtkUnity.Editor
{
    internal static class LDtkEditorGUI
    {
        ...
        public static void DrawInfo(Vector2 pos, string tooltipText, TextAnchor anchor) =>
            DrawIconInternal(pos, ICON_NAME_INFO, tooltipText, anchor);

        public static void DrawWarning(Vector2 pos, string tooltipText, TextAnchor anchor) =>
            DrawIconInternal(pos, ICON_NAME_WARNING, tooltipText, anchor);

        public static void DrawError(Vector2 pos, string tooltipText, TextAnchor anchor) =>
            DrawIconInternal(pos, ICON_NAME_ERROR, tooltipText, anchor);

        public static void DrawInfoBig(Vector2 pos, string tooltipText, TextAnchor anchor) =>
            DrawIconInternal(pos, ICON_NAME_INFO_BIG, tooltipText, anchor);

        public static void DrawWarningBig(Vector2 pos, string tooltipText, TextAnchor anchor) =>
            DrawIconInternal(pos, ICON_NAME_WARNING_BIG, tooltipText, anchor);

        public static void DrawErrorBig(Vector2 pos, string tooltipText, TextAnchor anchor) =>
            DrawIconInternal(pos, ICON_NAME_ERROR_BIG, tooltipText, anchor);

        private static void DrawIconInternal(
            Vector2 pos,
            string iconName,
            string tooltipText,
            TextAnchor anchor
        ...
        public static void DrawFieldInfo(Rect controlRect, string tooltip) =>
            DrawInfo(GetFieldIconPosition(controlRect), tooltip, TextAnchor.MiddleRight);

        public static void DrawFieldWarning(Rect controlRect, string tooltip) =>
            DrawWarning(GetFieldIconPosition(controlRect), tooltip, TextAnchor.MiddleRight);

        public static void DrawFieldError(Rect controlRect, string tooltip) =>
            DrawError(GetFieldIconPosition(controlRect), tooltip, TextAnchor.MiddleRight);
        ...
        public static Vector2 GetFieldIconPosition(Rect controlRect)
        {
            ...
            return new Vector2(
                controlRect.xMin + labelWidth,
                controlRect.yMin + controlRect.height / 2
            );
        }

        public static Rect PropertyFieldWithDefaultText(
        ...
        public static void DrawHelpIcon(string referenceLink, string guiText)
        {
            ...
            GUIStyle style = new GUIStyle { onHover = hoverState, hover = hoverState };
