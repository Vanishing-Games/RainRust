...
namespace LDtkUnity.Editor
{
    internal sealed class LDtkPrefs : ScriptableObject
    {
        ...
        [SerializeField]
        private float _drawDistance = DISTANCE_DEFAULT;

        //level
        [SerializeField]
        private bool _showLevelIdentifier = true;

        [SerializeField]
        private bool _showLevelBorder = true;

        [Range(THICKNESS_MIN, THICKNESS_MAX)]
        [SerializeField]
        private float _levelBorderThickness = THICKNESS_DEFAULT;

        //entity
        [SerializeField]
        private bool _showEntityIdentifier = true;

        [SerializeField]
        private bool _showEntityIcon = true;

        [SerializeField]
        private bool _showEntityShape = true;

        [Range(THICKNESS_MIN, THICKNESS_MAX)]
        [SerializeField]
        private float _entityShapeThickness = THICKNESS_DEFAULT;

        [SerializeField]
        private bool _entityOnlyBorders = false;

        [SerializeField]
        private bool _entityOnlyHollow = false;

        //floats/ints
        [SerializeField]
        private bool _showFieldRadius = true;

        [Range(THICKNESS_MIN, THICKNESS_MAX)]
        [SerializeField]
        private float _fieldRadiusThickness = THICKNESS_DEFAULT;

        //points
        [SerializeField]
        private bool _showFieldPoints = true;

        [Range(THICKNESS_MIN, THICKNESS_MAX)]
        [SerializeField]
        private float _fieldPointsThickness = THICKNESS_DEFAULT;

        //entityRef
        [SerializeField]
        private bool _showFieldEntityRef = true;

        [Range(THICKNESS_MIN, THICKNESS_MAX)]
        [SerializeField]
        private float _fieldEntityRefThickness = THICKNESS_DEFAULT;
