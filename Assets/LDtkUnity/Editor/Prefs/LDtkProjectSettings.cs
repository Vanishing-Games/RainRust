...
namespace LDtkUnity.Editor
{
    internal sealed class LDtkProjectSettings : ScriptableObject
    {
        ...
        [SerializeField]
        private Texture2D _internalIconsTexture = null;
        ...
        public static string InternalIconsTexturePath =>
            Instance._internalIconsTexture
                ? AssetDatabase.GetAssetPath(Instance._internalIconsTexture)
                : null;
    }
}
