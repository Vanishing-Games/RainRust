...
namespace LDtkUnity.Editor
{
    internal sealed class LDtkPrefsGUI
    {
        ...
        public LDtkPrefsGUI(SerializedObject obj, Action resetAction, Action saveAction)
        {
            ...
            _propEntityShapeOnlyHollow = obj.FindProperty(
                LDtkPrefs.PROPERTY_ENTITY_SHAPE_ONLY_HOLLOW
            );
            _propEntityShapeOnlyBorders = obj.FindProperty(
                LDtkPrefs.PROPERTY_ENTITY_SHAPE_ONLY_BORDERS
            );
