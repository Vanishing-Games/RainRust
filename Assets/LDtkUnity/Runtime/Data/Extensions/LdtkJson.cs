...
namespace LDtkUnity
{
    public partial class LdtkJson : ILDtkIid
    {
        ...
        /// </value>
        [IgnoreDataMember]
        public Vector2Int UnityDefaultLevelSize =>
            DefaultLevelWidth == null || DefaultLevelHeight == null
                ? Vector2Int.zero
                : new Vector2Int((int)DefaultLevelWidth, (int)DefaultLevelHeight);

        /// <value>
        /// Default size for new entities
        /// </value>
        [IgnoreDataMember]
        public Vector2Int UnityDefaultEntitySize =>
            new Vector2Int(DefaultEntityWidth, DefaultEntityHeight);
        ...
        /// </value>
        [IgnoreDataMember]
        public Vector2Int UnityWorldGridSize =>
            WorldGridWidth == null || WorldGridHeight == null
                ? Vector2Int.zero
                : new Vector2Int(WorldGridWidth.Value, WorldGridHeight.Value);
