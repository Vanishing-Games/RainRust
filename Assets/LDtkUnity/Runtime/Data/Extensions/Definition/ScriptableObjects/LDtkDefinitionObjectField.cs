...
namespace LDtkUnity
{
    ...
    public sealed class LDtkDefinitionObjectField : LDtkDefinitionObject<FieldDefinition>, ILDtkUid
    {
        ...
        [field: SerializeField]
        public string[] AcceptFileTypes { get; private set; }

        [field: Tooltip("Possible values: `Any`, `OnlySame`, `OnlyTags`, `OnlySpecificEntity`")]
        [field: SerializeField]
        public AllowedRefs AllowedRefs { get; private set; }

        [field: SerializeField]
        public LDtkDefinitionObjectEntity AllowedRefsEntity { get; private set; }

        [field: SerializeField]
        public string[] AllowedRefTags { get; private set; }

        [field: SerializeField]
        public bool AllowOutOfLevelRef { get; private set; }

        [field: Tooltip("Array max length")]
        [field: SerializeField]
        public int ArrayMaxLength { get; private set; }

        [field: Tooltip("Array min length")]
        [field: SerializeField]
        public int ArrayMinLength { get; private set; }

        [field: SerializeField]
        public bool AutoChainRef { get; private set; }
        ...
        [field: SerializeField]
        public object DefaultOverride { get; private set; }
        ...
        [field: SerializeField]
        public bool EditorAlwaysShow { get; private set; }

        [field: SerializeField]
        public bool EditorCutLongValues { get; private set; }

        [field: SerializeField]
        public string EditorDisplayColor { get; private set; }
        ...
        [field: SerializeField]
        public EditorDisplayMode EditorDisplayMode { get; private set; }

        [field: Tooltip("Possible values: `Above`, `Center`, `Beneath`")]
        [field: SerializeField]
        public EditorDisplayPos EditorDisplayPos { get; private set; }

        [field: SerializeField]
        public float EditorDisplayScale { get; private set; }

        [field: Tooltip(
            "Possible values: `ZigZag`, `StraightArrow`, `CurvedArrow`, `ArrowsLine`, `DashedLine`"
        )]
        [field: SerializeField]
        public EditorLinkStyle EditorLinkStyle { get; private set; }

        [field: SerializeField]
        public bool EditorShowInWorld { get; private set; }

        [field: SerializeField]
        public string EditorTextPrefix { get; private set; }

        [field: SerializeField]
        public string EditorTextSuffix { get; private set; }

        [field: Tooltip(
            "If TRUE, the field value will be exported to the `toc` project JSON field. Only applies to Entity fields."
        )]
        [field: SerializeField]
        public bool ExportToToc { get; private set; }
        ...
        [field: SerializeField]
        public bool SymmetricalRef { get; private set; }

        [field: Tooltip(
            "Possible values: &lt;`null`&gt;, `LangPython`, `LangRuby`, `LangJS`, `LangLua`, `LangC`, `LangHaxe`, `LangMarkdown`, `LangJson`, `LangXml`, `LangLog`"
        )]
        [field: SerializeField]
        public TextLanguageMode TextLanguageMode { get; private set; }

        [field: Tooltip("UID of the tileset used for a Tile")]
        [field: SerializeField]
        public LDtkDefinitionObjectTileset Tileset { get; private set; }
        ...
        [field: SerializeField]
        public string FieldDefinitionType { get; private set; }
        ...
        [field: SerializeField]
        public bool UseForSmartColor { get; private set; }
        ...
        internal override void Populate(LDtkDefinitionObjectsCache cache, FieldDefinition def)
        {
            ...
            AllowedRefsEntity = cache.GetObject<LDtkDefinitionObjectEntity>(
                def.AllowedRefsEntityUid
            );
