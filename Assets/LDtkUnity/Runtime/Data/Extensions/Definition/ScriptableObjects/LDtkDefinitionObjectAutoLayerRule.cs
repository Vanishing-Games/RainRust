...
namespace LDtkUnity
{
    ...
    public class LDtkDefinitionObjectAutoLayerRule
        : LDtkDefinitionObject<AutoLayerRuleDefinition>,
            ILDtkUid
    {
        ...
        [field: SerializeField]
        public bool BreakOnMatch { get; private set; }
        ...
        [field: SerializeField]
        public int OutOfBoundsValue { get; private set; }
        ...
        [field: SerializeField]
        public bool PerlinActive { get; private set; }

        [field: SerializeField]
        public float PerlinOctaves { get; private set; }

        [field: SerializeField]
        public float PerlinScale { get; private set; }
        ...
        [field: SerializeField]
        public Vector2Int TileRandomMax { get; private set; }

        [field: Tooltip("Min random offset for tile pos")]
        [field: SerializeField]
        public Vector2Int TileRandomMin { get; private set; }

        [field: Tooltip("Array containing all the possible tile IDs rectangles (picked randomly).")]
        [field: SerializeField]
        public int?[][] TileRectsIds { get; private set; }
        ...
        [field: SerializeField]
        public Vector2Int Modulo { get; private set; }
