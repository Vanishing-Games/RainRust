...
namespace LDtkUnity
{
    ...
    public sealed class LDtkDefinitionObjectEntity
        : LDtkDefinitionObject<EntityDefinition>,
            ILDtkUid
    {
        ...
        [field: Tooltip(
            "An array of 4 dimensions for the up/right/down/left borders (in this order) when using 9-slice mode for `tileRenderMode`. If the tileRenderMode is not NineSlice, then this array is empty.<br/>  See: https://en.wikipedia.org/wiki/9-slice_scaling"
        )]
        [field: SerializeField]
        public Rect NineSliceBorders { get; private set; }
        ...
        [field: SerializeField]
        public TileRenderMode TileRenderMode { get; private set; }
        ...
        [field: SerializeField]
        public Sprite UiTileRect { get; private set; }
        ...
        [field: SerializeField]
        public LDtkDefinitionObjectField[] FieldDefs { get; private set; }

        [field: SerializeField]
        public float FillOpacity { get; private set; }
        ...
        [field: SerializeField]
        public bool ResizableX { get; private set; }

        [field: Tooltip("If TRUE, the entity instances will be resizable vertically")]
        [field: SerializeField]
        public bool ResizableY { get; private set; }
        ...
        [field: SerializeField]
        public float TileOpacity { get; private set; }
        ...
        internal override void Populate(LDtkDefinitionObjectsCache cache, EntityDefinition def)
        {
            ...
            FieldDefs = def
                .FieldDefs.Select(p => cache.GetObject<LDtkDefinitionObjectField>(p.Uid))
                .ToArray();
