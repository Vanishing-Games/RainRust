...
namespace LDtkUnity
{
    ...
    public class LDtkDefinitionObjectAutoLayerRuleGroup
        : LDtkDefinitionObject<AutoLayerRuleGroup>,
            ILDtkUid
    {
        ...
        [field: SerializeField]
        public int BiomeRequirementMode { get; private set; }
        ...
        [field: SerializeField]
        public string[] RequiredBiomeValues { get; private set; }

        [field: SerializeField]
        public LDtkDefinitionObjectAutoLayerRule[] Rules { get; private set; }

        [field: SerializeField]
        public int Uid { get; private set; }

        [field: SerializeField]
        public bool UsesWizard { get; private set; }
        ...
        internal override void Populate(LDtkDefinitionObjectsCache cache, AutoLayerRuleGroup def)
        {
            ...
            Rules = def
                .Rules.Select(p => cache.GetObject<LDtkDefinitionObjectAutoLayerRule>(p.Uid))
                .ToArray();
            Uid = def.Uid;
