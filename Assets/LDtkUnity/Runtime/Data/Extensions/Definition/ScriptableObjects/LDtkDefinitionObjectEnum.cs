...
namespace LDtkUnity
{
    ...
    public sealed class LDtkDefinitionObjectEnum : LDtkDefinitionObject<EnumDefinition>, ILDtkUid
    {
        ...
        [field: SerializeField]
        public LDtkDefinitionObjectTileset IconTileset { get; private set; }
        ...
        [field: SerializeField]
        public LDtkDefinitionObjectEnumValue[] Values { get; private set; }

        #region EditorOnly

        [field: Tooltip("Internal")]
        [field: SerializeField]
        public string ExternalFileChecksum { get; private set; }
