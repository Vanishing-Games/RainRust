...
namespace LDtkUnity
{
    ...
    public partial class LayerDefinition : ILDtkUid, ILDtkIdentifier
    {
        ...
        /// </value>
        [IgnoreDataMember]
        public LayerDefinition AutoSourceLayerDefinition =>
            AutoSourceLayerDefUid != null
                ? LDtkUidBank.GetUidData<LayerDefinition>(AutoSourceLayerDefUid.Value)
                : null;
        ...
        /// </summary>
        [IgnoreDataMember]
        public Vector2Int GuideGridSize => new Vector2Int(GuideGridWid, GuideGridHei);
        ...
        /// </value>
        [IgnoreDataMember]
        public Vector2 TilePivot => new Vector2(TilePivotX, TilePivotY);

        /// <summary>
        /// User defined color for the UI
        /// </summary>
        [IgnoreDataMember]
        public Color UnityUiColor => UiColor.ToColor();
