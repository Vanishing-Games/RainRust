...
namespace LDtkUnity
{
    public partial class TilesetDefinition : ILDtkUid, ILDtkIdentifier
    {
        ...
        /// </value>
        [IgnoreDataMember]
        public EnumDefinition TagsSourceEnum =>
            TagsSourceEnumUid != null
                ? LDtkUidBank.GetUidData<EnumDefinition>(TagsSourceEnumUid.Value)
                : null;
        ...
        /// </value>
        [IgnoreDataMember]
        public Vector2Int UnityCSize => new Vector2Int(CWid, CHei);
        ...
        /// </value>
        [IgnoreDataMember]
        public bool IsEmbedAtlas => EmbedAtlas != null;
