...
namespace LDtkUnity
{
    public partial class TileInstance
    {
        ...
        /// </value>
        [IgnoreDataMember]
        public AutoLayerRuleDefinition AutoLayerRuleDefinition =>
            LDtkUidBank.GetUidData<AutoLayerRuleDefinition>(AutoLayerRuleId);
        ...
        /// </value>
        [IgnoreDataMember]
        public bool FlipX => (F & 1) == 1;

        /// <value>
        /// Y mirror transformation of the tile
        /// </value>
        [IgnoreDataMember]
        public bool FlipY => (F & 2) == 2;
        ...
        /// </value>
        [IgnoreDataMember]
        public Vector2Int UnitySrc => Src.ToVector2Int();
