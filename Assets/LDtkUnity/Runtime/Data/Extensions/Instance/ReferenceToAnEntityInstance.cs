...
namespace LDtkUnity
{
    public partial class ReferenceToAnEntityInstance
    {
        ...
        public EntityInstance Entity =>
            EntityIid == null ? null : LDtkIidBank.GetIidData<EntityInstance>(EntityIid);
        ...
        /// </value>
        [IgnoreDataMember]
        public LayerInstance Layer =>
            LayerIid == null ? null : LDtkIidBank.GetIidData<LayerInstance>(LayerIid);
        ...
        /// </value>
        [IgnoreDataMember]
        public World World => WorldIid == null ? null : LDtkIidBank.GetIidData<World>(WorldIid);
    }
}
