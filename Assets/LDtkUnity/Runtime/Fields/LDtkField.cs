...
namespace LDtkUnity
{
    ...
    public class LDtkField
    {
        ...
        [SerializeField]
        private LDtkDefinitionObjectField _def;

        [SerializeField]
        private LDtkFieldType _type;

        [SerializeField]
        internal LDtkFieldElement[] _data;
        ...
        internal bool IsArrayElementNull(int index)
        {
            ...
            {
                LDtkDebug.LogError(
                    $"Out of range when checking if an array's element index {index} was null for \"{_def.Identifier}\""
                );
                return true;
            }
        ...
        private bool ValidateSingle()
        {
            ...
            LDtkDebug.LogError(
                $"Tried accessing a single value when \"{_def.Identifier}\" is an array"
            );
            return false;
        }
        ...
        private bool ValidateArray()
        {
            ...
            LDtkDebug.LogError(
                $"Tried accessing an array when \"{_def.Identifier}\" is a single value"
            );
            return false;
        }
        ...
        internal bool ValidateElementTypes(LDtkFieldType type, Object ctx)
        {
            ...
            {
                LDtkDebug.LogError(
                    $"Tried getting a field \"{_def.Identifier}\" as type \"{type}\" but the field was a \"{_type}\" type instead",
                    ctx
                );
                return false;
            }
