...
namespace LDtkUnity
{
    ...
    public sealed class LDtkComponentLayer : MonoBehaviour
    {
        ...
        public LDtkComponentLevel Parent { get; private set; }
        ...
        [field: SerializeField]
        public float LayerScale { get; private set; }
        ...
        [field: SerializeField]
        public Vector2Int PxTotalOffset { get; private set; }
        ...
        [field: SerializeField]
        public LDtkComponentLayerTilesetTiles AutoLayerTiles { get; private set; }

        [field: Tooltip("")]
        [field: SerializeField]
        public LDtkComponentEntity[] EntityInstances { get; private set; }

        [field: Tooltip("")]
        [field: SerializeField]
        public LDtkComponentLayerTilesetTiles GridTiles { get; private set; }
        ...
        [field: SerializeField]
        public LDtkComponentLayerIntGridValues IntGrid { get; private set; }

        [field: Tooltip("Reference the Layer definition UID")]
        [field: SerializeField]
        public LDtkDefinitionObjectLayer LayerDef { get; private set; }

        [field: Tooltip("This layer can use another tileset by overriding the tileset UID here.")]
        [field: SerializeField]
        public LDtkDefinitionObjectTileset OverrideTileset { get; private set; }

        [field: Tooltip(
            "Offset in pixels to render this layer, usually 0 (IMPORTANT: this should be added to the `LayerDef` optional offset, so you should probably prefer using `__pxTotalOffset` which contains the total offset value)"
        )]
        [field: SerializeField]
        ...
        [field: SerializeField]
        public LDtkDefinitionObjectAutoLayerRuleGroup[] OptionalRules { get; private set; }
        ...
        internal void OnImport(
            ...
            LDtkIid iid,
            LDtkComponentEntity[] entities,
            LDtkComponentLayerIntGridValues values,
            LDtkComponentLayerTilesetTiles tilesetTiles,
            float layerScale
        )
        {
            ...
            OverrideTileset = cache.GetObject<LDtkDefinitionObjectTileset>(
                layer.OverrideTilesetUid
            );
            ...
            //internal
            OptionalRules = layer
                .OptionalRules.Select(cache.GetObject<LDtkDefinitionObjectAutoLayerRuleGroup>)
                .ToArray();
            Seed = layer.Seed;
        ...
        [Obsolete("Access LayerDef instead")]
        public LDtkDefinitionObjectLayer Definition => LayerDef;

        [Obsolete("Access EntityInstances instead")]
        public LDtkComponentEntity[] Entities => EntityInstances;

        [Obsolete("Access the definition instead")]
        public string Doc => LayerDef.Doc;

        [Obsolete("Access the definition instead")]
        public TypeEnum LayerType => LayerDef.LayerDefinitionType;
    }
}
