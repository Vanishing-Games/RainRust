...
namespace LDtkUnity
{
    ...
    public sealed class LDtkComponentEntity : MonoBehaviour
    {
        ...
        public LDtkComponentLayer Parent { get; private set; }
        ...
        [field: Tooltip(
            "The scale determined by how much the entity is resized relative to it's default size. Use for determining the length of an entity prefab, like scaling or length/size."
        )]
        [field: SerializeField]
        ...
        [field: SerializeField]
        public LDtkDefinitionObjectEntity Def { get; private set; }
        ...
        [field: SerializeField]
        public Vector2Int Px { get; private set; }

        internal void OnImport(
            LDtkDefinitionObjectsCache cache,
            EntityInstance entity,
            LDtkComponentLayer layer,
            LDtkFields fields,
            LDtkIid iid,
            Vector2 size
        )
