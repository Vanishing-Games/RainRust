...
namespace LDtkUnity
{
    ...
    public sealed class LDtkComponentWorld : MonoBehaviour
    {
        ...
        public LDtkComponentProject Parent { get; private set; }
        ...
        [field: SerializeField]
        public LDtkComponentLevel[] Levels { get; private set; }

        [field: Tooltip("Only 'GridVania' layouts. Size of the world grid in pixels.")]
        [field: SerializeField]
        public Vector2Int WorldGridSize { get; private set; }
        ...
        [field: SerializeField]
        public Vector2Int DefaultLevelSize { get; private set; }
