...
namespace LDtkUnity
{
    ...
    public sealed class LDtkComponentLevel : MonoBehaviour
    {
        ...
        public LDtkComponentWorld Parent { get; private set; }

        [field: Tooltip(
            "The separate level file raw json, in case you want to deserialize on your own.\nNOTE: This only exists if this is a separate level file"
        )]
        [field: SerializeField]
        public LDtkLevelFile Json { get; private set; }
        ...
        [field: SerializeField]
        public LDtkNeighbour[] Neighbours { get; private set; }

        [field: Tooltip(
            "Background color of the level. If `null`, the project `defaultLevelBgColor` should be used."
        )]
        [field: SerializeField]
        public Color LevelBgColor { get; private set; }
        ...
        [field: SerializeField]
        public BgPos LevelBgPos { get; private set; }
        ...
        [field: SerializeField]
        public LDtkFields FieldInstances { get; private set; }
        ...
        [field: SerializeField]
        public LDtkComponentLayer[] LayerInstances { get; private set; }

        [field: Tooltip("Size of the level in pixels")]
        [field: SerializeField]
        public Vector2Int PxSize { get; private set; }
        ...
        [field: SerializeField]
        public Color SmartColor { get; private set; }
        ...
        [field: SerializeField]
        public Vector2 BgPivot { get; private set; }

        [field: Tooltip("Position informations of the background image, if there is one.")]
        [field: SerializeField]
        public LevelBackgroundPosition BgPos { get; private set; }
        ...
        [field: SerializeField]
        public bool UseAutoIdentifier { get; private set; }
        ...
        internal void OnImport(
            Level lvl,
            LDtkLevelFile file,
            LDtkComponentLayer[] layers,
            LDtkFields fields,
            LDtkComponentWorld world,
            Vector2 unitySize,
            LDtkIid iid
        )
        {
        ...
        /// </value>
        [PublicAPI]
        public Rect BorderRect => new Rect(transform.position, Size);
        ...
        public Bounds BorderBounds =>
            new Bounds(transform.position + (Vector3)(Vector2.one * Size * 0.5f), Size);
    }
}
