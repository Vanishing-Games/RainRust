...
namespace LDtkUnity
{
    ...
    public sealed class LDtkComponentProject : MonoBehaviour
    {
        ...
        public LDtkProjectFile Json { get; private set; }
        ...
        [field: SerializeField]
        public LDtkIid Iid { get; private set; }
        ...
        [field: SerializeField]
        public LDtkComponentWorld[] Worlds { get; private set; }
        ...
        [field: SerializeField]
        public float AppBuildId { get; private set; }

        [field: Tooltip("Number of backup files to keep, if the `backupOnSave` is TRUE")]
        [field: SerializeField]
        public int BackupLimit { get; private set; }

        [field: Tooltip(
            "If TRUE, an extra copy of the project will be created in a sub folder, when saving."
        )]
        [field: SerializeField]
        public bool BackupOnSave { get; private set; }

        [field: Tooltip("Target relative path to store backup files")]
        [field: SerializeField]
        public string BackupRelPath { get; private set; }

        [field: Tooltip("An array of command lines that can be ran manually by the user")]
        [field: SerializeField]
        public LDtkDefinitionObjectCommand[] CustomCommands { get; private set; }

        [field: Tooltip("Default size for new entities")]
        [field: SerializeField]
        public Vector2Int DefaultEntitySize { get; private set; }
        ...
        [field: SerializeField]
        public string DummyWorldIid { get; private set; }

        [field: Tooltip(
            "If TRUE, the exported PNGs will include the level background (color or image)."
        )]
        [field: SerializeField]
        public bool ExportLevelBg { get; private set; }

        [field: Tooltip(
            "If TRUE, a Tiled compatible file will also be generated along with the LDtk JSON file (default is FALSE)"
        )]
        [field: SerializeField]
        public bool ExportTiled { get; private set; }
        ...
        [field: SerializeField]
        public string PngFilePattern { get; private set; }

        [field: Tooltip(
            "If TRUE, a very simplified will be generated on saving, for quicker and easier engine integration."
        )]
        [field: SerializeField]
        public bool SimplifiedExport { get; private set; }

        [field: Tooltip(
            "This optional description is used by LDtk Samples to show up some information and instructions."
        )]
        [field: SerializeField]
        public string TutorialDesc { get; private set; }

        #endregion

        internal void OnImport(
            LdtkJson json,
            LDtkProjectFile file,
            LDtkTableOfContents toc,
            LDtkComponentWorld[] worlds,
            LDtkIid iid
        )
        {
            ...
            CustomCommands = json
                .CustomCommands.Select(p => new LDtkDefinitionObjectCommand(p))
                .ToArray();
